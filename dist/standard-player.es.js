...
var P = (i, t, e) => (qs(i, t, "read from private field"), e ? e.call(i) : t.get(i)), N = (i, t, e) => {
  if (t.has(i))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(i) : t.set(i, e);
}, _ = (i, t, e, s) => (qs(i, t, "write to private field"), s ? s.call(i, e) : t.set(i, e), e);
const _i = /mobile/i.test(window.navigator.userAgent), ci = document.fullscreenEnabled || document.webkitFullscreenEnabled || document.mozFullScreenEnabled || document.msFullscreenEnabled || !1, di = document.pictureInPictureEnabled || !1;
function u(i, t, e) {
...
function ze(...i) {
  ...
  return i.shift(), i.forEach((e) => {
    if (bt(e)) {
      bt(t) || (t = {});
      for (const s in e)
        t[s] && bt(e[s]) ? t[s] = ze(t[s], e[s]) : t[s] = e[s];
    }
  }), t;
}
function vi(...i) {
  ...
  return i.shift(), i.forEach((s) => {
    s.plugins && (e = e.concat(e, s.plugins)), ze(t, s);
  }), t.plugins = e, t;
}
const Sr = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  dateFormat: Ie,
  debounce: Et,
  fullScreenEnabled: ci,
  isMobile: _i,
  isPlainObject: bt,
  mergeOptions: vi,
  numberToHexColor: mi,
  pictureInPictureEnabled: di,
  random: Fi,
  replaceChildren: Mi,
  secondToTime: mt,
  throttle: ui,
...
let ot = (G = class {
  constructor(t) {
    this.hook = new Oi(), this.plugins = {}, this.invokes = {}, this._eventEmitter = new Vi(), this.Player = G, this.container = t.container, this.$el = u("div", { class: `${r} mpui` }), this.$main = this.$el.appendChild(u("div", { class: `${r}-main` })), this.$area = this.$main.appendChild(u("div", { class: `${r}-area` })), this.$content = this.$area.appendChild(
      u("div", { class: `${r}-content` })
    ), this.invokes = t.invokes ?? {}, this.plugin = new zi(this), this._videoController = new Ii(this, t), this.loader = new Bi(this), this.init(t);
  }
  /** 初始化播放器 */
  async init(t) {
    var e;
 ...
 */
var _t;
const xt = window, st = xt.trustedTypes, Cs = st ? st.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, It = "$lit$", B = `lit$${(Math.random() + "").slice(9)}$`, fi = "?" + B, Ci = `<${fi}>`, Z = document, ht = () => Z.createComment(""), ct = (i) => i === null || typeof i != "object" && typeof i != "function", yi = Array.isArray, Wi = (i) => yi(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", Mt = `[ 	
\f\r]`, rt = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Ws = /-->/g, Us = />/g, j = RegExp(`>|${Mt}(?:([^\\s"'>=/]+)(${Mt}*=${Mt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Xs = /'/g, Ys = /"/g, bi = /^(?:script|style|textarea|title)$/i, Ui = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e }), O = Ui(1), dt = Symbol.for("lit-noChange"), F = Symbol.for("lit-nothing"), Ks = /* @__PURE__ */ new WeakMap(), W = Z.createTreeWalker(Z, 129, null, !1);
function ki(i, t) {
...
const Xi = (i, t) => {
  ...
  for (let h = 0; h < e; h++) {
    ...
    for (; w < o.length && (l.lastIndex = w, p = l.exec(o), p !== null); )
      w = l.lastIndex, l === rt ? p[1] === "!--" ? l = Ws : p[1] !== void 0 ? l = Us : p[2] !== void 0 ? (bi.test(p[2]) && (n = RegExp("</" + p[2], "g")), l = j) : p[3] !== void 0 && (l = j) : l === j ? p[0] === ">" ? (l = n ?? rt, g = -1) : p[1] === void 0 ? g = -2 : (g = l.lastIndex - p[2].length, c = p[1], l = p[3] === void 0 ? j : p[3] === '"' ? Ys : Xs) : l === Ys || l === Xs ? l = j : l === Ws || l === Us ? l = rt : (l = j, n = void 0);
    const S = l === j && i[h + 1].startsWith("/>") ? " " : "";
    a += l === rt ? o + Ci : g >= 0 ? (s.push(c), o.slice(0, g) + It + o.slice(g) + B + S) : o + B + (g === -2 ? (s.push(void 0), h) : S);
  }
  return [ki(i, a + (i[e] || "<?>") + (t === 2 ? "</svg>" : "")), s];
};
class ut {
  constructor({ strings: t, _$litType$: e }, s) {
    ...
    this.parts = [];
    let a = 0, l = 0;
    const h = t.length - 1, o = this.parts, [c, p] = Xi(t, e);
          ...
          for (const w of n.getAttributeNames())
            if (w.endsWith(It) || w.startsWith(B)) {
              ...
              if (g.push(w), S !== void 0) {
                ...
                o.push({ type: 1, index: a, name: m[2], strings: E, ctor: m[1] === "." ? Ki : m[1] === "?" ? Zi : m[1] === "@" ? Ji : Tt });
              } else
...
class Yi {
  ...
  u(t) {
    ...
    for (; c !== void 0; ) {
      if (h === c.index) {
        let p;
        c.type === 2 ? p = new $t(l, l.nextSibling, this, t) : c.type === 1 ? p = new c.ctor(l, c.name, c.strings, this, t) : c.type === 6 && (p = new Qi(l, this, t)), this._$AV.push(p), c = n[++o];
      }
...
class $t {
  ...
  _$AI(t, e = this) {
    t = it(this, t, e), ct(t) ? t === F || t == null || t === "" ? (this._$AH !== F && this._$AR(), this._$AH = F) : t !== this._$AH && t !== dt && this._(t) : t._$litType$ !== void 0 ? this.g(t) : t.nodeType !== void 0 ? this.$(t) : Wi(t) ? this.T(t) : this._(t);
  }
  k(t) {
  ...
  g(t) {
    var e;
    const { values: s, _$litType$: n } = t, a = typeof n == "number" ? this._$AC(t) : (n.el === void 0 && (n.el = ut.createElement(ki(n.h, n.h[0]), this.options)), n);
    if (((e = this._$AH) === null || e === void 0 ? void 0 : e._$AD) === a)
      this._$AH.v(s);
    else {
      const l = new Yi(a, this), h = l.u(this.options);
      l.v(s), this.$(h), this._$AH = l;
    }
  }
  _$AC(t) {
    let e = Ks.get(t.strings);
    return e === void 0 && Ks.set(t.strings, e = new ut(t)), e;
  }
  T(t) {
...
const Gs = xt.litHtmlPolyfillSupport;
Gs == null || Gs(ut, $t), ((_t = xt.litHtmlVersions) !== null && _t !== void 0 ? _t : xt.litHtmlVersions = []).push("2.8.0");
const At = (i, t, e) => {
  var s, n;
...
class J {
  ...
  /** 重载，一般用于列表项更改 */
  reload(t) {
    At(tn({ list: this.list, template: this.template }), this.container), this.$el = this.container.querySelector(".mpui-picker"), this.$items = this.$el.querySelectorAll(".mpui-picker-item"), this.$items.forEach((e) => {
...
class wi {
  ...
  /** 重载，一般用于列表项更改 */
  reload(t) {
    At(en({ list: this.list, template: this.template }), this.container), this.$el = this.container.querySelector(".mpui-picker"), this.$items = this.$el.querySelectorAll(".mpui-picker-item"), this.$items.forEach((e) => {
      e.addEventListener("click", () => {
...
`
  ...
  return o;
}, Ve = class Ve extends vt {
  constructor(t) {
    super(t, u("div", { class: `${r}-danmakulist` }, rn)), this.title = "弹幕列表", this.data = [], this.selected = [], this.focused = null, this.sortedBy = "time", this.sortOrder = 1, this.autoScroll = !0, this.frozen = !1, this.danmaku = t.plugins.danmaku, this.$main = this.$(`.${r}-danmakulist-main`), this.$container = this.$(`.${r}-danmakulist-container`), this.$status = this.$(`.${r}-danmakulist-status`), this.$colTime = this.$(".col-time"), this.$colDate = this.$(".col-date"), this.$colContent = this.$(".col-content"), this.$autoscroll = this.$(`.${r}-danmakulist-autoscroll`), this.$select = this.$(`.${r}-danmakulist-select`), this.$selectInfo = this.$(`.${r}-danmakulist-select-info`), this.$clearSelect = this.$('.list-operate-btn[data-action="clearSelect"]'), this.$clearSelect.onclick = () => {
      this.select([]);
...
const on = (
  ...
  <div>github：<a href="${Di}" target="_blank">mfuns-cn/mfunsPlayer</a></div>
  <div>开发者：</div>
...
`
  ...
  constructor(t) {
    super(t, u("div", { class: `${r}-about` }, on)), this.title = "关于";
  }
};
je.pluginName = "about";
let Bt = je;
...
`
  ...
  constructor(t) {
    super(t, u("div", { class: `${r}-videotime` }, pn)), this.valueBeforeEdited = "", this.timeFormat = 2, this.$label = this.$(`.${r}-videotime-label`), this.$current = this.$(`.${r}-videotime-current`), this.$total = this.$(`.${r}-videotime-total`), this.$input = this.$(`.${r}-videotime-input`);
  }
  init() {
...
`
  ...
  get ignored() {
    return !this.player.enterPip || !di;
  }
};
ts.pluginName = "buttonPip";
let Zt = ts;
const yn = (
  /*html*/
  `
...
es.pluginName = "buttonWidescreen";
let Zs = es;
const bn = (
  /*html*/
  `
...
`
  ...
  get ignored() {
    return !this.player.enterFullscreen || !ci;
  }
};
is.pluginName = "buttonFullscreen";
let Jt = is;
...
U = new WeakMap(), rs.pluginName = "modal";
let te = rs;
const xn = (
  /*html*/
  `
...
`
), as = class as extends M {
  constructor(t) {
    super(t, u("div", { class: `${r}-progress` }, xn)), this.trackLength = 0, this.distance = 0, this.nMax = 0, this.nLeft = 0, this.isDragging = !1, this.isHover = !1, this.isActive = !1, this.$bar = this.$(`.${r}-progress-bar`), this.$buffered = this.$(`.${r}-progress-buffered`), this.$played = this.$(`.${r}-progress-played`), this.$thumbTrack = this.$(`.${r}-progress-thumb-track`), this.$thumb = this.$(`.${r}-progress-thumb`), this.$preview = this.$(`.${r}-progress-preview`), this.$thumbnail = this.$(`.${r}-progress-thumbnail`), this.$time = this.$(`.${r}-progress-time`), this.$tip = this.$(`.${r}-progress-tip`), this.$el.addEventListener("mousedown", (n) => {
      const { clientX: a } = n;
...
`
), ls = class ls extends vt {
  constructor(t) {
    super(t, u("div", { class: `${r}-settings` }, Ln)), this.title = "设置", this.$slot = this.$(`.${r}-settings-slot`), this.$play = this.$(`.${r}-settings-play`), this.$others = this.$(`.${r}-settings-others`), this.$ratePicker = this.$(`.${r}-settings-rate-picker`), this.$ratioPicker = this.$(`.${r}-settings-ratio-picker`);
  }
  init() {
...
X = new WeakMap(), os.pluginName = "side";
let ie = os;
...
I = new WeakMap(), V = new WeakMap(), us.pluginName = "stateActive";
let le = us;
...
}, Qs = "ResizeObserver loop completed with undelivered notifications.", An = function() {
  var i;
  typeof ErrorEvent == "function" ? i = new ErrorEvent("error", {
    message: Qs
  }) : (i = document.createEvent("Event"), i.initEvent("error", !1, !1), i.message = Qs), window.dispatchEvent(i);
}, pt;
(function(i) {
...
var K = function(i) {
  ...
  return !1;
}, lt = typeof window < "u" ? window : {}, gt = /* @__PURE__ */ new WeakMap(), ei = /auto|scroll/, Mn = /^tb|vertical/, Fn = /msie|trident/i.test(lt.navigator && lt.navigator.userAgent), D = function(i) {
  return parseFloat(i || "0");
}, Q = function(i, t, e) {
  return i === void 0 && (i = 0), t === void 0 && (t = 0), e === void 0 && (e = !1), new Hn((e ? t : i) || 0, (e ? i : t) || 0);
}, si = K({
  ...
  if (t === void 0 && (t = !1), gt.has(i) && !t)
    return gt.get(i);
  if (Li(i))
    return gt.set(i, si), si;
  var e = getComputedStyle(i), s = Be(i) && i.ownerSVGElement && i.getBBox(), n = !Fn && e.boxSizing === "border-box", a = Mn.test(e.writingMode || ""), l = !s && ei.test(e.overflowY || ""), h = !s && ei.test(e.overflowX || ""), o = s ? 0 : D(e.paddingTop), c = s ? 0 : D(e.paddingRight), p = s ? 0 : D(e.paddingBottom), g = s ? 0 : D(e.paddingLeft), w = s ? 0 : D(e.borderTopWidth), S = s ? 0 : D(e.borderRightWidth), E = s ? 0 : D(e.borderBottomWidth), m = s ? 0 : D(e.borderLeftWidth), v = g + c, d = o + p, $ = m + S, L = w + E, y = h ? i.offsetHeight - L - i.clientHeight : 0, T = l ? i.offsetWidth - $ - i.clientWidth : 0, b = n ? v + $ : 0, x = n ? d + L : 0, A = s ? s.width : D(e.width) - b - T, f = s ? s.height : D(e.height) - x - y, H = A + v + T + $, R = f + d + y + L, nt = K({
    ...
    contentRect: new xi(g, o, A, f)
  });
  return gt.set(i, nt), nt;
}, Si = function(i, t, e) {
  var s = Ei(i, e), n = s.borderBoxSize, a = s.contentBoxSize, l = s.devicePixelContentBoxSize;
  switch (t) {
  ...
  Y.forEach(function(l) {
    if (l.activeTargets.length !== 0) {
      ...
      l.activeTargets.forEach(function(c) {
        var p = new Pn(c.target), g = Ti(c.target);
        h.push(p), c.lastReportedSize = Si(c.target, c.observedBox), g < i && (i = g);
      }), t.push(function() {
  ...
  Y.forEach(function(e) {
    e.activeTargets.splice(0, e.activeTargets.length), e.skippedTargets.splice(0, e.skippedTargets.length), e.observationTargets.forEach(function(n) {
      n.isActive() && (Ti(n.target) > i ? e.activeTargets.push(n) : e.skippedTargets.push(n));
    });
  });
}, Dn = function() {
  var i = 0;
  ...
  return Ai.splice(0).forEach(function(i) {
    return i();
  });
}, In = function(i) {
  if (!Ft) {
  ...
  return !!kt;
}, Bn = 250, Vn = { attributes: !0, characterData: !0, childList: !0, subtree: !0 }, ni = [
  "resize",
  "load",
  "transitionend",
  "animationend",
  ...
  return i.prototype.run = function(t) {
    ...
    var t = this;
    this.stopped && (this.stopped = !1, this.observer = new MutationObserver(this.listener), this.observe(), ni.forEach(function(e) {
      return lt.addEventListener(e, t.listener, !0);
    }));
  }, i.prototype.stop = function() {
    var t = this;
    this.stopped || (this.observer && this.observer.disconnect(), ni.forEach(function(e) {
      return lt.removeEventListener(e, t.listener, !0);
    }), this.stopped = !0);
  }, i;
}(), he = new qn(), ai = function(i) {
  !kt && i > 0 && he.start(), kt += i, !kt && he.stop();
}, jn = function(i) {
  return !Be(i) && !_n(i) && getComputedStyle(i).display === "inline";
}, Cn = function() {
  function i(t, e) {
  ...
  return i.prototype.isActive = function() {
    var t = Si(this.target, this.observedBox, !0);
    return jn(this.target) && (this.lastReportedSize = t), this.lastReportedSize.inlineSize !== t.inlineSize || this.lastReportedSize.blockSize !== t.blockSize;
  }, i;
  ...
  return i;
}(), ft = /* @__PURE__ */ new WeakMap(), li = function(i, t) {
  ...
  return i.connect = function(t, e) {
    ...
    li(n.observationTargets, e) < 0 && (a && Y.push(n), n.observationTargets.push(new Cn(e, s && s.box)), ai(1), he.schedule());
  }, i.unobserve = function(t, e) {
    var s = ft.get(t), n = li(s.observationTargets, e), a = s.observationTargets.length === 1;
    n >= 0 && (a && Y.splice(Y.indexOf(s), 1), s.observationTargets.splice(n, 1), ai(-1));
...
const ms = class ms extends k {
  constructor(t) {
    super(t);
    const e = window.ResizeObserver || Hi;
...
vs.pluginName = "stateIntersecting";
let de = vs;
class Un extends St {
  constructor(t) {
...
const Xn = [
  ...
  Zt,
  Jt
], Gn = [...Xn, ...Yn, ...Kn], $s = class $s extends k {
  constructor() {
...
`
  ...
  constructor(t) {
    super(t, u("div", { class: `${r}-videostatus` }, tr)), this.$paused = this.$(`.${r}-videostatus-paused`), this.$loading = this.$(`.${r}-videostatus-loading`), this.$volume = this.$(`.${r}-videostatus-volume`), this.player.$area.appendChild(this.$el), this.player.on("volumechange", (s, n) => {
...
`
  ...
  constructor(t) {
    super(t, u("div", { class: `${r}-loadingmask` }, er)), this.delay = 0, this.$info = this.$(`.${r}-loadingmask-info`), this.$tips = this.$(`.${r}-loadingmask-tips`), this.player.$main.appendChild(this.$el);
  }
  apply(t, e) {
    var s, n;
...
Ss.pluginName = "loadingMask";
let we = Ss;
const Ts = class Ts extends M {
  get count() {
    var t;
...
`)}`, typeof v.color == "number" ? d.style.color = mi(v.color) : d.style.color = v.color, d.style.opacity = this.opacity.toString(), d.style.fontSize = +v.size * this.fontScale + "px", v.fromHere && (d.style.border = "2px solid white"), d.addEventListener("animationend", () => {
...
function nr() {
  const i = [], t = hi.length;
  for (let e = 0; e < 8; e++)
    i.push(hi[Math.floor(Math.random() * t)]);
  return oi++, i.join("") + `${oi}`;
}
const Ms = class Ms extends k {
  constructor() {
...
Ps.pluginName = "buttonDanmakuToggle";
let Ae = Ps;
const lr = (
  /*html*/
  `
...
const Rs = class Rs extends M {
  constructor(e) {
    super(e, u("div", { class: `${r}-danmakubar` }, lr));
    N(this, q, void 0);
  ...
  apply(e, s) {
    var n, a, l;
    (n = s.danmakuBar) != null && n.loginRequired && _(this, q, !0), this.setPlaceHolder(((a = s.danmakuBar) == null ? void 0 : a.placeholder) || or), this.controls = ((l = s.danmakuBar) == null ? void 0 : l.controls) || {};
  }
  ready() {
...
q = new WeakMap(), Rs.pluginName = "danmakuBar";
let He = Rs;
const or = "发条弹幕吧~", hr = (
  /*html*/
  `
...
`, dr = (i) => navigator.clipboard.writeText(i), Ns = class Ns extends k {
  constructor(t) {
...
`
  ...
  init(t) {
    this.pickerSize = new J({
      ...
      value: "#FFFFFF",
      list: vr.map((e) => ({ value: e })),
      onPick: (e) => {
        this.danmakuBar.danmakuColor = pi(e);
      },
      onChange: (e) => {
...
Is.pluginName = "buttonDanmakuStyle";
let Fe = Is;
const pr = [
  [18, "小"],
  [25, "中"],
...
const Vs = class Vs extends k {
  constructor(e) {
    super(e);
    N(this, z, null);
    const s = window.ResizeObserver || Hi;
...
z = new WeakMap(), Vs.pluginName = "aspectRatio";
let Ne = Vs;
const br = [
  be,
  yr,
  ...
  ke,
  we
], kr = [fe, ye, Lt], wr = [Bt, Ot, ge], xr = [Pe, Re, De], Lr = [
  ...Gn,
  ...fr,
  ...br,
  ...wr,
