...
var P = (i, t, e) => (Cs(i, t, "read from private field"), e ? e.call(i) : t.get(i)), D = (i, t, e) => {
  if (t.has(i))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(i) : t.set(i, e);
}, S = (i, t, e, s) => (Cs(i, t, "write to private field"), s ? s.call(i, e) : t.set(i, e), e);
const Fi = /mobile/i.test(window.navigator.userAgent), ui = document.fullscreenEnabled || document.webkitFullscreenEnabled || document.mozFullScreenEnabled || document.msFullscreenEnabled || !1, pi = document.pictureInPictureEnabled || !1;
function u(i, t, e) {
...
function Be(...i) {
  ...
  return i.shift(), i.forEach((e) => {
    if (wt(e)) {
      wt(t) || (t = {});
      for (const s in e)
        t[s] && wt(e[s]) ? t[s] = Be(t[s], e[s]) : t[s] = e[s];
    }
  }), t;
}
function gi(...i) {
  ...
  return i.shift(), i.forEach((s) => {
    s.plugins && (e = e.concat(e, s.plugins)), Be(t, s);
  }), t.plugins = e, t;
}
const Ar = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  dateFormat: Oe,
  debounce: St,
  fullScreenEnabled: ui,
  isMobile: Fi,
  isPlainObject: wt,
  mergeOptions: gi,
  numberToHexColor: $i,
  pictureInPictureEnabled: pi,
  random: Ri,
  replaceChildren: Pi,
  secondToTime: $t,
  throttle: mi,
  timeToSecond: It
}, Symbol.toStringTag, { value: "Module" })), r = "mfuns-player", Di = "3.0.0-alpha.8", Ni = "3481c24", Ii = "https://github.com/Mfuns-cn/mfunsPlayer/tree/v3-beta", zi = [
...
let ht = (G = class {
  constructor(t) {
    this.hook = new Vi(), this.plugins = {}, this.invokes = {}, this._eventEmitter = new ji(), this.Player = G, this.container = t.container, this.$el = u("div", { class: `${r} mpui` }), this.$main = this.$el.appendChild(u("div", { class: `${r}-main` })), this.$area = this.$main.appendChild(u("div", { class: `${r}-area` })), this.$content = this.$area.appendChild(
      u("div", { class: `${r}-content` })
    ), this.invokes = t.invokes ?? {}, this.plugin = new Bi(this), this._videoController = new Oi(this, t), this.loader = new qi(this), this.init(t);
  }
  /** 初始化播放器 */
  async init(t) {
    var e;
  ...
  seek(t) {
    this.hook.call("seek").then((e) => {
      e && (this.$video.currentTime = Nt(t, 0, this.$video.duration));
    });
  }
  /** 设置音量
   * @param volume 音量（0-1）
...
class fi extends Tt {
  ...
  /** 挂载 */
  mount(e, s) {
    e.appendChild(this.$el), this.unmount(), S(this, tt, s == null ? void 0 : s.onUnmount);
  }
  /** 卸载 */
  unmount() {
    var e;
    (e = P(this, tt)) == null || e.call(this), S(this, tt, void 0);
  }
  show() {
...
class gt extends fi {
  ...
  /** 挂载 */
  mount(e, s) {
    super.mount(e, { onUnmount: s == null ? void 0 : s.onUnmount }), S(this, et, s == null ? void 0 : s.onToggle);
  }
  /** 卸载 */
  unmount() {
    this.toggle(!1), super.unmount(), S(this, et, void 0);
  }
  /** 切换显示隐藏状态 */
  toggle(e) {
    var s;
    this.shown = e ?? !this.shown, (s = P(this, et)) == null || s.call(this, this.shown);
  }
}
et = new WeakMap();
class Hr extends k {
...
class lt {
  constructor({
    ...
    this.container = t, this.min = e, this.max = s, this.step = n || 0, this.divider = a ? typeof a == "boolean" ? this.step : a : 0, this.value = isNaN(l) ? l : Number(l), this.onChange = h, this.onDragStart = o, this.onDragEnd = c, this.onDrag = p, this.$el = this.container.appendChild(
      ...
      var b;
      const w = g, { clientX: T } = w, E = this.$track.offsetWidth;
      ...
      const y = (x) => {
        ...
        let M = f - d - v;
        M = M >= m ? m : M <= 0 ? 0 : M;
        const R = this.step ? Math.round(M / m * (this.max - this.min) / this.step) * this.step + this.min : M / m * (this.max - this.min) + this.min;
        this.value != R && this.drag(R), (rt = window.getSelection()) == null || rt.removeAllRanges();
      }, A = (x) => {
        var f, M;
        x.stopPropagation(), (f = window.getSelection()) == null || f.removeAllRanges(), document.removeEventListener("mousemove", y), document.removeEventListener("mouseup", A), (M = this.onDragEnd) == null || M.call(this, L);
      };
...
class yi {
  constructor({
    ...
    this.container = t, this.min = e, this.max = s, this.step = n || 0, this.value = isNaN(a) ? a : Number(a), this.onChange = l, this.onDragStart = h, this.onDragEnd = o, this.onDrag = c, this.$el = u(
      ...
      var A;
      const g = p, { clientY: w } = g, T = this.$track.offsetHeight;
      let E = this.$thumbTrack.offsetHeight;
      E = E || T;
      const m = (T - E) / 2, v = this.$el.getBoundingClientRect().top;
      let d = E - (w - v - m);
      d = d >= E ? E : d <= 0 ? 0 : d;
      ...
      const L = (b) => {
        ...
        let f = E - (H - v - m);
        f = f >= E ? E : f <= 0 ? 0 : f;
        const M = this.step ? Math.round(f / E * (this.max - this.min) / this.step) * this.step + this.min : f / E * (this.max - this.min) + this.min;
 ...
 */
var _t;
const Et = window, it = Et.trustedTypes, Us = it ? it.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, zt = "$lit$", B = `lit$${(Math.random() + "").slice(9)}$`, bi = "?" + B, Ui = `<${bi}>`, Z = document, ct = () => Z.createComment(""), dt = (i) => i === null || typeof i != "object" && typeof i != "function", ki = Array.isArray, Xi = (i) => ki(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", Ft = `[ 	
\f\r]`, at = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Xs = /-->/g, Ys = />/g, q = RegExp(`>|${Ft}(?:([^\\s"'>=/]+)(${Ft}*=${Ft}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Ks = /'/g, Gs = /"/g, wi = /^(?:script|style|textarea|title)$/i, Yi = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e }), O = Yi(1), ut = Symbol.for("lit-noChange"), F = Symbol.for("lit-nothing"), Zs = /* @__PURE__ */ new WeakMap(), C = Z.createTreeWalker(Z, 129, null, !1);
function xi(i, t) {
...
const Ki = (i, t) => {
  ...
  for (let h = 0; h < e; h++) {
    ...
    for (; w < o.length && (l.lastIndex = w, p = l.exec(o), p !== null); )
      w = l.lastIndex, l === at ? p[1] === "!--" ? l = Xs : p[1] !== void 0 ? l = Ys : p[2] !== void 0 ? (wi.test(p[2]) && (n = RegExp("</" + p[2], "g")), l = q) : p[3] !== void 0 && (l = q) : l === q ? p[0] === ">" ? (l = n ?? at, g = -1) : p[1] === void 0 ? g = -2 : (g = l.lastIndex - p[2].length, c = p[1], l = p[3] === void 0 ? q : p[3] === '"' ? Gs : Ks) : l === Gs || l === Ks ? l = q : l === Xs || l === Ys ? l = at : (l = q, n = void 0);
    const T = l === q && i[h + 1].startsWith("/>") ? " " : "";
    a += l === at ? o + Ui : g >= 0 ? (s.push(c), o.slice(0, g) + zt + o.slice(g) + B + T) : o + B + (g === -2 ? (s.push(void 0), h) : T);
  }
  return [xi(i, a + (i[e] || "<?>") + (t === 2 ? "</svg>" : "")), s];
};
class pt {
  constructor({ strings: t, _$litType$: e }, s) {
    ...
    this.parts = [];
    let a = 0, l = 0;
    const h = t.length - 1, o = this.parts, [c, p] = Ki(t, e);
    if (this.el = pt.createElement(c, s), C.currentNode = this.el.content, e === 2) {
      const g = this.el.content, w = g.firstChild;
      w.remove(), g.append(...w.childNodes);
    }
      ...
      if (n.nodeType === 1) {
        if (n.hasAttributes()) {
          ...
          for (const w of n.getAttributeNames())
            if (w.endsWith(zt) || w.startsWith(B)) {
              const T = p[l++];
              if (g.push(w), T !== void 0) {
                const E = n.getAttribute(T.toLowerCase() + zt).split(B), m = /([.?@])?(.*)/.exec(T);
                o.push({ type: 1, index: a, name: m[2], strings: E, ctor: m[1] === "." ? Zi : m[1] === "?" ? Qi : m[1] === "@" ? tn : At });
              } else
        ...
        if (wi.test(n.tagName)) {
          const g = n.textContent.split(B), w = g.length - 1;
          if (w > 0) {
            n.textContent = it ? it.emptyScript : "";
            for (let T = 0; T < w; T++)
              n.append(g[T], ct()), C.nextNode(), o.push({ type: 2, index: ++a });
            n.append(g[w], ct());
          }
        }
...
function nt(i, t, e = i, s) {
  ...
  return (o == null ? void 0 : o.constructor) !== c && ((a = o == null ? void 0 : o._$AO) === null || a === void 0 || a.call(o, !1), c === void 0 ? o = void 0 : (o = new c(i), o._$AT(i, e, s)), s !== void 0 ? ((l = (h = e)._$Co) !== null && l !== void 0 ? l : h._$Co = [])[s] = o : e._$Cl = o), o !== void 0 && (t = nt(i, o._$AS(i, t.values), o, s)), t;
}
class Gi {
  constructor(t, e) {
  ...
  u(t) {
    ...
    for (; c !== void 0; ) {
      if (h === c.index) {
        let p;
        c.type === 2 ? p = new ft(l, l.nextSibling, this, t) : c.type === 1 ? p = new c.ctor(l, c.name, c.strings, this, t) : c.type === 6 && (p = new en(l, this, t)), this._$AV.push(p), c = n[++o];
      }
      h !== (c == null ? void 0 : c.index) && (l = C.nextNode(), h++);
    }
    return C.currentNode = Z, a;
  }
  v(t) {
    let e = 0;
...
class ft {
  ...
  _$AI(t, e = this) {
    t = nt(this, t, e), dt(t) ? t === F || t == null || t === "" ? (this._$AH !== F && this._$AR(), this._$AH = F) : t !== this._$AH && t !== ut && this._(t) : t._$litType$ !== void 0 ? this.g(t) : t.nodeType !== void 0 ? this.$(t) : Xi(t) ? this.T(t) : this._(t);
  }
  k(t) {
  ...
  _(t) {
    this._$AH !== F && dt(this._$AH) ? this._$AA.nextSibling.data = t : this.$(Z.createTextNode(t)), this._$AH = t;
  }
  g(t) {
    var e;
    const { values: s, _$litType$: n } = t, a = typeof n == "number" ? this._$AC(t) : (n.el === void 0 && (n.el = pt.createElement(xi(n.h, n.h[0]), this.options)), n);
    if (((e = this._$AH) === null || e === void 0 ? void 0 : e._$AD) === a)
      this._$AH.v(s);
    else {
      const l = new Gi(a, this), h = l.u(this.options);
      l.v(s), this.$(h), this._$AH = l;
    }
  }
  _$AC(t) {
    let e = Zs.get(t.strings);
    return e === void 0 && Zs.set(t.strings, e = new pt(t)), e;
  }
  T(t) {
  ...
  _$AI(t, e = this, s, n) {
    ...
    if (a === void 0)
      ...
      for (t = a[0], o = 0; o < a.length - 1; o++)
        c = nt(this, h[s + o], e, o), c === ut && (c = this._$AH[o]), l || (l = !dt(c) || c !== this._$AH[o]), c === F ? t = F : t !== F && (t += (c ?? "") + a[o + 1]), this._$AH[o] = c;
    }
    l && !n && this.j(t);
  }
  j(t) {
...
const Ji = it ? it.emptyScript : "";
class Qi extends At {
  constructor() {
    super(...arguments), this.type = 4;
  }
  j(t) {
    t && t !== F ? this.element.setAttribute(this.name, Ji) : this.element.removeAttribute(this.name);
  }
}
class tn extends At {
  constructor(t, e, s, n, a) {
  ...
  _$AI(t, e = this) {
    var s;
    if ((t = (s = nt(this, t, e, 0)) !== null && s !== void 0 ? s : F) === ut)
      return;
...
const Js = Et.litHtmlPolyfillSupport;
Js == null || Js(pt, ft), ((_t = Et.litHtmlVersions) !== null && _t !== void 0 ? _t : Et.litHtmlVersions = []).push("2.8.0");
const Ht = (i, t, e) => {
  var s, n;
  ...
  if (l === void 0) {
    ...
    a._$litPart$ = l = new ft(t.insertBefore(ct(), h), h, void 0, e ?? {});
  }
  return l._$AI(i), l;
}, sn = ({
  list: i,
...
class J {
  ...
  /** 重载，一般用于列表项更改 */
  reload(t) {
    Ht(sn({ list: this.list, template: this.template }), this.container), this.$el = this.container.querySelector(".mpui-picker"), this.$items = this.$el.querySelectorAll(".mpui-picker-item"), this.$items.forEach((e) => {
...
class Li {
  ...
  /** 重载，一般用于列表项更改 */
  reload(t) {
    Ht(nn({ list: this.list, template: this.template }), this.container), this.$el = this.container.querySelector(".mpui-picker"), this.$items = this.$el.querySelectorAll(".mpui-picker-item"), this.$items.forEach((e) => {
      e.addEventListener("click", () => {
...
`
  ...
  const o = u(
    ...
    `
      ...
      <div class="list-cell col-date">
        ${i.date ? Oe(new Date(i.date * 1e3), "yy-MM-dd HH:mm") : "-"}
      </div>
    `
  );
  ...
  if (c.length) {
    ...
    c.forEach(([g, w, T]) => {
      ...
      E.onclick = (m) => {
        m.stopPropagation(), w(i);
      }, p.appendChild(E);
    }), o.appendChild(p);
  }
  return o;
}, je = class je extends gt {
  constructor(t) {
    super(t, u("div", { class: `${r}-danmakulist` }, ln)), this.title = "弹幕列表", this.data = [], this.selected = [], this.focused = null, this.sortedBy = "time", this.sortOrder = -1, this.autoScroll = !0, this.frozen = !1, this.danmaku = t.plugins.danmaku, this.$main = this.$(`.${r}-danmakulist-main`), this.$container = this.$(`.${r}-danmakulist-container`), this.$status = this.$(`.${r}-danmakulist-status`), this.$colTime = this.$(".col-time"), this.$colDate = this.$(".col-date"), this.$colContent = this.$(".col-content"), this.$autoscroll = this.$(`.${r}-danmakulist-autoscroll`), this.$select = this.$(`.${r}-danmakulist-select`), this.$selectInfo = this.$(`.${r}-danmakulist-select-info`), this.$clearSelect = this.$('.list-operate-btn[data-action="clearSelect"]'), this.$clearSelect.onclick = () => {
      this.select([]);
  ...
  init() {
    ...
    this.list = new an({
      ...
      createItem: (n, a) => on(n, a, {
        ...
        title: `${n.content}
${n.date ? Oe(new Date(n.date * 1e3), "yyyy-MM-dd HH:mm:ss") : "-"} @ ${$t(n.time, 16)}`
      }),
      overflow: 5
    });
    const s = St(() => {
...
`
  ...
  constructor(t) {
    ...
    super(
      t,
      u("div", { class: `${r}-hotkeys` }, hn(e))
    ), this.title = "快捷键说明";
  }
};
Ce.pluginName = "hotkeyInfo";
let Bt = Ce;
const cn = (
  /*html*/
  `
  ...
  <div>github：<a href="${Ii}" target="_blank">mfuns-cn/mfunsPlayer</a></div>
  <div>开发者：</div>
...
`
), We = class We extends gt {
  constructor(t) {
    super(t, u("div", { class: `${r}-about` }, cn)), this.title = "关于";
  }
};
We.pluginName = "about";
let Vt = We;
...
`
), Ze = class Ze extends _ {
  constructor(t) {
    super(t, u("div", { class: `${r}-videotime` }, vn)), this.valueBeforeEdited = "", this.timeFormat = 2, this.$label = this.$(`.${r}-videotime-label`), this.$current = this.$(`.${r}-videotime-current`), this.$total = this.$(`.${r}-videotime-total`), this.$input = this.$(`.${r}-videotime-input`);
  }
  init() {
    this.player.on("timeupdate", (t) => {
      ...
      t != this.valueBeforeEdited && (this.player.seek(It(t)), this.player.play()), this.exitInput();
    }), this.$input.addEventListener("keydown", (t) => {
      const e = t || window.event;
      e.keyCode == 13 && (this.player.seek(It(this.$input.value)), this.player.play(), this.exitInput()), e.keyCode == 27 && this.exitInput();
    });
  }
  /** 退出输入模式 */
  exitInput() {
...
`
  ...
  get ignored() {
    return !this.player.enterPip || !pi;
  }
};
ss.pluginName = "buttonPip";
let Jt = ss;
const kn = (
  /*html*/
  `
...
is.pluginName = "buttonWidescreen";
let Qs = is;
const wn = (
  /*html*/
  `
...
`
  ...
  get ignored() {
    return !this.player.enterFullscreen || !ui;
  }
};
rs.pluginName = "buttonFullscreen";
let Qt = rs;
...
const ls = class ls extends k {
  ...
  apply(e, s) {
    var n;
    S(this, W, ((n = s.modal) == null ? void 0 : n.panels) || []);
  }
  ready() {
    P(this, W).forEach((e) => {
...
W = new WeakMap(), ls.pluginName = "modal";
let ee = ls;
const En = (
  /*html*/
  `
...
`
), os = class os extends _ {
  constructor(t) {
    super(t, u("div", { class: `${r}-progress` }, En)), this.trackLength = 0, this.distance = 0, this.nMax = 0, this.nLeft = 0, this.isDragging = !1, this.isHover = !1, this.isActive = !1, this.$bar = this.$(`.${r}-progress-bar`), this.$buffered = this.$(`.${r}-progress-buffered`), this.$played = this.$(`.${r}-progress-played`), this.$thumbTrack = this.$(`.${r}-progress-thumb-track`), this.$thumb = this.$(`.${r}-progress-thumb`), this.$preview = this.$(`.${r}-progress-preview`), this.$thumbnail = this.$(`.${r}-progress-thumbnail`), this.$time = this.$(`.${r}-progress-time`), this.$tip = this.$(`.${r}-progress-tip`), this.$el.addEventListener("mousedown", (n) => {
      const { clientX: a } = n;
...
`
), hs = class hs extends gt {
  constructor(t) {
    super(t, u("div", { class: `${r}-settings` }, Sn)), this.title = "设置", this.$slot = this.$(`.${r}-settings-slot`), this.$play = this.$(`.${r}-settings-play`), this.$others = this.$(`.${r}-settings-others`), this.$ratePicker = this.$(`.${r}-settings-rate-picker`), this.$ratioPicker = this.$(`.${r}-settings-ratio-picker`);
  }
  init() {
...
const cs = class cs extends k {
  ...
  apply(e, s) {
    var n;
    S(this, U, ((n = s.side) == null ? void 0 : n.panels) || []);
  }
  ready() {
    P(this, U).forEach((e) => {
      const s = this.player.plugin.from(e);
...
U = new WeakMap(), cs.pluginName = "side";
let ne = cs;
...
us.pluginName = "fullscreen";
let ae = us;
var st, vt;
const ps = class ps extends k {
  constructor() {
    super(...arguments);
    D(this, st, 0);
    D(this, vt, 0);
  ...
  init() {
    this.player.define("userId", { get: () => P(this, st) }), this.player.define("authorId", { get: () => P(this, vt) }), this.player.define("login", () => this.login()), this.player.on("videoChange", ({ author: e }) => {
      (e == null ? void 0 : e.id) != null && S(this, vt, e.id || 0);
    });
  }
  apply(e, s) {
    S(this, st, s.userId || 0);
  }
  /** 调用页面登录 */
  async login() {
    var e;
  ...
  /** 设置用户 */
  async setUser(e) {
    S(this, st, e), this.player.emit("login", e);
  }
};
st = new WeakMap(), vt = new WeakMap(), ps.pluginName = "user";
let le = ps;
var I, V;
const ms = class ms extends k {
  constructor(e) {
    ...
    D(this, I, void 0);
    D(this, V, void 0);
    S(this, I, !1), S(this, V, !1), this.activeDuration = 3e3, this.player.define("isActive", {
      get: () => P(this, I)
    });
    const s = St(() => {
      S(this, V, !1), this.remove();
    }, this.activeDuration);
    this.player.$main.addEventListener("mousemove", () => {
      S(this, V, !0), this.set(), s();
  ...
  /** 设置播放器活跃状态 */
  set() {
    P(this, I) || (this.player.$el.classList.add("is-active"), S(this, I, !0), this.player.emit("active"));
  }
  /** 移除播放器活跃状态 */
  remove() {
    !P(this, I) || P(this, V) || this.player.isControlled || this.player.hook.call("inactive").then((e) => {
      e && (this.player.$el.classList.remove("is-active"), S(this, I, !1), this.player.emit("inactive"));
    });
  }
};
I = new WeakMap(), V = new WeakMap(), ms.pluginName = "stateActive";
let oe = ms;
const vs = class vs extends k {
  constructor(t) {
...
}, ei = "ResizeObserver loop completed with undelivered notifications.", Mn = function() {
  var i;
  typeof ErrorEvent == "function" ? i = new ErrorEvent("error", {
    message: ei
  }) : (i = document.createEvent("Event"), i.initEvent("error", !1, !1), i.message = ei), window.dispatchEvent(i);
}, mt;
(function(i) {
...
var K = function(i) {
  ...
  return !1;
}, ot = typeof window < "u" ? window : {}, yt = /* @__PURE__ */ new WeakMap(), ii = /auto|scroll/, Pn = /^tb|vertical/, Rn = /msie|trident/i.test(ot.navigator && ot.navigator.userAgent), N = function(i) {
  ...
  borderBoxSize: Q(),
  contentBoxSize: Q(),
  contentRect: new Ei(0, 0, 0, 0)
}), Ti = function(i, t) {
  if (t === void 0 && (t = !1), yt.has(i) && !t)
    return yt.get(i);
  if (Si(i))
    return yt.set(i, ni), ni;
  var e = getComputedStyle(i), s = qe(i) && i.ownerSVGElement && i.getBBox(), n = !Rn && e.boxSizing === "border-box", a = Pn.test(e.writingMode || ""), l = !s && ii.test(e.overflowY || ""), h = !s && ii.test(e.overflowX || ""), o = s ? 0 : N(e.paddingTop), c = s ? 0 : N(e.paddingRight), p = s ? 0 : N(e.paddingBottom), g = s ? 0 : N(e.paddingLeft), w = s ? 0 : N(e.borderTopWidth), T = s ? 0 : N(e.borderRightWidth), E = s ? 0 : N(e.borderBottomWidth), m = s ? 0 : N(e.borderLeftWidth), v = g + c, d = o + p, $ = m + T, L = w + E, y = h ? i.offsetHeight - L - i.clientHeight : 0, A = l ? i.offsetWidth - $ - i.clientWidth : 0, b = n ? v + $ : 0, x = n ? d + L : 0, H = s ? s.width : N(e.width) - b - A, f = s ? s.height : N(e.height) - x - y, M = H + v + A + $, R = f + d + y + L, rt = K({
    devicePixelContentBoxSize: Q(Math.round(H * devicePixelRatio), Math.round(f * devicePixelRatio), a),
    borderBoxSize: Q(M, R, a),
    contentBoxSize: Q(H, f, a),
    contentRect: new Ei(g, o, H, f)
  });
  return yt.set(i, rt), rt;
}, Ai = function(i, t, e) {
  var s = Ti(i, e), n = s.borderBoxSize, a = s.contentBoxSize, l = s.devicePixelContentBoxSize;
  switch (t) {
  ...
  Y.forEach(function(l) {
    if (l.activeTargets.length !== 0) {
      ...
      l.activeTargets.forEach(function(c) {
        var p = new Dn(c.target), g = Hi(c.target);
        h.push(p), c.lastReportedSize = Ai(c.target, c.observedBox), g < i && (i = g);
      }), t.push(function() {
  ...
  Y.forEach(function(e) {
    e.activeTargets.splice(0, e.activeTargets.length), e.skippedTargets.splice(0, e.skippedTargets.length), e.observationTargets.forEach(function(n) {
      n.isActive() && (Hi(n.target) > i ? e.activeTargets.push(n) : e.skippedTargets.push(n));
    });
  });
}, In = function() {
  var i = 0;
  ...
  return Mi.splice(0).forEach(function(i) {
    return i();
  });
}, On = function(i) {
  if (!Pt) {
  ...
  return !!xt;
}, qn = 250, jn = { attributes: !0, characterData: !0, childList: !0, subtree: !0 }, ai = [
  "resize",
  "load",
  "transitionend",
  "animationend",
  ...
  return i.prototype.run = function(t) {
    ...
    var t = this, e = function() {
      return t.observer && t.observer.observe(document.body, jn);
    };
    document.body ? e() : ot.addEventListener("DOMContentLoaded", e);
  }, i.prototype.start = function() {
    var t = this;
    this.stopped && (this.stopped = !1, this.observer = new MutationObserver(this.listener), this.observe(), ai.forEach(function(e) {
      return ot.addEventListener(e, t.listener, !0);
    }));
  }, i.prototype.stop = function() {
    var t = this;
    this.stopped || (this.observer && this.observer.disconnect(), ai.forEach(function(e) {
      return ot.removeEventListener(e, t.listener, !0);
    }), this.stopped = !0);
  }, i;
}(), ce = new Cn(), oi = function(i) {
  !xt && i > 0 && ce.start(), xt += i, !xt && ce.stop();
}, Wn = function(i) {
  return !qe(i) && !Fn(i) && getComputedStyle(i).display === "inline";
}, Un = function() {
  function i(t, e) {
  ...
  return i.prototype.isActive = function() {
    var t = Ai(this.target, this.observedBox, !0);
  ...
  return i;
}(), bt = /* @__PURE__ */ new WeakMap(), hi = function(i, t) {
  ...
  return i.connect = function(t, e) {
    ...
    hi(n.observationTargets, e) < 0 && (a && Y.push(n), n.observationTargets.push(new Un(e, s && s.box)), oi(1), ce.schedule());
  }, i.unobserve = function(t, e) {
    var s = bt.get(t), n = hi(s.observationTargets, e), a = s.observationTargets.length === 1;
    n >= 0 && (a && Y.splice(Y.indexOf(s), 1), s.observationTargets.splice(n, 1), oi(-1));
...
const $s = class $s extends k {
  constructor(t) {
    super(t);
    const e = window.ResizeObserver || _i;
...
$s.pluginName = "stateResize";
let de = $s;
const gs = class gs extends k {
  constructor(t) {
...
gs.pluginName = "stateIntersecting";
let ue = gs;
class Yn extends Tt {
  constructor(t) {
...
const Kn = [
  ...
  Jt,
  Qt
], Jn = [...Kn, ...Gn, ...Zn], fs = class fs extends k {
  constructor() {
...
const Dt = {
  ...
  setTheme(t) {
    Object.assign(this.properties, t), this.themeElement.forEach((e) => {
      let s;
      for (s in t)
        e.style.setProperty(Dt[s], t[s]);
    });
  }
  /** 设置某个主题属性 */
  set(t, e) {
    this.properties[t] = e, this.themeElement.forEach((s) => {
      s.style.setProperty(Dt[t], e);
    });
  }
  get(t) {
...
Es.pluginName = "buttonQuality";
let be = Es;
const Ss = class Ss extends k {
  constructor() {
...
`
), Ts = class Ts extends Tt {
  constructor(t) {
    super(t, u("div", { class: `${r}-videostatus` }, sr)), this.$paused = this.$(`.${r}-videostatus-paused`), this.$loading = this.$(`.${r}-videostatus-loading`), this.$volume = this.$(`.${r}-videostatus-volume`), this.player.$area.appendChild(this.$el), this.player.on("volumechange", (s, n) => {
      n && s > 0 ? this.$volume.innerText = "已静音" : this.$volume.innerText = `音量 | ${Math.round(s * 100)}%`;
    });
    const e = St(() => this.hideVolume(), 3e3);
...
`
), As = class As extends Tt {
  constructor(t) {
    super(t, u("div", { class: `${r}-loadingmask` }, ir)), this.delay = 0, this.$info = this.$(`.${r}-loadingmask-info`), this.$tips = this.$(`.${r}-loadingmask-tips`), this.player.$main.appendChild(this.$el);
  }
  apply(t, e) {
    var s, n;
...
Ms.pluginName = "header";
let Ee = Ms;
const _s = class _s extends k {
  constructor(t) {
...
_s.pluginName = "danmaku";
let Se = _s;
var Lt = /* @__PURE__ */ ((i) => (i[i.roll = 1] = "roll", i[i.bottom = 4] = "bottom", i[i.top = 5] = "top", i[i.reverse = 6] = "reverse", i[i.special = 7] = "special", i[i.advanced = 9] = "advanced", i))(Lt || {});
class rr {
  constructor(t, e) {
  ...
  /** 检查弹幕类型过滤 */
  checkTrackFilter(t) {
    return !this.trackFilter[Lt[t.mode]];
  }
  /** 设置弹幕颜色过滤 */
  setColorFilter(t) {
  ...
  draw(t) {
    ...
    for (let m = 0; m < t.length; m++) {
      ...
      d.classList.add(`${this.classPrefix}-danmaku-item`), d.classList.add(`${this.classPrefix}-danmaku-${Lt[v.mode]}`), d.innerHTML = `${v.content.replace(/(\\n)/g, `
`)}`, typeof v.color == "number" ? d.style.color = $i(v.color) : d.style.color = v.color, d.style.opacity = this.opacity.toString(), d.style.fontSize = +v.size * this.fontScale + "px", v.fromHere && (d.style.border = "2px solid white"), d.addEventListener("animationend", () => {
      ...
      switch (L) {
        ...
        case "top":
          if (y = p(d, L, 0) % a, y >= 0) {
            ...
            for (const f of x)
              b.push(...f);
            const H = b.map((f) => parseInt(f.style.fontSize) + this.trackPadding).slice(0, y).reduce((f, M) => f + M, 0);
  ...
  captureDanmakuDOM(t, e, s, n = !1) {
    ...
    for (const h of l)
      if (h.innerHTML) {
        const o = h.getBoundingClientRect(), c = this.container.getBoundingClientRect(), p = o.left - c.left, g = o.right - c.left, w = o.top - c.top, T = o.bottom - c.top;
        if (t >= p - s && t <= g + s && e >= w - s && e <= T + s && (a.push(h), n))
          return a;
      }
    return a;
  }
...
function ar() {
  const i = [], t = di.length;
  for (let e = 0; e < 8; e++)
    i.push(di[Math.floor(Math.random() * t)]);
  return ci++, i.join("") + `${ci}`;
}
const Ps = class Ps extends k {
  constructor() {
    super(...arguments), this.type = "", this.parser = lr;
  }
  get danmaku() {
...
Ds.pluginName = "buttonDanmakuToggle";
let Me = Ds;
const hr = (
  /*html*/
  `
...
const Ns = class Ns extends _ {
  constructor(e) {
    ...
    this.danmakuColor = 16777215, this.danmakuMode = 1, this.danmakuSize = 25, S(this, X, !1), this.coolDownTimer = 0, this.controls = {}, this.controller = this.plugins.controller, this.danmaku = this.plugins.danmaku, this.$send = this.$el.querySelector(`.${r}-danmakubar-send`), this.$input = this.$el.querySelector(`.${r}-danmakubar-input`), this.$outer = this.$el.querySelector(`.${r}-danmakubar-outer`), this.$left = this.$el.querySelector(`.${r}-danmakubar-left`), this.$right = this.$el.querySelector(`.${r}-danmakubar-right`), this.$logina = this.$el.querySelector(`.${r}-danmakubar-status-login a`), this.$logina.onclick = () => {
      ...
      P(this, X) && this.setLoginStatus(!s);
    }), this.$input.addEventListener("keydown", (s) => {
      s.keyCode == j.Enter && this.send();
    }), this.$send.onclick = () => {
      this.send();
    };
  }
  ...
  apply(e, s) {
    var n, a, l;
    (n = s.danmakuBar) != null && n.loginRequired && (S(this, X, !0), !e.userId && this.setLoginStatus(!0)), this.setPlaceHolder(((a = s.danmakuBar) == null ? void 0 : a.placeholder) || cr), this.controls = ((l = s.danmakuBar) == null ? void 0 : l.controls) || {};
  }
  ready() {
    this.setControls(this.controls);
  }
  ...
  setControls(e) {
    this.controls = e;
    const { outer: s, left: n, right: a } = e;
    this.build(this.$outer, s), this.build(this.$left, n), this.build(this.$right, a);
  }
  setPlaceHolder(e) {
  ...
  build(e, s) {
    ...
    s == null || s.forEach((a) => {
      var h;
      const l = (h = this.player.plugin.from(a)) == null ? void 0 : h.$el;
      l && n.appendChild(l);
    }), e.appendChild(n);
  }
  /** 执行弹幕发送操作 */
...
X = new WeakMap(), Ns.pluginName = "danmakuBar";
let _e = Ns;
const cr = "发条弹幕吧~", dr = (
  /*html*/
  `
...
Is.pluginName = "buttonDanmakuSettings";
let Fe = Is;
const ur = (i, t, e, s) => O`
  ${i.map(
  (n) => O`
...
`, pr = (i) => navigator.clipboard.writeText(i), zs = class zs extends k {
  constructor(t) {
  ...
  update(t) {
    ...
    t != null && t.length ? this.$el.style.display = "" : this.$el.style.display = "none", Ht(
      ur(
        t,
        (n) => {
...
`
  ...
  init(t) {
    this.pickerSize = new J({
      ...
      value: "#FFFFFF",
      list: gr.map((e) => ({ value: e })),
      onPick: (e) => {
        this.danmakuBar.danmakuColor = vi(e);
      },
      onChange: (e) => {
...
Os.pluginName = "buttonDanmakuStyle";
let Re = Os;
const vr = [
  [18, "小"],
  [25, "中"],
...
Vs.pluginName = "hlsLoader";
let Ne = Vs;
const qs = class qs extends k {
  constructor(t) {
    super(t);
  }
  apply(t, e) {
...
qs.pluginName = "dashLoader";
let Ie = qs;
var z;
const js = class js extends k {
  constructor(e) {
    super(e);
    D(this, z, null);
    const s = window.ResizeObserver || _i;
  ...
  apply(e, s) {
    S(this, z, this._parse(s.aspectRatio || ""));
  }
  init() {
  ...
  set(e) {
    ...
    S(this, z, s), this._setRatio(s), this.player.emit("aspectRatioChange", this._stringify(s));
  }
  /** 设置视频比例 */
  _setRatio(e) {
...
z = new WeakMap(), js.pluginName = "aspectRatio";
let ze = js;
const wr = [
  ke,
  kr,
  ...
  we,
  xe
], xr = [ye, be, Le], Lr = [Vt, Bt, fe], Er = [De, Ne, Ie], Sr = [
  ...Jn,
  ...br,
  ...wr,
  ...Lr,
