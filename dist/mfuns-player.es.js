const J = (s, t) => Array.from({ length: s }, () => t), Ts = () => document.fullscreenElement || document.mozFullScreenElement || document.webkitFullscreenElement || document.msFullscreenElement || null, _s = document.fullscreenEnabled || document.webkitFullscreenEnabled || document.mozFullScreenEnabled || document.msFullscreenEnabled || !1, As = document.pictureInPictureEnabled, Rt = (s) => {
...
const Pt = class de {
  constructor(t) {
    this.hook = new Rs(), this.plugin = {}, this._eventEmitter = new Os(), this.Player = de, this.container = t.container, this.$el = F("div", { class: `${r} mpui` }), this.$main = this.$el.appendChild(F("div", { class: `${r}-main` })), this.$area = this.$main.appendChild(F("div", { class: `${r}-area` })), this.$content = this.$area.appendChild(
      F("div", { class: `${r}-content` })
 ...
 */
var xt;
const bt = window, G = bt.trustedTypes, It = G ? G.createPolicy("lit-html", { createHTML: (s) => s }) : void 0, Dt = "$lit$", B = `lit$${(Math.random() + "").slice(9)}$`, ue = "?" + B, zs = `<${ue}>`, U = document, nt = () => U.createComment(""), rt = (s) => s === null || typeof s != "object" && typeof s != "function", pe = Array.isArray, Vs = (s) => pe(s) || typeof (s == null ? void 0 : s[Symbol.iterator]) == "function", St = `[ 	
\f\r]`, Q = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, qt = /-->/g, Ot = />/g, I = RegExp(`>|${St}(?:([^\\s"'>=/]+)(${St}*=${St}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), zt = /'/g, Vt = /"/g, me = /^(?:script|style|textarea|title)$/i, Ws = (s) => (t, ...e) => ({ _$litType$: s, strings: t, values: e }), p = Ws(1), at = Symbol.for("lit-noChange"), H = Symbol.for("lit-nothing"), Wt = /* @__PURE__ */ new WeakMap(), V = U.createTreeWalker(U, 129, null, !1);
function ve(s, t) {
...
const Cs = (s, t) => {
  ...
  for (let o = 0; o < e; o++) {
    ...
    for (; x < h.length && (l.lastIndex = x, u = l.exec(h), u !== null); )
      x = l.lastIndex, l === Q ? u[1] === "!--" ? l = qt : u[1] !== void 0 ? l = Ot : u[2] !== void 0 ? (me.test(u[2]) && (n = RegExp("</" + u[2], "g")), l = I) : u[3] !== void 0 && (l = I) : l === I ? u[0] === ">" ? (l = n ?? Q, f = -1) : u[1] === void 0 ? f = -2 : (f = l.lastIndex - u[2].length, c = u[1], l = u[3] === void 0 ? I : u[3] === '"' ? Vt : zt) : l === Vt || l === zt ? l = I : l === qt || l === Ot ? l = Q : (l = I, n = void 0);
    const T = l === I && s[o + 1].startsWith("/>") ? " " : "";
    a += l === Q ? h + zs : f >= 0 ? (i.push(c), h.slice(0, f) + Dt + h.slice(f) + B + T) : h + B + (f === -2 ? (i.push(void 0), o) : T);
  }
  return [ve(s, a + (s[e] || "<?>") + (t === 2 ? "</svg>" : "")), i];
};
class lt {
      ...
      if (n.nodeType === 1) {
        if (n.hasAttributes()) {
          ...
          for (const x of n.getAttributeNames())
            if (x.endsWith(Dt) || x.startsWith(B)) {
              const T = u[l++];
              if (f.push(x), T !== void 0) {
                const L = n.getAttribute(T.toLowerCase() + Dt).split(B), v = /([.?@])?(.*)/.exec(T);
        ...
        if (me.test(n.tagName)) {
          ...
          if (x > 0) {
            ...
            for (let T = 0; T < x; T++)
              n.append(f[T], nt()), V.nextNode(), h.push({ type: 2, index: ++a });
            n.append(f[x], nt());
          }
        }
...
class ht {
  ...
  _$AI(t, e = this) {
    t = Y(this, t, e), rt(t) ? t === H || t == null || t === "" ? (this._$AH !== H && this._$AR(), this._$AH = H) : t !== this._$AH && t !== at && this._(t) : t._$litType$ !== void 0 ? this.g(t) : t.nodeType !== void 0 ? this.$(t) : Vs(t) ? this.T(t) : this._(t);
  }
  k(t) {
  ...
  _(t) {
    this._$AH !== H && rt(this._$AH) ? this._$AA.nextSibling.data = t : this.$(U.createTextNode(t)), this._$AH = t;
  }
  g(t) {
    var e;
    const { values: i, _$litType$: n } = t, a = typeof n == "number" ? this._$AC(t) : (n.el === void 0 && (n.el = lt.createElement(ve(n.h, n.h[0]), this.options)), n);
  ...
  _$AC(t) {
    ...
    return e === void 0 && Wt.set(t.strings, e = new lt(t)), e;
  }
  T(t) {
  ...
  _$AI(t, e = this, i, n) {
    ...
    if (a === void 0)
      ...
      for (t = a[0], h = 0; h < a.length - 1; h++)
        c = Y(this, o[i + h], e, h), c === at && (c = this._$AH[h]), l || (l = !rt(c) || c !== this._$AH[h]), c === H ? t = H : t !== H && (t += (c ?? "") + a[h + 1]), this._$AH[h] = c;
    }
    l && !n && this.j(t);
  }
  j(t) {
...
class Gs extends wt {
  ...
  j(t) {
    t && t !== H ? this.element.setAttribute(this.name, Xs) : this.element.removeAttribute(this.name);
  }
}
class Ys extends wt {
  constructor(t, e, i, n, a) {
  ...
  _$AI(t, e = this) {
    var i;
    if ((t = (i = Y(this, t, e, 0)) !== null && i !== void 0 ? i : H) === at)
      return;
...
const Ct = bt.litHtmlPolyfillSupport;
Ct == null || Ct(lt, ht), ((xt = bt.litHtmlVersions) !== null && xt !== void 0 ? xt : bt.litHtmlVersions = []).push("2.8.0");
const $ = (s, t, e) => {
  var i, n;
  ...
  const h = p`
    ...
    >
      ...
      <div class="list-cell col-date">
        ${s.date ? ce(new Date(s.date * 1e3), "yy-MM-dd HH:mm") : "-"}
      </div>
  ...
  init() {
    ...
    this.list = new Qs({
      ...
      createItem: (a, l) => Js(a, l, {
        ...
        title: (o) => `${o.content}
${a.date ? ce(new Date(a.date * 1e3), "yyyy-MM-dd HH:mm:ss") : "-"} @ ${z(a.time, !1)}`
      }),
      overflow: 5
    });
    const i = he(() => {
...
class ye extends w {
  constructor(t) {
    super(t), this.list = [], this.isShow = !1, this.player = t, this.container = F("div", { class: `${r}-contextmenu-wrap` }), $(si(), this.container), this.$el = this.container.querySelector(`.${r}-contextmenu`), this.$list = this.$el.querySelector(`.${r}-contextmenu-list`), this.player.$main.appendChild(this.container);
  }
  apply(t, e) {
    var i;
  ...
  setMenu(t) {
    ...
    const e = new DocumentFragment();
    t.forEach((i) => {
      const n = F("li", { class: `${r}-contextmenu-item` });
      i.onClick && (n.onclick = () => {
        var l;
...
class dt {
  constructor({
    ...
    this.container = t, this.min = e, this.max = i, this.step = n || 0, this.divider = a ? typeof a == "boolean" ? this.step : a : 0, this.value = isNaN(l) ? l : Number(l), this.onChange = o, this.onDragStart = h, this.onDragEnd = c, this.onDrag = u, $(ci({ divider: this.divider }), t), this.$el = this.container.querySelector(".mpui-slider"), this.$track = this.$el.querySelector(".mpui-slider-track"), this.$bar = this.$track.querySelector(".mpui-slider-bar"), this.$thumbTrack = this.$track.querySelector(".mpui-slider-thumb-track"), this.$thumb = this.$track.querySelector(".mpui-slider-thumb"), this.$el.addEventListener("mousedown", (f) => {
      var k;
      const x = f, { clientX: T } = x, L = this.$track.offsetWidth;
      ...
      const b = (S) => {
        ...
        var y, D;
        S.stopPropagation(), (y = window.getSelection()) == null || y.removeAllRanges(), document.removeEventListener("mousemove", b), document.removeEventListener("mouseup", _), (D = this.onDragEnd) == null || D.call(this, E);
      };
...
class ui {
  constructor({
    ...
    this.container = t, this.min = e, this.max = i, this.step = n || 0, this.value = isNaN(a) ? a : Number(a), this.onChange = l, this.onDragStart = o, this.onDragEnd = h, this.onDrag = c, $(di(), t), this.$el = this.container.querySelector(".mpui-slider"), this.$track = this.$el.querySelector(".mpui-slider-track"), this.$bar = this.$track.querySelector(".mpui-slider-bar"), this.$thumbTrack = this.$track.querySelector(".mpui-slider-thumb-track"), this.$thumb = this.$track.querySelector(".mpui-slider-thumb"), this.$el.addEventListener("mousedown", (u) => {
      var _;
      const f = u, { clientY: x } = f, T = this.$track.offsetHeight;
      let L = this.$thumbTrack.offsetHeight;
      L = L || T;
      const v = (T - L) / 2, m = this.$el.getBoundingClientRect().top;
      let d = L - (x - m - v);
      d = d >= L ? L : d <= 0 ? 0 : d;
...
class Fe extends P {
  ...
  get ignored() {
    return !this.player.enterFullscreen || !_s;
  }
}
...
}, jt = (s, t, e, i) => (He(s, t, "write to private field"), i ? i.call(s, e) : t.set(s, e), e), tt;
const Ti = () => p`
...
class Me extends w {
  ...
  apply(t, e) {
    var i;
    jt(this, tt, ((i = e.modal) == null ? void 0 : i.panels) || []);
  }
  ready() {
...
class Re extends P {
  constructor(t) {
    const e = new DocumentFragment();
    $(_i(), e), super(t, e.querySelector(`.${r}-progress`)), this.name = "progress", this.trackLength = 0, this.distance = 0, this.nMax = 0, this.nLeft = 0, this.isDragging = !1, this.isHover = !1, this.isActive = !1, this.$bar = this.$(`.${r}-progress-bar`), this.$buffered = this.$(`.${r}-progress-buffered`), this.$played = this.$(`.${r}-progress-played`), this.$thumbTrack = this.$(`.${r}-progress-thumb-track`), this.$thumb = this.$(`.${r}-progress-thumb`), this.$preview = this.$(`.${r}-progress-preview`), this.$thumbnail = this.$(`.${r}-progress-thumbnail`), this.$time = this.$(`.${r}-progress-time`), this.$tip = this.$(`.${r}-progress-tip`), this.$el.addEventListener("mousedown", (a) => {
      const { clientX: l } = a;
...
var Be = (s, t, e) => {
  ...
  if (t.has(s))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(s) : t.set(s, e);
}, Xt = (s, t, e, i) => (Be(s, t, "write to private field"), i ? i.call(s, e) : t.set(s, e), e), et;
const Pi = () => p`
...
class Ie extends w {
  ...
  apply(t, e) {
    var i;
    Xt(this, et, ((i = e.side) == null ? void 0 : i.panels) || []);
  }
  ready() {
...
var ze = (s, t, e) => {
  if (!t.has(s))
    throw TypeError("Cannot " + e);
}, Gt = (s, t, e) => (ze(s, t, "read from private field"), e ? e.call(s) : t.get(s)), Yt = (s, t, e) => {
  if (t.has(s))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(s) : t.set(s, e);
...
class Ve extends w {
  constructor() {
    super(...arguments), Yt(this, st, 0), Yt(this, $t, 0);
  }
  init() {
    this.player.define("userId", { get: () => Gt(this, st) }), this.player.define("authorId", { get: () => Gt(this, $t) }), this.player.define("login", () => this.login()), this.player.on("videoChange", ({ author: t }) => {
...
var We = (s, t, e) => {
  if (!t.has(s))
    throw TypeError("Cannot " + e);
}, ut = (s, t, e) => (We(s, t, "read from private field"), e ? e.call(s) : t.get(s)), Kt = (s, t, e) => {
  if (t.has(s))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(s) : t.set(s, e);
...
class Ce extends w {
  constructor(t) {
    super(t), Kt(this, q, !1), Kt(this, j, !1), this.activeDuration = 3e3, this.player.define("isActive", {
      get: () => ut(this, q)
    });
    const e = he(() => {
...
}, Qt = "ResizeObserver loop completed with undelivered notifications.", Ri = function() {
  var s;
  typeof ErrorEvent == "function" ? s = new ErrorEvent("error", {
    message: Qt
  }) : (s = document.createEvent("Event"), s.initEvent("error", !1, !1), s.message = Qt), window.dispatchEvent(s);
}, ot;
(function(s) {
...
var C = function(s) {
  ...
  return !1;
}, it = typeof window < "u" ? window : {}, pt = /* @__PURE__ */ new WeakMap(), Jt = /auto|scroll/, Ii = /^tb|vertical/, qi = /msie|trident/i.test(it.navigator && it.navigator.userAgent), R = function(s) {
  ...
  if (t === void 0 && (t = !1), pt.has(s) && !t)
    return pt.get(s);
  if (Xe(s))
    return pt.set(s, te), te;
  var e = getComputedStyle(s), i = Mt(s) && s.ownerSVGElement && s.getBBox(), n = !qi && e.boxSizing === "border-box", a = Ii.test(e.writingMode || ""), l = !i && Jt.test(e.overflowY || ""), o = !i && Jt.test(e.overflowX || ""), h = i ? 0 : R(e.paddingTop), c = i ? 0 : R(e.paddingRight), u = i ? 0 : R(e.paddingBottom), f = i ? 0 : R(e.paddingLeft), x = i ? 0 : R(e.borderTopWidth), T = i ? 0 : R(e.borderRightWidth), L = i ? 0 : R(e.borderBottomWidth), v = i ? 0 : R(e.borderLeftWidth), m = f + c, d = h + u, g = v + T, E = x + L, b = o ? s.offsetHeight - E - s.clientHeight : 0, _ = l ? s.offsetWidth - g - s.clientWidth : 0, k = n ? m + g : 0, S = n ? d + E : 0, A = i ? i.width : R(e.width) - k - _, y = i ? i.height : R(e.height) - S - b, D = A + m + _ + g, M = y + d + b + E, K = C({
  ...
  return !!ft;
}, Xi = 250, Gi = { attributes: !0, characterData: !0, childList: !0, subtree: !0 }, se = [
  "resize",
  "load",
  "transitionend",
  "animationend",
  ...
  return s.prototype.run = function(t) {
    ...
    var t = this;
    this.stopped && (this.stopped = !1, this.observer = new MutationObserver(this.listener), this.observe(), se.forEach(function(e) {
      return it.addEventListener(e, t.listener, !0);
    }));
  }, s.prototype.stop = function() {
    var t = this;
    this.stopped || (this.observer && this.observer.disconnect(), se.forEach(function(e) {
      return it.removeEventListener(e, t.listener, !0);
    }), this.stopped = !0);
  }, s;
}(), Ft = new Yi(), ne = function(s) {
  !ft && s > 0 && Ft.start(), ft += s, !ft && Ft.stop();
}, Ki = function(s) {
  return !Mt(s) && !Bi(s) && getComputedStyle(s).display === "inline";
}, Qi = function() {
  function s(t, e) {
  ...
  return s;
}(), mt = /* @__PURE__ */ new WeakMap(), re = function(s, t) {
  ...
  return s.connect = function(t, e) {
    ...
    re(n.observationTargets, e) < 0 && (a && W.push(n), n.observationTargets.push(new Qi(e, i && i.box)), ne(1), Ft.schedule());
  }, s.unobserve = function(t, e) {
    var i = mt.get(t), n = re(i.observationTargets, e), a = i.observationTargets.length === 1;
    n >= 0 && (a && W.splice(W.indexOf(i), 1), i.observationTargets.splice(n, 1), ne(-1));
...
class Ji extends Ht {
  constructor(t) {
    super(t, F("div", { class: `${r}-toast` })), this.defaultDuration = 5e3, this.player.$area.appendChild(this.$el);
  }
  init() {
    this.player.define(
      "toast",
  ...
  /** 创建一个toast元素 */
  createToastItem(t) {
    const e = F("div", { class: `${r}-toast-item` });
    e.appendChild(
      F("div", { class: `${r}-toast-item-content` })
...
class is extends w {
  ...
  setTheme(t) {
    Object.assign(this.properties, t), this.themeElement.forEach((e) => {
      let i;
      for (i in t)
        e.style.setProperty(_t[i], t[i]);
    });
  }
  /** 设置某个主题属性 */
  set(t, e) {
    this.properties[t] = e, this.themeElement.forEach((i) => {
      i.style.setProperty(_t[t], e);
    });
  }
  get(t) {
...
class as extends ct {
  constructor(t) {
    const e = new DocumentFragment();
    $(rn, e), super(t, e.querySelector(`.${r}-partlist`)), this.name = "partList", this.title = "分P列表", this._part = 0, this._list = [], this.$list = this.$(`.${r}-partlist-list`);
  }
  init() {
    this.player.on("videoChange", (t) => {
...
class ls extends P {
  constructor(t) {
    const e = new DocumentFragment();
    $(ln, e), super(t, e.querySelector(`.${r}-controls-button`)), this.name = "danmakuList", this.$icon = this.$(`.${r}-controls-button-icon`), this.$text = this.$(`.${r}-controls-button-text`), this.$tooltip = this.$(".mpui-tooltip");
  }
  init() {
    this.$icon.addEventListener("click", () => {
      var t;
...
class os extends P {
  constructor(t) {
    const e = new DocumentFragment();
    $(on, e), super(t, e.querySelector(`.${r}-controls-button`)), this.name = "quality", this._itemMap = /* @__PURE__ */ new Map(), this.$icon = this.$(`.${r}-controls-button-icon`), this.$text = this.$(`.${r}-controls-button-text`), this.$panel = this.$(`.${r}-controls-panel`), this.$list = this.$(`.${r}-button-quality-list`);
  }
  init() {
...
class cs extends w {
  constructor(t) {
    super(t), this.$el = F("div", { class: `${r}-videostatus` }), $(hn, this.$el), this.$paused = this.$el.querySelector(`.${r}-videostatus-paused`), this.$loading = this.$el.querySelector(`.${r}-videostatus-loading`), this.$volume = this.$el.querySelector(`.${r}-videostatus-volume`), this.player.$area.appendChild(this.$el);
  }
}
...
class ds extends w {
  constructor(t) {
    super(t), this.delay = 0, this.$el = F("div", { class: `${r}-loadingmask` }), $(cn, this.$el), this.$info = this.$el.querySelector(`.${r}-loadingmask-info`), this.$tips = this.$el.querySelector(`.${r}-loadingmask-tips`), this.player.$main.appendChild(this.$el);
  }
  apply(t, e) {
    var i, n;
  ...
  _add(t, e) {
    const i = F("div", { class: `${r}-loadingmask-info-item` });
...
class us extends P {
  constructor(t) {
    super(t, F("div", { class: `${r}-videotitle` })), this.name = "title";
  }
  init() {
    this.player.on("videoChange", (t) => {
...
class ms extends w {
  constructor(t) {
    super(t), this.handler = {}, this._status = !0, this.invoke = {}, this.$el = F("div", { class: `${r}-danmaku-wrap` }), this.player.$content.after(this.$el);
  }
  get status() {
    return this._status;
  }
        ...
        for (let g = 0; this.overlap || g < a; g++) {
          ...
          if (this.danmakuTracks[m][g] = E, b && b.length) {
            if (m === "roll") {
              ...
              for (const k of b) {
                const S = l(k) - 10;
                if (this.trackHeights[m][g] = parseInt(k.style.fontSize) + this.trackPadding, S <= i - _ * h(k.getBoundingClientRect().width) || S <= 0)
                  continue t;
              }
            } else if (m === "reverse") {
              const _ = i / h(d);
            ...
            return this.danmakuTracks[m][g].push(v), v.addEventListener("animationend", () => {
              var k, S;
              const _ = (k = this.danmakuTracks[m][g]) == null ? void 0 : k.indexOf(v);
...
`)}`, typeof m.color == "number" ? d.style.color = Ds(m.color) : d.style.color = m.color, d.style.opacity = this.opacity.toString(), d.style.fontSize = +m.size * this.fontScale + "px", m.fromHere && (d.style.border = "2px solid white"), d.addEventListener("animationend", () => {
      ...
      switch (E) {
        ...
        case "reverse":
          if (_ = u(d, E, g), b = _ % a, b >= 0) {
            ...
            d.dataset.track = _.toString(), d.style.width = g + 1 + "px", d.style.top = S + "px", d.style.fontFamily = this.fontFamily, d.style.fontWeight = this.fontWeight, d.style.setProperty("--duration", `${y / A}s`), d.style.setProperty("--offset", `${i + this.startDistance}px`), d.style.setProperty("--translateX", `${-y}px`);
          }
          break;
        case "top":
          if (b = u(d, E, 0) % a, b >= 0) {
  ...
  captureDanmakuDOM(t, e, i, n = !1) {
    ...
    for (const o of l)
      if (o.innerHTML) {
        const h = o.getBoundingClientRect(), c = this.container.getBoundingClientRect(), u = h.left - c.left, f = h.right - c.left, x = h.top - c.top, T = h.bottom - c.top;
        if (t >= u - i && t <= f + i && e >= x - i && e <= T + i && (a.push(o), n))
          return a;
      }
    return a;
  }
...
class vs extends w {
  constructor(t) {
    super(t), this.$el = this.plugin.danmaku.$el.appendChild(
      F("div", { class: `${r}-rowdanmaku` })
    ), this.core = new un(this.$el, {
...
function pn() {
  const s = [], t = le.length;
  for (let e = 0; e < 8; e++)
    s.push(le[Math.floor(Math.random() * t)]);
  return ae++, s.join("") + `${ae}`;
}
class gs extends w {
  constructor() {
    super(...arguments), this.type = "", this.parser = mn;
  }
  get danmaku() {
...
class fs extends P {
  constructor(t) {
    const e = new DocumentFragment();
    $(vn, e), super(t, e.querySelector(`.${r}-controls-button`)), this.name = "danmakuToggle", this.$icon = this.$(`.${r}-controls-button-icon`), this.$tooltip = this.$(".mpui-tooltip");
  }
  init() {
    this.player.on("danmaku:on", () => {
      this._change(!0);
...
class ys extends P {
  ...
  apply(t, e) {
    var i, n;
    (i = e.danmakuBar) != null && i.loginRequired && this.setLoginRequired(!0), this.setPlaceHolder(((n = e.danmakuBar) == null ? void 0 : n.placeholder) || $n);
  }
  setPlaceHolder(t) {
...
`, bn = (s) => navigator.clipboard.writeText(s);
class ws extends w {
  constructor(t) {
    super(t), this.$el = F("ul", { class: `${r}-contextmenu-danmaku mpui-black` });
  }
  init() {
...
var Es = (s, t, e) => {
  if (!t.has(s))
    throw TypeError("Cannot " + e);
}, gt = (s, t, e) => (Es(s, t, "read from private field"), e ? e.call(s) : t.get(s)), En = (s, t, e) => {
  if (t.has(s))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(s) : t.set(s, e);
}, oe = (s, t, e, i) => (Es(s, t, "write to private field"), i ? i.call(s, e) : t.set(s, e), e), N;
class Ls extends w {
  constructor(t) {
    super(t), En(this, N, null);
    const e = window.ResizeObserver || Ze;
    e && (this.observer = new e(([i]) => {
      const { width: n, height: a } = i.contentRect;
      this._keepRatio(n, a);
  ...
  apply(t, e) {
    oe(this, N, this._parse(e.aspectRatio || ""));
  }
  init() {
  ...
  set(t) {
    ...
    oe(this, N, e), this._setRatio(e), this.player.emit("aspectRatioChange", this._stringify(e));
  }
  /** 设置视频比例 */
  _setRatio(t) {
...
const Ln = [
  ...
  cs,
  ds
], Tn = [ls, os, us], _n = [fe, $e, as], An = [ks, xs, Ss];
class Dn extends At {
  constructor(t) {
    super({
      autoPart: !0,
