...
var M = (i, t, e) => (li(i, t, "read from private field"), e ? e.call(i) : t.get(i)), R = (i, t, e) => {
  if (t.has(i))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(i) : t.set(i, e);
}, E = (i, t, e, s) => (li(i, t, "write to private field"), s ? s.call(i, e) : t.set(i, e), e);
const Xi = /mobile/i.test(window.navigator.userAgent), Si = document.fullscreenEnabled || document.webkitFullscreenEnabled || document.mozFullScreenEnabled || document.msFullscreenEnabled || !1, Ai = document.pictureInPictureEnabled || !1;
function u(i, t, e) {
...
function Ze(...i) {
  ...
  return i.shift(), i.forEach((e) => {
    if (Et(e)) {
      Et(t) || (t = {});
      for (const s in e)
        t[s] && Et(e[s]) ? t[s] = Ze(t[s], e[s]) : t[s] = e[s];
    }
  }), t;
}
function Fi(...i) {
...
const ja = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  throttle: Hi,
  timeToSecond: Vt
}, Symbol.toStringTag, { value: "Module" })), a = "mfuns-player", Gi = "3.0.0-alpha.11", Zi = "f453182", Ji = "https://github.com/Mfuns-cn/mfunsPlayer/tree/v3-beta", Qi = [
...
let ut = (J = class {
  constructor(t) {
    this.hook = new sn(), this.plugins = {}, this.invokes = {}, this._eventEmitter = new an(), this.Player = J, this.container = t.container, this.$el = u("div", { class: `${a} mpui` }), this.$main = this.$el.appendChild(u("div", { class: `${a}-main` })), this.$area = this.$main.appendChild(u("div", { class: `${a}-area` })), this.$content = this.$area.appendChild(
      u("div", { class: `${a}-content` })
    ), this.invokes = t.invokes ?? {}, this.plugin = new en(this), this._videoController = new tn(this, t), this.loader = new nn(this), this.init(t);
  }
  /** 初始化播放器 */
  async init(t) {
    var e;
...
class ct {
  constructor({
    ...
    this.container = t, this.min = e, this.max = s, this.step = n || 0, this.divider = r ? typeof r == "boolean" ? this.step : r : 0, this.value = isNaN(l) ? l : Number(l), this.onChange = h, this.onDragStart = o, this.onDragEnd = c, this.onDrag = p, this.$el = this.container.appendChild(
      ...
      var w;
      const b = $, { clientX: T } = b, S = this.$track.offsetWidth;
...
class Ri {
  constructor({
    ...
    this.container = t, this.min = e, this.max = s, this.step = n || 0, this.value = isNaN(r) ? r : Number(r), this.onChange = l, this.onDragStart = h, this.onDragEnd = o, this.onDrag = c, this.$el = u(
      ...
      var A;
      const $ = p, { clientY: b } = $, T = this.$track.offsetHeight;
      let S = this.$thumbTrack.offsetHeight;
      S = S || T;
      const m = (T - S) / 2, v = this.$el.getBoundingClientRect().top;
      let d = S - (b - v - m);
      d = d >= S ? S : d <= 0 ? 0 : d;
      const g = this.step ? Math.round(d / S * (this.max - this.min) / this.step) * this.step + this.min : d / S * (this.max - this.min) + this.min;
 ...
 */
var Rt;
const At = window, rt = At.trustedTypes, hi = rt ? rt.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, Bt = "$lit$", V = `lit$${(Math.random() + "").slice(9)}$`, Ni = "?" + V, on = `<${Ni}>`, Q = document, pt = () => Q.createComment(""), mt = (i) => i === null || typeof i != "object" && typeof i != "function", Di = Array.isArray, hn = (i) => Di(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", Nt = `[ 	
\f\r]`, ht = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ci = /-->/g, di = />/g, j = RegExp(`>|${Nt}(?:([^\\s"'>=/]+)(${Nt}*=${Nt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ui = /'/g, pi = /"/g, Ii = /^(?:script|style|textarea|title)$/i, cn = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e }), O = cn(1), vt = Symbol.for("lit-noChange"), P = Symbol.for("lit-nothing"), mi = /* @__PURE__ */ new WeakMap(), U = Q.createTreeWalker(Q, 129, null, !1);
function zi(i, t) {
...
const dn = (i, t) => {
  ...
  for (let h = 0; h < e; h++) {
    ...
    for (; b < o.length && (l.lastIndex = b, p = l.exec(o), p !== null); )
      b = l.lastIndex, l === ht ? p[1] === "!--" ? l = ci : p[1] !== void 0 ? l = di : p[2] !== void 0 ? (Ii.test(p[2]) && (n = RegExp("</" + p[2], "g")), l = j) : p[3] !== void 0 && (l = j) : l === j ? p[0] === ">" ? (l = n ?? ht, $ = -1) : p[1] === void 0 ? $ = -2 : ($ = l.lastIndex - p[2].length, c = p[1], l = p[3] === void 0 ? j : p[3] === '"' ? pi : ui) : l === pi || l === ui ? l = j : l === ci || l === di ? l = ht : (l = j, n = void 0);
    const T = l === j && i[h + 1].startsWith("/>") ? " " : "";
    r += l === ht ? o + on : $ >= 0 ? (s.push(c), o.slice(0, $) + Bt + o.slice($) + V + T) : o + V + ($ === -2 ? (s.push(void 0), h) : T);
  }
  return [zi(i, r + (i[e] || "<?>") + (t === 2 ? "</svg>" : "")), s];
};
class gt {
  constructor({ strings: t, _$litType$: e }, s) {
    ...
    this.parts = [];
    let r = 0, l = 0;
    const h = t.length - 1, o = this.parts, [c, p] = dn(t, e);
      ...
      if (n.nodeType === 1) {
        if (n.hasAttributes()) {
          ...
          for (const b of n.getAttributeNames())
            if (b.endsWith(Bt) || b.startsWith(V)) {
              const T = p[l++];
              if ($.push(b), T !== void 0) {
                const S = n.getAttribute(T.toLowerCase() + Bt).split(V), m = /([.?@])?(.*)/.exec(T);
                o.push({ type: 1, index: r, name: m[2], strings: S, ctor: m[1] === "." ? pn : m[1] === "?" ? vn : m[1] === "@" ? gn : Mt });
              } else
        ...
        if (Ii.test(n.tagName)) {
          ...
          if (b > 0) {
            ...
            for (let T = 0; T < b; T++)
              n.append($[T], pt()), U.nextNode(), o.push({ type: 2, index: ++r });
            n.append($[b], pt());
          }
        }
...
class un {
  ...
  u(t) {
    ...
    for (; c !== void 0; ) {
      if (h === c.index) {
        let p;
        c.type === 2 ? p = new kt(l, l.nextSibling, this, t) : c.type === 1 ? p = new c.ctor(l, c.name, c.strings, this, t) : c.type === 6 && (p = new $n(l, this, t)), this._$AV.push(p), c = n[++o];
      }
...
class kt {
  ...
  _$AI(t, e = this) {
    t = lt(this, t, e), mt(t) ? t === P || t == null || t === "" ? (this._$AH !== P && this._$AR(), this._$AH = P) : t !== this._$AH && t !== vt && this._(t) : t._$litType$ !== void 0 ? this.g(t) : t.nodeType !== void 0 ? this.$(t) : hn(t) ? this.T(t) : this._(t);
  }
  k(t) {
  ...
  g(t) {
    var e;
    const { values: s, _$litType$: n } = t, r = typeof n == "number" ? this._$AC(t) : (n.el === void 0 && (n.el = gt.createElement(zi(n.h, n.h[0]), this.options)), n);
    if (((e = this._$AH) === null || e === void 0 ? void 0 : e._$AD) === r)
      this._$AH.v(s);
    else {
      const l = new un(r, this), h = l.u(this.options);
      l.v(s), this.$(h), this._$AH = l;
    }
  }
  _$AC(t) {
    let e = mi.get(t.strings);
    return e === void 0 && mi.set(t.strings, e = new gt(t)), e;
  }
  T(t) {
...
const mn = rt ? rt.emptyScript : "";
class vn extends Mt {
  constructor() {
    super(...arguments), this.type = 4;
  }
  j(t) {
    t && t !== P ? this.element.setAttribute(this.name, mn) : this.element.removeAttribute(this.name);
  }
}
class gn extends Mt {
  constructor(t, e, s, n, r) {
...
const vi = At.litHtmlPolyfillSupport;
vi == null || vi(gt, kt), ((Rt = At.litHtmlVersions) !== null && Rt !== void 0 ? Rt : At.litHtmlVersions = []).push("2.8.0");
const Ft = (i, t, e) => {
  var s, n;
...
class et {
  ...
  /** 重载，一般用于列表项更改 */
  reload(t) {
    Ft(fn({ list: this.list, template: this.template }), this.container), this.$el = this.container.querySelector(".mpui-picker"), this.$items = this.$el.querySelectorAll(".mpui-picker-item"), this.$items.forEach((e) => {
...
class Oi {
  ...
  /** 重载，一般用于列表项更改 */
  reload(t) {
    Ft(yn({ list: this.list, template: this.template }), this.container), this.$el = this.container.querySelector(".mpui-picker"), this.$items = this.$el.querySelectorAll(".mpui-picker-item"), this.$items.forEach((e) => {
      e.addEventListener("click", () => {
...
`
  ...
  if (c.length) {
    ...
    c.forEach(([$, b, T]) => {
      if (!T)
        return;
      const S = u("div", { class: "list-operate-btn" }, $);
      S.onclick = (m) => {
  ...
  init() {
    ...
    this.list = new kn({
      ...
      createItem: (n, r) => xn(n, r, {
        ...
        title: `${n.content}
${n.date ? Ge(new Date(n.date * 1e3), "yyyy-MM-dd HH:mm:ss") : "--"} @ ${ft(n.time, 2)}`
      }),
      overflow: 5
    });
    const s = _t(() => {
...
`
  ...
  constructor(t) {
    super(t, u("div", { class: `${a}-videotime` }, Sn)), this.valueBeforeEdited = "", this.timeFormat = 2, this.$label = this.$(`.${a}-videotime-label`), this.$current = this.$(`.${a}-videotime-current`), this.$total = this.$(`.${a}-videotime-total`), this.$input = this.$(`.${a}-videotime-input`);
  }
  init() {
...
ds.pluginName = "buttonWidescreen";
let te = ds;
const Rn = (
  /*html*/
  `
...
ps.pluginName = "buttonFullscreen";
let se = ps;
const Dn = (
  /*html*/
  `
...
`
), ms = class ms extends bt {
  constructor(t) {
    super(t, u("div", { class: `${a}-about` }, Dn)), this.title = "关于";
  }
};
ms.pluginName = "about";
let ie = ms;
...
`
  ...
  constructor(t) {
    ...
    super(
      t,
      u("div", { class: `${a}-hotkeys` }, In(e))
    ), this.title = "快捷键说明";
  }
};
vs.pluginName = "hotkeyInfo";
let ne = vs;
...
X = new WeakMap(), ys.pluginName = "modal";
let oe = ys;
const Vn = (
  /*html*/
  `
...
`
  ...
  constructor(t) {
    super(t, u("div", { class: `${a}-progress` }, Vn)), this.trackLength = 0, this.distance = 0, this.nMax = 0, this.nLeft = 0, this.isDragging = !1, this.isHover = !1, this.isActive = !1, this.$bar = this.$(`.${a}-progress-bar`), this.$buffered = this.$(`.${a}-progress-buffered`), this.$played = this.$(`.${a}-progress-played`), this.$thumbTrack = this.$(`.${a}-progress-thumb-track`), this.$thumb = this.$(`.${a}-progress-thumb`), this.$preview = this.$(`.${a}-progress-preview`), this.$thumbnail = this.$(`.${a}-progress-thumbnail`), this.$time = this.$(`.${a}-progress-time`), this.$tip = this.$(`.${a}-progress-tip`), this.$el.addEventListener("mousedown", (n) => {
      const { clientX: r } = n;
...
`
), ks = class ks extends bt {
  constructor(t) {
    super(t, u("div", { class: `${a}-settings` }, Bn)), this.title = "设置", this.$slot = this.$(`.${a}-settings-slot`), this.$play = this.$(`.${a}-settings-play`), this.$others = this.$(`.${a}-settings-others`), this.$ratePicker = this.$(`.${a}-settings-rate-picker`), this.$ratioPicker = this.$(`.${a}-settings-ratio-picker`);
  }
  init() {
...
}, gi = "ResizeObserver loop completed with undelivered notifications.", Wn = function() {
  var i;
  typeof ErrorEvent == "function" ? i = new ErrorEvent("error", {
    message: gi
  }) : (i = document.createEvent("Event"), i.initEvent("error", !1, !1), i.message = gi), window.dispatchEvent(i);
}, $t;
(function(i) {
...
var Z = function(i) {
  ...
  return !1;
}, dt = typeof window < "u" ? window : {}, wt = /* @__PURE__ */ new WeakMap(), fi = /auto|scroll/, Yn = /^tb|vertical/, Kn = /msie|trident/i.test(dt.navigator && dt.navigator.userAgent), D = function(i) {
  return parseFloat(i || "0");
}, st = function(i, t, e) {
  return i === void 0 && (i = 0), t === void 0 && (t = 0), e === void 0 && (e = !1), new Un((e ? t : i) || 0, (e ? i : t) || 0);
}, yi = Z({
  ...
  if (t === void 0 && (t = !1), wt.has(i) && !t)
    return wt.get(i);
  if (Bi(i))
    return wt.set(i, yi), yi;
  var e = getComputedStyle(i), s = Je(i) && i.ownerSVGElement && i.getBBox(), n = !Kn && e.boxSizing === "border-box", r = Yn.test(e.writingMode || ""), l = !s && fi.test(e.overflowY || ""), h = !s && fi.test(e.overflowX || ""), o = s ? 0 : D(e.paddingTop), c = s ? 0 : D(e.paddingRight), p = s ? 0 : D(e.paddingBottom), $ = s ? 0 : D(e.paddingLeft), b = s ? 0 : D(e.borderTopWidth), T = s ? 0 : D(e.borderRightWidth), S = s ? 0 : D(e.borderBottomWidth), m = s ? 0 : D(e.borderLeftWidth), v = $ + c, d = o + p, g = m + T, L = b + S, k = h ? i.offsetHeight - L - i.clientHeight : 0, A = l ? i.offsetWidth - g - i.clientWidth : 0, w = n ? v + g : 0, x = n ? d + L : 0, H = s ? s.width : D(e.width) - w - A, y = s ? s.height : D(e.height) - x - k, _ = H + v + A + g, N = y + d + k + L, ot = Z({
    ...
    contentRect: new Vi($, o, H, y)
  });
  return wt.set(i, ot), ot;
}, Ci = function(i, t, e) {
  var s = qi(i, e), n = s.borderBoxSize, r = s.contentBoxSize, l = s.devicePixelContentBoxSize;
  switch (t) {
  ...
  G.forEach(function(l) {
    if (l.activeTargets.length !== 0) {
      ...
      l.activeTargets.forEach(function(c) {
        var p = new Gn(c.target), $ = ji(c.target);
        h.push(p), c.lastReportedSize = Ci(c.target, c.observedBox), $ < i && (i = $);
      }), t.push(function() {
  ...
  G.forEach(function(e) {
    e.activeTargets.splice(0, e.activeTargets.length), e.skippedTargets.splice(0, e.skippedTargets.length), e.observationTargets.forEach(function(n) {
      n.isActive() && (ji(n.target) > i ? e.activeTargets.push(n) : e.skippedTargets.push(n));
    });
  });
}, Jn = function() {
  var i = 0;
  ...
  return Wi.splice(0).forEach(function(i) {
    return i();
  });
}, ta = function(i) {
  if (!Dt) {
  ...
  return !!Tt;
}, ia = 250, na = { attributes: !0, characterData: !0, childList: !0, subtree: !0 }, ki = [
  "resize",
  "load",
  "transitionend",
  "animationend",
  ...
  return i.prototype.run = function(t) {
    ...
    var t = this, e = function() {
      return t.observer && t.observer.observe(document.body, na);
    };
    document.body ? e() : dt.addEventListener("DOMContentLoaded", e);
  }, i.prototype.start = function() {
    var t = this;
    this.stopped && (this.stopped = !1, this.observer = new MutationObserver(this.listener), this.observe(), ki.forEach(function(e) {
      return dt.addEventListener(e, t.listener, !0);
    }));
  }, i.prototype.stop = function() {
    var t = this;
    this.stopped || (this.observer && this.observer.disconnect(), ki.forEach(function(e) {
      return dt.removeEventListener(e, t.listener, !0);
    }), this.stopped = !0);
  }, i;
}(), $e = new aa(), xi = function(i) {
  !Tt && i > 0 && $e.start(), Tt += i, !Tt && $e.stop();
}, ra = function(i) {
  return !Je(i) && !Xn(i) && getComputedStyle(i).display === "inline";
}, la = function() {
  function i(t, e) {
  ...
  return i.prototype.isActive = function() {
    var t = Ci(this.target, this.observedBox, !0);
    return ra(this.target) && (this.lastReportedSize = t), this.lastReportedSize.inlineSize !== t.inlineSize || this.lastReportedSize.blockSize !== t.blockSize;
  }, i;
  ...
  return i;
}(), xt = /* @__PURE__ */ new WeakMap(), Li = function(i, t) {
  ...
  return i.connect = function(t, e) {
    ...
    Li(n.observationTargets, e) < 0 && (r && G.push(n), n.observationTargets.push(new la(e, s && s.box)), xi(1), $e.schedule());
  }, i.unobserve = function(t, e) {
    var s = xt.get(t), n = Li(s.observationTargets, e), r = s.observationTargets.length === 1;
    n >= 0 && (r && G.splice(G.indexOf(s), 1), s.observationTargets.splice(n, 1), xi(-1));
...
const As = class As extends f {
  constructor(t) {
    super(t);
    const e = window.ResizeObserver || Ui;
...
Hs.pluginName = "stateIntersecting";
let ye = Hs;
class ha extends yt {
  constructor(t) {
...
const ca = [
  ...
  Qt,
  se
], pa = [...ca, ...da, ...ua], _s = class _s extends f {
  constructor() {
...
Is.pluginName = "buttonDanmakuList";
let Se = Is;
...
`
), Vs = class Vs extends yt {
  constructor(t) {
    super(t, u("div", { class: `${a}-videostatus` }, $a)), this.$paused = this.$(`.${a}-videostatus-paused`), this.$loading = this.$(`.${a}-videostatus-loading`), this.$volume = this.$(`.${a}-videostatus-volume`), this.player.$area.appendChild(this.$el), this.player.on("volumechange", (s, n) => {
...
`
), Bs = class Bs extends yt {
  constructor(t) {
    super(t, u("div", { class: `${a}-loadingmask` }, fa)), this.delay = 0, this.$info = this.$(`.${a}-loadingmask-info`), this.$tips = this.$(`.${a}-loadingmask-tips`), this.player.$main.appendChild(this.$el);
  }
  apply(t, e) {
    var s, n;
...
q = new WeakMap(), at = new WeakMap(), K = new WeakMap(), js.pluginName = "mini";
let Pe = js;
const Ws = class Ws extends f {
  constructor(t) {
    var e;
...
`)}`, typeof v.color == "number" ? d.style.color = Mi(v.color) : d.style.color = v.color, d.style.opacity = this.opacity.toString(), d.style.fontSize = +v.size * this.fontScale + "px", v.fromHere && (d.style.border = "2px solid white"), d.addEventListener("animationend", () => {
  ...
  captureDanmakuDOM(t, e, s, n = !1) {
    ...
    for (const h of l)
      if (h.innerHTML) {
        const o = h.getBoundingClientRect(), c = this.container.getBoundingClientRect(), p = o.left - c.left, $ = o.right - c.left, b = o.top - c.top, T = o.bottom - c.top;
        if (t >= p - s && t <= $ + s && e >= b - s && e <= T + s && (r.push(h), n))
          return r;
      }
    return r;
  }
...
function ka() {
  const i = [], t = Ti.length;
  for (let e = 0; e < 8; e++)
    i.push(Ti[Math.floor(Math.random() * t)]);
  return Ei++, i.join("") + `${Ei}`;
}
const Ks = class Ks extends f {
  constructor() {
    super(...arguments), this.type = "", this.parser = wa;
  }
  get danmaku() {
...
Zs.pluginName = "buttonDanmakuToggle";
let Ve = Zs;
const La = (
  /*html*/
  `
...
const Js = class Js extends F {
  constructor(e) {
    super(e, u("div", { class: `${a}-danmakubar` }, La));
    R(this, C, void 0);
  ...
  apply(e, s) {
    var n, r, l;
    (n = s.danmakuBar) != null && n.loginRequired && E(this, C, !0), this.setPlaceHolder(((r = s.danmakuBar) == null ? void 0 : r.placeholder) || Ea), this.controls = ((l = s.danmakuBar) == null ? void 0 : l.controls) || {};
  }
  ready() {
...
C = new WeakMap(), Js.pluginName = "danmakuBar";
let Be = Js;
const Ea = "发条弹幕吧~", Ta = (
  /*html*/
  `
...
Qs.pluginName = "buttonDanmakuSettings";
let qe = Qs;
const Sa = (i, t, e, s) => O`
  ${i.map(
  (n) => O`
...
`, Aa = (i) => navigator.clipboard.writeText(i), ti = class ti extends f {
  constructor(t) {
...
`
  ...
  init(t) {
    this.pickerSize = new et({
      ...
      value: "#FFFFFF",
      list: Fa.map((e) => ({ value: e })),
      onPick: (e) => {
        this.danmakuBar.danmakuColor = _i(e);
      },
      onChange: (e) => {
...
ei.pluginName = "buttonDanmakuStyle";
let je = ei;
const _a = [
  [18, "小"],
  [25, "中"],
...
const ai = class ai extends f {
  constructor(e) {
    super(e);
    R(this, z, null);
    const s = window.ResizeObserver || Ui;
...
z = new WeakMap(), ai.pluginName = "aspectRatio";
let Ye = ai;
const Ia = (
  /*html*/
  `
...
`
), ri = class ri extends yt {
  constructor(t) {
    super(t, u("div", { class: `${a}-footbar` }, Ia)), this.controls = {}, this.$left = this.$(`.${a}-footbar-left`), this.$right = this.$(`.${a}-footbar-right`);
  }
  apply(t, e) {
    var s;
...
const za = [
  ...
  Re,
  Ke
], Oa = [ie, ne, Te], Va = [ee, te, Se, He, Ht], Ba = [Xe, We, Ue], qa = [
  ...Na,
  ...pa,
  ...za,
  ...Oa,
