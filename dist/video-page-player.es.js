const nt = (s, t) => Array.from({ length: s }, () => t), Vs = () => document.fullscreenElement || document.mozFullScreenElement || document.webkitFullscreenElement || document.msFullscreenElement || null, Ws = document.fullscreenEnabled || document.webkitFullscreenEnabled || document.mozFullScreenEnabled || document.msFullscreenEnabled || !1, Cs = document.pictureInPictureEnabled, Vt = (s) => {
...
const V = (s, t = !0) => {
...
}, Us = (s) => `#${`00000${s.toString(16)}`.slice(-6)}`, Tt = {
  ...
  (e) => {
    var i;
    return (i = Tt[e]) == null ? void 0 : i.call(Tt, s);
  }
), r = "mfuns-player", Xs = "https://github.com/Mfuns-cn/mfunsPlayer/tree/v3-beta", js = [
...
const qt = class fe {
  constructor(t) {
    this.hook = new Ks(), this.plugin = {}, this._eventEmitter = new ei(), this.Player = fe, this.container = t.container, this.$el = L("div", { class: `${r} mpui` }), this.$main = this.$el.appendChild(L("div", { class: `${r}-main` })), this.$area = this.$main.appendChild(L("div", { class: `${r}-area` })), this.$content = this.$area.appendChild(
      L("div", { class: `${r}-content` })
    ), this._pluginManager = new Gs(this), this._videoController = new Ys(this, t), this.loader = new ti(this), this.controls = new Qs(this), this.panel = new Zs(this), this.menu = new Js(this), this.init(t);
  }
  /** 初始化播放器 */
  async init(t) {
    this.on("videoChange", () => {
  ...
  seek(t) {
    this.hook.call("seek").then((e) => {
      e && (this.$video.currentTime = Wt(t, 0, this.$video.duration));
    });
  }
  /** 设置音量
   * @param volume 音量（0-1）
...
qt.version = "3.0.0-dev";
qt.gitHash = "d47f1cd";
let Rt = qt;
console.log(
  `
 %c mfunsPlayer v3.0.0-dev d47f1cd %c https://github.com/Mfuns-cn 
 ...
 */
var At;
const Lt = window, Z = Lt.trustedTypes, Ut = Z ? Z.createPolicy("lit-html", { createHTML: (s) => s }) : void 0, Bt = "$lit$", B = `lit$${(Math.random() + "").slice(9)}$`, ye = "?" + B, si = `<${ye}>`, X = document, ct = () => X.createComment(""), dt = (s) => s === null || typeof s != "object" && typeof s != "function", be = Array.isArray, ii = (s) => be(s) || typeof (s == null ? void 0 : s[Symbol.iterator]) == "function", Dt = `[ 	
\f\r]`, st = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Xt = /-->/g, jt = />/g, I = RegExp(`>|${Dt}(?:([^\\s"'>=/]+)(${Dt}*=${Dt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Yt = /'/g, Gt = /"/g, we = /^(?:script|style|textarea|title)$/i, ni = (s) => (t, ...e) => ({ _$litType$: s, strings: t, values: e }), p = ni(1), ut = Symbol.for("lit-noChange"), H = Symbol.for("lit-nothing"), Kt = /* @__PURE__ */ new WeakMap(), W = X.createTreeWalker(X, 129, null, !1);
function ke(s, t) {
...
const ri = (s, t) => {
  ...
  let n, a = t === 2 ? "<svg>" : "", l = st;
  for (let o = 0; o < e; o++) {
    const h = s[o];
    let c, u, $ = -1, w = 0;
    for (; w < h.length && (l.lastIndex = w, u = l.exec(h), u !== null); )
      w = l.lastIndex, l === st ? u[1] === "!--" ? l = Xt : u[1] !== void 0 ? l = jt : u[2] !== void 0 ? (we.test(u[2]) && (n = RegExp("</" + u[2], "g")), l = I) : u[3] !== void 0 && (l = I) : l === I ? u[0] === ">" ? (l = n ?? st, $ = -1) : u[1] === void 0 ? $ = -2 : ($ = l.lastIndex - u[2].length, c = u[1], l = u[3] === void 0 ? I : u[3] === '"' ? Gt : Yt) : l === Gt || l === Yt ? l = I : l === Xt || l === jt ? l = st : (l = I, n = void 0);
    const T = l === I && s[o + 1].startsWith("/>") ? " " : "";
    a += l === st ? h + si : $ >= 0 ? (i.push(c), h.slice(0, $) + Bt + h.slice($) + B + T) : h + B + ($ === -2 ? (i.push(void 0), o) : T);
  }
  return [ke(s, a + (s[e] || "<?>") + (t === 2 ? "</svg>" : "")), i];
};
class pt {
  constructor({ strings: t, _$litType$: e }, i) {
    ...
    this.parts = [];
    let a = 0, l = 0;
    const o = t.length - 1, h = this.parts, [c, u] = ri(t, e);
    if (this.el = pt.createElement(c, i), W.currentNode = this.el.content, e === 2) {
      ...
      if (n.nodeType === 1) {
        if (n.hasAttributes()) {
          ...
          for (const w of n.getAttributeNames())
            if (w.endsWith(Bt) || w.startsWith(B)) {
              const T = u[l++];
              if ($.push(w), T !== void 0) {
                const _ = n.getAttribute(T.toLowerCase() + Bt).split(B), v = /([.?@])?(.*)/.exec(T);
                h.push({ type: 1, index: a, name: v[2], strings: _, ctor: v[1] === "." ? li : v[1] === "?" ? hi : v[1] === "@" ? ci : _t });
              } else
        ...
        if (we.test(n.tagName)) {
          ...
          if (w > 0) {
            ...
            for (let T = 0; T < w; T++)
              n.append($[T], ct()), W.nextNode(), h.push({ type: 2, index: ++a });
            n.append($[w], ct());
          }
        }
...
function J(s, t, e = s, i) {
  ...
  return (h == null ? void 0 : h.constructor) !== c && ((a = h == null ? void 0 : h._$AO) === null || a === void 0 || a.call(h, !1), c === void 0 ? h = void 0 : (h = new c(s), h._$AT(s, e, i)), i !== void 0 ? ((l = (o = e)._$Co) !== null && l !== void 0 ? l : o._$Co = [])[i] = h : e._$Cl = h), h !== void 0 && (t = J(s, h._$AS(s, t.values), h, i)), t;
}
class ai {
  constructor(t, e) {
  ...
  u(t) {
    var e;
    const { el: { content: i }, parts: n } = this._$AD, a = ((e = t == null ? void 0 : t.creationScope) !== null && e !== void 0 ? e : X).importNode(i, !0);
    W.currentNode = a;
    let l = W.nextNode(), o = 0, h = 0, c = n[0];
    for (; c !== void 0; ) {
      if (o === c.index) {
        let u;
        c.type === 2 ? u = new vt(l, l.nextSibling, this, t) : c.type === 1 ? u = new c.ctor(l, c.name, c.strings, this, t) : c.type === 6 && (u = new di(l, this, t)), this._$AV.push(u), c = n[++h];
      }
      o !== (c == null ? void 0 : c.index) && (l = W.nextNode(), o++);
    }
    return W.currentNode = X, a;
  }
  v(t) {
    let e = 0;
...
class vt {
  constructor(t, e, i, n) {
    var a;
    this.type = 2, this._$AH = H, this._$AN = void 0, this._$AA = t, this._$AB = e, this._$AM = i, this.options = n, this._$Cp = (a = n == null ? void 0 : n.isConnected) === null || a === void 0 || a;
  }
  get _$AU() {
    var t, e;
  ...
  _$AI(t, e = this) {
    t = J(this, t, e), dt(t) ? t === H || t == null || t === "" ? (this._$AH !== H && this._$AR(), this._$AH = H) : t !== this._$AH && t !== ut && this._(t) : t._$litType$ !== void 0 ? this.g(t) : t.nodeType !== void 0 ? this.$(t) : ii(t) ? this.T(t) : this._(t);
  }
  k(t) {
  ...
  _(t) {
    this._$AH !== H && dt(this._$AH) ? this._$AA.nextSibling.data = t : this.$(X.createTextNode(t)), this._$AH = t;
  }
  g(t) {
    var e;
    const { values: i, _$litType$: n } = t, a = typeof n == "number" ? this._$AC(t) : (n.el === void 0 && (n.el = pt.createElement(ke(n.h, n.h[0]), this.options)), n);
    if (((e = this._$AH) === null || e === void 0 ? void 0 : e._$AD) === a)
      this._$AH.v(i);
    else {
      const l = new ai(a, this), o = l.u(this.options);
      l.v(i), this.$(o), this._$AH = l;
    }
  }
  _$AC(t) {
    let e = Kt.get(t.strings);
    return e === void 0 && Kt.set(t.strings, e = new pt(t)), e;
  }
  T(t) {
    ...
    let i, n = 0;
    for (const a of t)
      n === e.length ? e.push(i = new vt(this.k(ct()), this.k(ct()), this, this.options)) : i = e[n], i._$AI(a), n++;
...
class _t {
  constructor(t, e, i, n, a) {
    this.type = 1, this._$AH = H, this._$AN = void 0, this.element = t, this.name = e, this._$AM = n, this.options = a, i.length > 2 || i[0] !== "" || i[1] !== "" ? (this._$AH = Array(i.length - 1).fill(new String()), this.strings = i) : this._$AH = H;
  }
  get tagName() {
  ...
  _$AI(t, e = this, i, n) {
    ...
    let l = !1;
    if (a === void 0)
      t = J(this, t, e, 0), l = !dt(t) || t !== this._$AH && t !== ut, l && (this._$AH = t);
    else {
      const o = t;
      let h, c;
      for (t = a[0], h = 0; h < a.length - 1; h++)
        c = J(this, o[i + h], e, h), c === ut && (c = this._$AH[h]), l || (l = !dt(c) || c !== this._$AH[h]), c === H ? t = H : t !== H && (t += (c ?? "") + a[h + 1]), this._$AH[h] = c;
    }
    l && !n && this.j(t);
  }
  j(t) {
...
const oi = Z ? Z.emptyScript : "";
class hi extends _t {
  constructor() {
    super(...arguments), this.type = 4;
  }
  j(t) {
    t && t !== H ? this.element.setAttribute(this.name, oi) : this.element.removeAttribute(this.name);
  }
}
class ci extends _t {
  constructor(t, e, i, n, a) {
  ...
  _$AI(t, e = this) {
    var i;
    if ((t = (i = J(this, t, e, 0)) !== null && i !== void 0 ? i : H) === ut)
      return;
    const n = this._$AH, a = t === H && n !== H || t.capture !== n.capture || t.once !== n.once || t.passive !== n.passive, l = t !== H && (n === H || a);
...
const Qt = Lt.litHtmlPolyfillSupport;
Qt == null || Qt(pt, vt), ((At = Lt.litHtmlVersions) !== null && At !== void 0 ? At : Lt.litHtmlVersions = []).push("2.8.0");
const f = (s, t, e) => {
  var i, n;
  ...
  if (l === void 0) {
    ...
    a._$litPart$ = l = new vt(t.insertBefore(ct(), o), o, void 0, e ?? {});
  }
  return l._$AI(s), l;
};
class ui {
...
`, mi = (s, t, {
  ...
  const h = p`
    ...
    i(u, s);
      ...
      title="${o(s)}"
    >
      <div class="list-cell col-time">${V(s.time)}</div>
      <div class="list-cell col-content">${s.content}</div>
      <div class="list-cell col-date">
        ${s.date ? $e(new Date(s.date * 1e3), "yy-MM-dd HH:mm") : "-"}
      </div>
  ...
  init() {
    ...
    this.list = new ui({
      ...
      createItem: (a, l) => mi(a, l, {
        ...
        title: (o) => `${o.content}
${a.date ? $e(new Date(a.date * 1e3), "yyyy-MM-dd HH:mm:ss") : "-"} @ ${V(a.time, !1)}`
      }),
      overflow: 5
    });
    const i = ge(() => {
...
xe.pluginName = "danmakuList";
const vi = ({ divider: s }) => p` <div
    ...
    <div class="mpui-slider-thumb-track" style="height: 0px">
      ...
      ${s ? p`
            <div class="mpui-slider-divider">
              ${nt(s, p`<div class="mpui-slider-divider-dot"></div>`)}
            </div>
          ` : ""}
    </div>
  </div>
...
class $t {
  constructor({
    ...
    this.container = t, this.min = e, this.max = i, this.step = n || 0, this.divider = a ? typeof a == "boolean" ? this.step : a : 0, this.value = isNaN(l) ? l : Number(l), this.onChange = o, this.onDragStart = h, this.onDragEnd = c, this.onDrag = u, f(vi({ divider: this.divider }), t), this.$el = this.container.querySelector(".mpui-slider"), this.$track = this.$el.querySelector(".mpui-slider-track"), this.$bar = this.$track.querySelector(".mpui-slider-bar"), this.$thumbTrack = this.$track.querySelector(".mpui-slider-thumb-track"), this.$thumb = this.$track.querySelector(".mpui-slider-thumb"), this.$el.addEventListener("mousedown", ($) => {
      ...
      const k = (S) => {
        var et;
        const D = S, { clientX: b } = D;
        D.preventDefault(), D.stopPropagation();
        let F = b - d - m;
        F = F >= v ? v : F <= 0 ? 0 : F;
        const M = this.step ? Math.round(F / v * (this.max - this.min) / this.step) * this.step + this.min : F / v * (this.max - this.min) + this.min;
        this.value != M && this.drag(M), (et = window.getSelection()) == null || et.removeAllRanges();
      }, A = (S) => {
        var b, F;
        S.stopPropagation(), (b = window.getSelection()) == null || b.removeAllRanges(), document.removeEventListener("mousemove", k), document.removeEventListener("mouseup", A), (F = this.onDragEnd) == null || F.call(this, E);
      };
...
class $i {
  constructor({
    ...
    this.container = t, this.min = e, this.max = i, this.step = n || 0, this.value = isNaN(a) ? a : Number(a), this.onChange = l, this.onDragStart = o, this.onDragEnd = h, this.onDrag = c, f(gi(), t), this.$el = this.container.querySelector(".mpui-slider"), this.$track = this.$el.querySelector(".mpui-slider-track"), this.$bar = this.$track.querySelector(".mpui-slider-bar"), this.$thumbTrack = this.$track.querySelector(".mpui-slider-thumb-track"), this.$thumb = this.$track.querySelector(".mpui-slider-thumb"), this.$el.addEventListener("mousedown", (u) => {
      ...
      const E = (x) => {
        var M;
        const S = x, { clientY: D } = S;
        S.preventDefault(), S.stopPropagation();
        let b = _ - (D - m - v);
        b = b >= _ ? _ : b <= 0 ? 0 : b;
        const F = this.step ? Math.round(b / _ * (this.max - this.min) / this.step) * this.step + this.min : b / _ * (this.max - this.min) + this.min;
        this.value != F && this.drag(F), (M = window.getSelection()) == null || M.removeAllRanges();
      }, k = (x) => {
        var D, b;
        x.stopPropagation(), (D = window.getSelection()) == null || D.removeAllRanges(), document.removeEventListener("mousemove", E), document.removeEventListener("mouseup", k), (b = this.onDragEnd) == null || b.call(this, g);
      };
...
class Zt {
  ...
  /** 重载，一般用于列表项更改 */
  reload(t) {
    f(fi({ list: this.list, template: this.template }), this.container), this.$el = this.container.querySelector(".mpui-picker"), this.$items = this.$el.querySelectorAll(".mpui-picker-item"), this.$items.forEach((e) => {
...
class bi {
  ...
  /** 重载，一般用于列表项更改 */
  reload(t) {
    f(yi({ list: this.list, template: this.template }), this.container), this.$el = this.container.querySelector(".mpui-picker"), this.$items = this.$el.querySelectorAll(".mpui-picker-item"), this.$items.forEach((e) => {
      e.addEventListener("click", () => {
...
class tt {
  constructor({ container: t, value: e = !1, onChange: i, onToggle: n, label: a }) {
    this.container = t, this.value = e, this.onChange = i, this.onToggle = n, this.label = a, f(wi({ label: this.label }), this.container), this.$el = this.container.querySelector(".mpui-checkbox"), this.$el.addEventListener("click", () => {
      this.toggle();
    }), this.setValue(this.value);
  }
  /** 设置开关状态 */
  ...
  constructor(t) {
    ...
    if (super(t), this.padding = "", t.plugin.buttonSettings) {
      ...
      this.checkbox = new tt({
        ...
        label: "隐藏黑边"
      }), (e = t.plugin.settings) == null || e.$others.appendChild(i);
    }
  }
  apply(t, e) {
...
class Ee extends y {
  ...
  apply(t, e) {
    var i;
    this.invokeToggle = (i = e.invoke) == null ? void 0 : i.widescreen, e.widescreen && this.enter();
  }
  enter() {
    var t;
...
class Le extends P {
  constructor(t) {
    const e = new DocumentFragment();
    f(ki, e), super(t, e.querySelector(`.${r}-controls-button`)), this.name = "play", this.$icon = this.$(`.${r}-controls-button-icon`), this.$tooltip = this.$(".mpui-tooltip");
  }
  init() {
...
class _e extends P {
  constructor(t) {
    const e = new DocumentFragment();
    f(xi, e), super(t, e.querySelector(`.${r}-controls-button`)), this.name = "prev", this.singleHide = !0, this.$icon = this.$(`.${r}-controls-button-icon`), this.$tooltip = this.$(".mpui-tooltip");
  }
  apply(t, e) {
    var i;
...
class Te extends P {
  constructor(t) {
    const e = new DocumentFragment();
    f(Si, e), super(t, e.querySelector(`.${r}-controls-button`)), this.name = "next", this.singleHide = !0, this.$icon = this.$(`.${r}-controls-button-icon`), this.$tooltip = this.$(".mpui-tooltip");
  }
  apply(t, e) {
    var i;
    super.apply(t, e), this.singleHide = ((i = e.switchButton) == null ? void 0 : i.singleHide) ?? !0;
...
class Ae extends P {
  constructor(t) {
    const e = new DocumentFragment();
    f(Ei, e), super(t, e.querySelector(`.${r}-videotime`)), this.name = "time", this.valueBeforeEdited = "", this.$label = this.$(`.${r}-videotime-label`), this.$current = this.$(`.${r}-videotime-current`), this.$total = this.$(`.${r}-videotime-total`), this.$input = this.$(`.${r}-videotime-input`);
  }
  init() {
    this.player.on("timeupdate", (t) => {
      this.$current.innerText = V(t);
    }), this.player.on("seeking", (t) => {
      this.$current.innerText = V(t);
    }), this.player.on("durationchange", (t) => {
      this.$total.innerText = V(t);
    }), this.$label.addEventListener("click", () => {
      this.$el.classList.add("is-input"), this.$input.value = V(this.player.currentTime), this.valueBeforeEdited = this.$input.value, this.$input.focus();
...
class De extends P {
  constructor(t) {
    const e = new DocumentFragment();
    f(Li, e), super(t, e.querySelector(`.${r}-controls-button`)), this.name = "loop", this.$icon = this.$(`.${r}-controls-button-icon`), this.$tooltip = this.$(".mpui-tooltip");
  }
  init() {
...
class Fe extends P {
  constructor(t) {
    const e = new DocumentFragment();
    f(_i, e), super(t, e.querySelector(`.${r}-controls-button`)), this.name = "part", this.$icon = this.$(`.${r}-controls-button-icon`), this.$text = this.$(`.${r}-controls-button-text`), this.$tooltip = this.$(".mpui-tooltip");
  }
  init() {
    this.$icon.addEventListener("click", () => {
      var t;
...
class Pe extends P {
  constructor(t) {
    const e = new DocumentFragment();
    f(Ti, e), super(t, e.querySelector(`.${r}-controls-button`)), this.name = "volume", this.$icon = this.$(`.${r}-controls-button-icon`), this.$slider = this.$(`.${r}-button-volume-slider`), this.$value = this.$(`.${r}-button-volume-value`);
  }
  init() {
    this.slider = new $i({
...
class He extends P {
  constructor(t) {
    const e = new DocumentFragment();
    f(Ai, e), super(t, e.querySelector(`.${r}-controls-button`)), this.name = "settings", this.$icon = this.$(`.${r}-controls-button-icon`), this.$panel = this.$(`.${r}-controls-panel`);
  }
  ready() {
...
class Me extends P {
  constructor(t) {
    const e = new DocumentFragment();
    f(Di, e), super(t, e.querySelector(`.${r}-controls-button`)), this.name = "pip", this.$icon = this.$(`.${r}-controls-button-icon`), this.$tooltip = this.$(".mpui-tooltip");
  }
  init() {
  ...
  get ignored() {
    return !this.player.enterPip || !Cs;
  }
}
Me.pluginName = "buttonPip";
const Fi = p`
...
class Ne extends P {
  constructor(t) {
    const e = new DocumentFragment();
    f(Fi, e), super(t, e.querySelector(`.${r}-controls-button`)), this.name = "widescreen", this.$icon = this.$(`.${r}-controls-button-icon`), this.$tooltip = this.$(".mpui-tooltip");
  }
  init() {
...
Ne.pluginName = "buttonWidescreen";
const Pi = p`
...
class Re extends P {
  constructor(t) {
    const e = new DocumentFragment();
    f(Pi, e), super(t, e.querySelector(`.${r}-controls-button`)), this.name = "webscreen", this.$icon = this.$(`.${r}-controls-button-icon`), this.$tooltip = this.$(".mpui-tooltip");
  }
  init() {
...
class Be extends P {
  constructor(t) {
    const e = new DocumentFragment();
    f(Hi, e), super(t, e.querySelector(`.${r}-controls-button`)), this.name = "fullscreen", this.$icon = this.$(`.${r}-controls-button-icon`), this.$tooltip = this.$(".mpui-tooltip");
  }
  init() {
  ...
  get ignored() {
    return !this.player.enterFullscreen || !Ws;
  }
}
Be.pluginName = "buttonFullscreen";
const Mi = () => p`
  <div class="${r}-about">
    <div class="${r}-about-logo"></div>
    <div class="${r}-about-version">version ${Rt.version}-${Rt.gitHash}</div>
    <div>github：<a href="${Xs}" target="_blank">mfuns-cn/mfunsPlayer</a></div>
    <div>开发者：</div>
...
class Ie extends gt {
  constructor(t) {
    const e = new DocumentFragment();
    f(Mi(), e), super(t, e.querySelector(`.${r}-about`)), this.name = "about", this.title = "关于";
  }
}
Ie.pluginName = "about";
const Ni = (s) => p`
...
class qe extends gt {
  constructor(t) {
    ...
    f(Ni(e), i), super(t, i.querySelector(`.${r}-hotkeys`)), this.name = "hotkeyInfo", this.title = "快捷键说明";
  }
}
...
class Oe extends y {
  constructor(t) {
    super(t), this.list = [], this.isShow = !1, this.player = t, this.container = L("div", { class: `${r}-contextmenu-wrap` }), f(Ri(), this.container), this.$el = this.container.querySelector(`.${r}-contextmenu`), this.$list = this.$el.querySelector(`.${r}-contextmenu-list`), this.player.$main.appendChild(this.container);
  }
  apply(t, e) {
    var i;
  ...
  setMenu(t) {
    ...
    const e = new DocumentFragment();
    t.forEach((i) => {
      const n = L("li", { class: `${r}-contextmenu-item` });
      i.onClick && (n.onclick = () => {
        var l;
...
var z = /* @__PURE__ */ ((s) => (s[s.Backspace = 8] = "Backspace", s[s.Tab = 9] = "Tab", s[s.Enter = 13] = "Enter", s[s.Shift = 16] = "Shift", s[s.Ctrl = 17] = "Ctrl", s[s.Alt = 18] = "Alt", s[s.PauseBreak = 19] = "PauseBreak", s[s.CapsLock = 20] = "CapsLock", s[s.Escape = 27] = "Escape", s[s.Space = 32] = "Space", s[s.PageUp = 33] = "PageUp", s[s.PageDown = 34] = "PageDown", s[s.End = 35] = "End", s[s.Home = 36] = "Home", s[s.LeftArrow = 37] = "LeftArrow", s[s.UpArrow = 38] = "UpArrow", s[s.RightArrow = 39] = "RightArrow", s[s.DownArrow = 40] = "DownArrow", s[s.Insert = 45] = "Insert", s[s.Delete = 46] = "Delete", s[s.Zero = 48] = "Zero", s[
  ...
  s.GraveAccent = 192
  /* Tilde */
] = "GraveAccent", s[s.OpenBracket = 219] = "OpenBracket", s[s.ClosedBracket = 221] = "ClosedBracket", s[s.Quote = 222] = "Quote", s))(z || {});
class Ve {
  constructor(t) {
...
Ve.pluginName = "hotkey";
var We = (s, t, e) => {
  if (!t.has(s))
    throw TypeError("Cannot " + e);
}, Ii = (s, t, e) => (We(s, t, "read from private field"), e ? e.call(s) : t.get(s)), qi = (s, t, e) => {
  if (t.has(s))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(s) : t.set(s, e);
}, Jt = (s, t, e, i) => (We(s, t, "write to private field"), i ? i.call(s, e) : t.set(s, e), e), rt;
const Oi = () => p`
...
class Ce extends y {
  ...
  apply(t, e) {
    var i;
    Jt(this, rt, ((i = e.modal) == null ? void 0 : i.panels) || []);
  }
  ready() {
    Ii(this, rt).forEach((t) => {
...
class Ue extends P {
  constructor(t) {
    const e = new DocumentFragment();
    f(zi(), e), super(t, e.querySelector(`.${r}-progress`)), this.name = "progress", this.trackLength = 0, this.distance = 0, this.nMax = 0, this.nLeft = 0, this.isDragging = !1, this.isHover = !1, this.isActive = !1, this.$bar = this.$(`.${r}-progress-bar`), this.$buffered = this.$(`.${r}-progress-buffered`), this.$played = this.$(`.${r}-progress-played`), this.$thumbTrack = this.$(`.${r}-progress-thumb-track`), this.$thumb = this.$(`.${r}-progress-thumb`), this.$preview = this.$(`.${r}-progress-preview`), this.$thumbnail = this.$(`.${r}-progress-thumbnail`), this.$time = this.$(`.${r}-progress-time`), this.$tip = this.$(`.${r}-progress-tip`), this.$el.addEventListener("mousedown", (a) => {
      const { clientX: l } = a;
  ...
  updateTip() {
    ...
    t = t >= 1 ? 1 : t <= 0 ? 0 : t, this.$tip.style.left = `${t * 100}%`, this.$preview.style.left = `${t * 100}%`, this.$time.innerText = V(this.nValue);
  }
}
Ue.pluginName = "progress";
const Vi = p`
...
class Xe extends gt {
  constructor(t) {
    const e = new DocumentFragment();
    f(Vi, e), super(t, e.querySelector(`.${r}-settings`)), this.name = "settings", this.title = "设置", this.$slot = this.$(`.${r}-settings-slot`), this.$play = this.$(`.${r}-settings-play`), this.$others = this.$(`.${r}-settings-others`), this.$ratePicker = this.$(`.${r}-settings-rate-picker`), this.$ratioPicker = this.$(`.${r}-settings-ratio-picker`);
  }
  init() {
    this.pickerRate = new Zt({
...
Xe.pluginName = "settings";
var je = (s, t, e) => {
  if (!t.has(s))
    throw TypeError("Cannot " + e);
}, Wi = (s, t, e) => (je(s, t, "read from private field"), e ? e.call(s) : t.get(s)), Ci = (s, t, e) => {
  if (t.has(s))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(s) : t.set(s, e);
}, te = (s, t, e, i) => (je(s, t, "write to private field"), i ? i.call(s, e) : t.set(s, e), e), at;
const Ui = () => p`
...
class Ye extends y {
  ...
  apply(t, e) {
    var i;
    te(this, at, ((i = e.side) == null ? void 0 : i.panels) || []);
  }
  ready() {
    Wi(this, at).forEach((t) => {
      const e = this.player.panel.get(t);
      e && this.mount(e);
    }), te(this, at, []);
  }
...
Ke.pluginName = "fullscreen";
var Qe = (s, t, e) => {
  if (!t.has(s))
    throw TypeError("Cannot " + e);
}, ee = (s, t, e) => (Qe(s, t, "read from private field"), e ? e.call(s) : t.get(s)), se = (s, t, e) => {
  if (t.has(s))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(s) : t.set(s, e);
}, Ft = (s, t, e, i) => (Qe(s, t, "write to private field"), i ? i.call(s, e) : t.set(s, e), e), lt, xt;
class Ze extends y {
  constructor() {
    super(...arguments), se(this, lt, 0), se(this, xt, 0);
  }
  init() {
    this.player.define("userId", { get: () => ee(this, lt) }), this.player.define("authorId", { get: () => ee(this, xt) }), this.player.define("login", () => this.login()), this.player.on("videoChange", ({ author: t }) => {
      (t == null ? void 0 : t.id) != null && Ft(this, xt, t.id || 0);
    });
  }
  apply(t, e) {
    var i;
    Ft(this, lt, e.userId || 0), this.invokeLogin = (i = e.invoke) == null ? void 0 : i.login;
  }
  /** 调用页面登录 */
  async login() {
    var t;
  ...
  /** 设置用户 */
  async setUser(t) {
    Ft(this, lt, t), this.player.emit("login", t);
  }
}
...
var Je = (s, t, e) => {
  if (!t.has(s))
    throw TypeError("Cannot " + e);
}, ft = (s, t, e) => (Je(s, t, "read from private field"), e ? e.call(s) : t.get(s)), ie = (s, t, e) => {
  if (t.has(s))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(s) : t.set(s, e);
}, it = (s, t, e, i) => (Je(s, t, "write to private field"), i ? i.call(s, e) : t.set(s, e), e), q, G;
class ts extends y {
  constructor(t) {
    super(t), ie(this, q, !1), ie(this, G, !1), this.activeDuration = 3e3, this.player.define("isActive", {
      get: () => ft(this, q)
    });
    const e = ge(() => {
      it(this, G, !1), this.remove();
    }, this.activeDuration);
    this.player.$main.addEventListener("mousemove", () => {
      it(this, G, !0), this.set(), e();
  ...
  /** 设置播放器活跃状态 */
  set() {
    ft(this, q) || (this.player.$el.classList.add("is-active"), it(this, q, !0), this.player.emit("active"));
  }
  /** 移除播放器活跃状态 */
  remove() {
    !ft(this, q) || ft(this, G) || this.player.isControlled || this.player.hook.call("inactive").then((t) => {
      t && (this.player.$el.classList.remove("is-active"), it(this, q, !1), this.player.emit("inactive"));
    });
  }
}
q = /* @__PURE__ */ new WeakMap();
G = /* @__PURE__ */ new WeakMap();
ts.pluginName = "stateActive";
class es extends y {
  constructor(t) {
...
}, ne = "ResizeObserver loop completed with undelivered notifications.", Yi = function() {
  var s;
  typeof ErrorEvent == "function" ? s = new ErrorEvent("error", {
    message: ne
  }) : (s = document.createEvent("Event"), s.initEvent("error", !1, !1), s.message = ne), window.dispatchEvent(s);
}, mt;
(function(s) {
...
var U = function(s) {
  ...
  function s(t, e) {
    this.inlineSize = t, this.blockSize = e, U(this);
  }
  return s;
}(), ss = function() {
  function s(t, e, i, n) {
    return this.x = t, this.y = e, this.width = i, this.height = n, this.top = this.y, this.left = this.x, this.bottom = this.top + this.height, this.right = this.left + this.width, U(this);
  }
  ...
  return !1;
}, ht = typeof window < "u" ? window : {}, yt = /* @__PURE__ */ new WeakMap(), ae = /auto|scroll/, Qi = /^tb|vertical/, Zi = /msie|trident/i.test(ht.navigator && ht.navigator.userAgent), N = function(s) {
  return parseFloat(s || "0");
}, Q = function(s, t, e) {
  return s === void 0 && (s = 0), t === void 0 && (t = 0), e === void 0 && (e = !1), new Gi((e ? t : s) || 0, (e ? s : t) || 0);
}, le = U({
  devicePixelContentBoxSize: Q(),
  borderBoxSize: Q(),
  contentBoxSize: Q(),
  contentRect: new ss(0, 0, 0, 0)
}), ns = function(s, t) {
  if (t === void 0 && (t = !1), yt.has(s) && !t)
    return yt.get(s);
  if (is(s))
    return yt.set(s, le), le;
  var e = getComputedStyle(s), i = zt(s) && s.ownerSVGElement && s.getBBox(), n = !Zi && e.boxSizing === "border-box", a = Qi.test(e.writingMode || ""), l = !i && ae.test(e.overflowY || ""), o = !i && ae.test(e.overflowX || ""), h = i ? 0 : N(e.paddingTop), c = i ? 0 : N(e.paddingRight), u = i ? 0 : N(e.paddingBottom), $ = i ? 0 : N(e.paddingLeft), w = i ? 0 : N(e.borderTopWidth), T = i ? 0 : N(e.borderRightWidth), _ = i ? 0 : N(e.borderBottomWidth), v = i ? 0 : N(e.borderLeftWidth), m = $ + c, d = h + u, g = v + T, E = w + _, k = o ? s.offsetHeight - E - s.clientHeight : 0, A = l ? s.offsetWidth - g - s.clientWidth : 0, x = n ? m + g : 0, S = n ? d + E : 0, D = i ? i.width : N(e.width) - x - A, b = i ? i.height : N(e.height) - S - k, F = D + m + A + g, M = b + d + k + E, et = U({
    devicePixelContentBoxSize: Q(Math.round(D * devicePixelRatio), Math.round(b * devicePixelRatio), a),
    borderBoxSize: Q(F, M, a),
    contentBoxSize: Q(D, b, a),
    contentRect: new ss($, h, D, b)
  });
  return yt.set(s, et), et;
}, rs = function(s, t, e) {
  var i = ns(s, e), n = i.borderBoxSize, a = i.contentBoxSize, l = i.devicePixelContentBoxSize;
  switch (t) {
  ...
  function s(t) {
    var e = ns(t);
    this.target = t, this.contentRect = e.contentRect, this.borderBoxSize = U([e.borderBoxSize]), this.contentBoxSize = U([e.contentBoxSize]), this.devicePixelContentBoxSize = U([e.devicePixelContentBoxSize]);
  }
  return s;
}(), as = function(s) {
  if (is(s))
  ...
  C.forEach(function(l) {
    if (l.activeTargets.length !== 0) {
      ...
      l.activeTargets.forEach(function(c) {
        var u = new Ji(c.target), $ = as(c.target);
        o.push(u), c.lastReportedSize = rs(c.target, c.observedBox), $ < s && (s = $);
      }), t.push(function() {
  ...
  C.forEach(function(e) {
    e.activeTargets.splice(0, e.activeTargets.length), e.skippedTargets.splice(0, e.skippedTargets.length), e.observationTargets.forEach(function(n) {
      n.isActive() && (as(n.target) > s ? e.activeTargets.push(n) : e.skippedTargets.push(n));
    });
  });
}, en = function() {
  var s = 0;
  ...
  return ls.splice(0).forEach(function(s) {
    return s();
  });
}, nn = function(s) {
  if (!Pt) {
  ...
  return !!St;
}, ln = 250, on = { attributes: !0, characterData: !0, childList: !0, subtree: !0 }, he = [
  "resize",
  "load",
  "transitionend",
  "animationend",
  ...
  return s.prototype.run = function(t) {
    ...
    var t = this;
    this.stopped && (this.stopped = !1, this.observer = new MutationObserver(this.listener), this.observe(), he.forEach(function(e) {
      return ht.addEventListener(e, t.listener, !0);
    }));
  }, s.prototype.stop = function() {
    var t = this;
    this.stopped || (this.observer && this.observer.disconnect(), he.forEach(function(e) {
      return ht.removeEventListener(e, t.listener, !0);
    }), this.stopped = !0);
  }, s;
}(), It = new hn(), de = function(s) {
  !St && s > 0 && It.start(), St += s, !St && It.stop();
}, cn = function(s) {
  return !zt(s) && !Ki(s) && getComputedStyle(s).display === "inline";
}, dn = function() {
  function s(t, e) {
  ...
  return s;
}(), bt = /* @__PURE__ */ new WeakMap(), ue = function(s, t) {
  ...
  return s.connect = function(t, e) {
    ...
    ue(n.observationTargets, e) < 0 && (a && C.push(n), n.observationTargets.push(new dn(e, i && i.box)), de(1), It.schedule());
  }, s.unobserve = function(t, e) {
    var i = bt.get(t), n = ue(i.observationTargets, e), a = i.observationTargets.length === 1;
    n >= 0 && (a && C.splice(C.indexOf(i), 1), i.observationTargets.splice(n, 1), de(-1));
  }, s.disconnect = function(t) {
    var e = this, i = bt.get(t);
...
class hs extends y {
  constructor(t) {
    super(t);
    const e = window.ResizeObserver || os;
...
cs.pluginName = "stateIntersecting";
class pn extends Ot {
  constructor(t) {
    super(t, L("div", { class: `${r}-toast` })), this.defaultDuration = 5e3, this.player.$area.appendChild(this.$el);
  }
  init() {
    this.player.define(
      "toast",
      (t, e, i) => this.append(t, e, i)
    );
  }
  /** 添加toast消息
   ...
   */
  append(t, e, i) {
    const n = this.createToastItem({ content: t, duration: e, close: i });
    return this.$el.appendChild(n.el), n;
  }
  /** 创建一个toast元素 */
  createToastItem(t) {
    const e = L("div", { class: `${r}-toast-item` });
    e.appendChild(
      L("div", { class: `${r}-toast-item-content` })
...
class ms extends y {
  ...
  setTheme(t) {
    Object.assign(this.properties, t), this.themeElement.forEach((e) => {
      let i;
      for (i in t)
        e.style.setProperty(Mt[i], t[i]);
    });
  }
  /** 设置某个主题属性 */
  set(t, e) {
    this.properties[t] = e, this.themeElement.forEach((i) => {
      i.style.setProperty(Mt[t], e);
    });
  }
  get(t) {
...
class $s extends gt {
  constructor(t) {
    const e = new DocumentFragment();
    f(fn, e), super(t, e.querySelector(`.${r}-partlist`)), this.name = "partList", this.title = "分P列表", this._part = 0, this._list = [], this.$list = this.$(`.${r}-partlist-list`);
  }
  init() {
    this.player.on("videoChange", (t) => {
...
class fs extends P {
  constructor(t) {
    const e = new DocumentFragment();
    f(bn, e), super(t, e.querySelector(`.${r}-controls-button`)), this.name = "danmakuList", this.$icon = this.$(`.${r}-controls-button-icon`), this.$text = this.$(`.${r}-controls-button-text`), this.$tooltip = this.$(".mpui-tooltip");
  }
  init() {
    this.$icon.addEventListener("click", () => {
      var t;
...
class bs extends P {
  constructor(t) {
    const e = new DocumentFragment();
    f(wn, e), super(t, e.querySelector(`.${r}-controls-button`)), this.name = "quality", this._itemMap = /* @__PURE__ */ new Map(), this.$icon = this.$(`.${r}-controls-button-icon`), this.$text = this.$(`.${r}-controls-button-text`), this.$panel = this.$(`.${r}-controls-panel`), this.$list = this.$(`.${r}-button-quality-list`);
  }
  init() {
...
class ws extends y {
  constructor(t) {
    super(t), this.$el = L("div", { class: `${r}-videostatus` }), f(kn, this.$el), this.$paused = this.$el.querySelector(`.${r}-videostatus-paused`), this.$loading = this.$el.querySelector(`.${r}-videostatus-loading`), this.$volume = this.$el.querySelector(`.${r}-videostatus-volume`), this.player.$area.appendChild(this.$el);
  }
}
...
class ks extends y {
  constructor(t) {
    super(t), this.delay = 0, this.$el = L("div", { class: `${r}-loadingmask` }), f(xn, this.$el), this.$info = this.$el.querySelector(`.${r}-loadingmask-info`), this.$tips = this.$el.querySelector(`.${r}-loadingmask-tips`), this.player.$main.appendChild(this.$el);
  }
  apply(t, e) {
    var i, n;
  ...
  _add(t, e) {
    const i = L("div", { class: `${r}-loadingmask-info-item` });
...
ks.pluginName = "loadingMask";
class xs extends P {
  constructor(t) {
    super(t, L("div", { class: `${r}-videotitle` })), this.name = "title";
  }
  init() {
    this.player.on("videoChange", (t) => {
...
var Es = (s, t, e) => {
  if (!t.has(s))
    throw TypeError("Cannot " + e);
}, j = (s, t, e) => (Es(s, t, "read from private field"), e ? e.call(s) : t.get(s)), Nt = (s, t, e) => {
  if (t.has(s))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(s) : t.set(s, e);
}, Y = (s, t, e, i) => (Es(s, t, "write to private field"), i ? i.call(s, e) : t.set(s, e), e), O, ot, K;
class Ls extends y {
  constructor(t) {
    var e;
    if (super(t), Nt(this, O, !1), Nt(this, ot, !1), Nt(this, K, !1), this.$el = L("div", { class: `${r}-mini` }), this.player.$el.appendChild(this.$el), this.player.on("intersection", (i) => {
      const n = !j(this, K) || this.player.isPip;
      i ? !n && this._hide() : !n && this._show(), console.log(i);
    }), t.plugin.buttonSettings) {
      const i = document.createElement("div");
      this.checkbox = new tt({
        container: i,
        value: this.enabled,
        ...
        label: "小窗模式"
      }), (e = t.plugin.settings) == null || e.$others.appendChild(i), t.on("miniChange", (n) => {
        var a;
  ...
  init() {
    this.$el.addEventListener("click", () => {
      !j(this, ot) && (this.player.paused ? this.player.play : this.player.pause());
    }), this.$el.addEventListener("mousedown", (t) => {
      const { clientX: e, clientY: i } = t, { offsetLeft: n, offsetTop: a } = this.$el;
      console.log([n, a]);
      const l = e - n, o = i - a, h = (u) => {
        Y(this, ot, !0);
        const { clientX: $, clientY: w } = u;
        this.$el.style.left = `${$ - l}px`, this.$el.style.top = `${w - o}px`;
      }, c = () => {
        this.$el.removeEventListener("mousemove", h), document.removeEventListener("mouseup", c), requestAnimationFrame(() => {
          Y(this, ot, !1);
        });
      };
      this.$el.addEventListener("mousemove", h), document.addEventListener("mouseup", c);
  ...
  _show() {
    j(this, O) || (this.player.$area.style.height = `${this.player.$area.clientHeight}px`, this.$el.append(...this.player.$area.children), this.$el.classList.add("is-show"), Y(this, O, !0));
  }
  _hide() {
    j(this, O) && (this.player.$area.style.height = "", this.player.$area.append(...this.$el.children), this.$el.classList.remove("is-show"), Y(this, O, !1));
  }
  /** 播放器小窗启用状态 */
  get enabled() {
    return j(this, K);
...
class _s extends y {
  constructor(t) {
    var e;
    if (super(t), this.status = !1, this.$mask = L("div", { class: `${r}-lightoff-mask` }), t.plugin.buttonSettings) {
      const i = document.createElement("div");
      this.checkbox = new tt({
        container: i,
        value: this.status,
        ...
        label: "关灯模式"
      }), (e = t.plugin.settings) == null || e.$others.appendChild(i), t.on("lightOffChange", (n) => {
        var a;
        return (a = this.checkbox) == null ? void 0 : a.setValue(n);
      });
    }
...
Ts.pluginName = "webscreen";
class As extends y {
  constructor(t) {
    super(t), this.handler = {}, this._status = !0, this.invoke = {}, this.$el = L("div", { class: `${r}-danmaku-wrap` }), this.player.$content.after(this.$el);
  }
  get status() {
    return this._status;
  }
...
var Et = /* @__PURE__ */ ((s) => (s[s.roll = 1] = "roll", s[s.bottom = 4] = "bottom", s[s.top = 5] = "top", s[s.reverse = 6] = "reverse", s[s.special = 7] = "special", s[s.advanced = 9] = "advanced", s))(Et || {});
class En {
  constructor(t, e) {
  ...
  /** 检查弹幕类型过滤 */
  checkTrackFilter(t) {
    return !this.trackFilter[Et[t.mode]];
  }
  /** 设置弹幕颜色过滤 */
  setColorFilter(t) {
  ...
  draw(t) {
    ...
    this.trackHeights.roll.length !== a && (this.trackHeights.roll = nt(a, e)), this.trackHeights.reverse.length !== a && (this.trackHeights.reverse = nt(a, e)), this.trackHeights.top.length !== a && (this.trackHeights.top = nt(a, e)), this.trackHeights.bottom.length !== a && (this.trackHeights.bottom = nt(a, e));
    const l = (v) => {
      ...
      t:
        for (let g = 0; this.overlap || g < a; g++) {
          const E = c(m, g);
          let k = this.danmakuTracks[m][g];
          if (this.danmakuTracks[m][g] = E, k && k.length) {
            if (m === "roll") {
              const A = i / h(d);
              k.length !== E.length && (k = E);
              for (const x of k) {
                const S = l(x) - 10;
                if (this.trackHeights[m][g] = parseInt(x.style.fontSize) + this.trackPadding, S <= i - A * h(x.getBoundingClientRect().width) || S <= 0)
                  continue t;
              }
            } else if (m === "reverse") {
              const A = i / h(d);
            ...
            return this.danmakuTracks[m][g].push(v), v.addEventListener("animationend", () => {
              var x, S;
              const A = (x = this.danmakuTracks[m][g]) == null ? void 0 : x.indexOf(v);
              A && ((S = this.danmakuTracks[m][g]) == null || S.splice(A, 1));
            }), g;
          } else
    ...
    for (let v = 0; v < t.length; v++) {
      ...
      d.classList.add(`${this.classPrefix}-danmaku-item`), d.classList.add(`${this.classPrefix}-danmaku-${Et[m.mode]}`), d.innerHTML = `${m.content.replace(/(\\n)/g, `
`)}`, typeof m.color == "number" ? d.style.color = Us(m.color) : d.style.color = m.color, d.style.opacity = this.opacity.toString(), d.style.fontSize = +m.size * this.fontScale + "px", m.fromHere && (d.style.border = "2px solid white"), d.addEventListener("animationend", () => {
      ...
      switch (E) {
        case "roll":
        case "reverse":
          if (A = u(d, E, g), k = A % a, k >= 0) {
            const x = this.trackHeights[E].slice(0, a).reduce((F, M) => F + M, 0), S = this.trackHeights[E].slice(0, k).reduce((F, M) => F + M, 0) % x;
            if (S + parseInt(d.style.fontSize) + this.trackPadding > n) {
              (w = this.danmakuTracks[E][v]) == null || w.pop();
              return;
            }
            const D = h(g), b = g + i + this.startDistance * 2;
            d.dataset.track = A.toString(), d.style.width = g + 1 + "px", d.style.top = S + "px", d.style.fontFamily = this.fontFamily, d.style.fontWeight = this.fontWeight, d.style.setProperty("--duration", `${b / D}s`), d.style.setProperty("--offset", `${i + this.startDistance}px`), d.style.setProperty("--translateX", `${-b}px`);
          }
          break;
        case "top":
          if (k = u(d, E, 0) % a, k >= 0) {
            ...
            for (const b of S)
              x.push(...b);
            const D = x.map((b) => parseInt(b.style.fontSize) + this.trackPadding).slice(0, k).reduce((b, F) => b + F, 0);
            if (D + parseInt(d.style.fontSize) + this.trackPadding > n) {
              (T = this.danmakuTracks[E][v]) == null || T.pop();
              return;
            }
            d.dataset.track = k.toString(), d.style.width = g + 1 + "px", d.style.marginLeft = `-${(g + 1) * 0.5}px`, d.style.top = D + "px", d.style.fontFamily = this.fontFamily, d.style.fontWeight = this.fontWeight, d.style.setProperty("--duration", `${this.baseDuration / this.speed}s`);
          }
          break;
        case "bottom":
          if (E = "bottom", k = u(d, E, 0) % a, k >= 0) {
            ...
            d.dataset.track = k.toString(), d.style.width = g + 1 + "px", d.style.marginLeft = `-${(g + 1) * 0.5}px`, d.style.bottom = D + "px", d.style.fontFamily = this.fontFamily, d.style.fontWeight = this.fontWeight, d.style.setProperty("--duration", `${this.baseDuration / this.speed}s`);
          }
          break;
        default:
          k = -1, console.error(`无法处理的弹幕模式: ${m.mode}`);
      }
      k >= 0 && (d.dataset.id = m.id.toString(), d.dataset.user = m.user.toString(), this.container.appendChild(d));
    }
    return $;
  }
  /** 测量字体宽度 */
  ...
  captureDanmakuDOM(t, e, i, n = !1) {
    ...
    for (const o of l)
      if (o.innerHTML) {
        const h = o.getBoundingClientRect(), c = this.container.getBoundingClientRect(), u = h.left - c.left, $ = h.right - c.left, w = h.top - c.top, T = h.bottom - c.top;
        if (t >= u - i && t <= $ + i && e >= w - i && e <= T + i && (a.push(o), n))
          return a;
      }
    return a;
  }
...
class Ds extends y {
  constructor(t) {
    super(t), this.$el = this.plugin.danmaku.$el.appendChild(
      L("div", { class: `${r}-rowdanmaku` })
    ), this.core = new En(this.$el, {
...
function Ln() {
  const s = [], t = me.length;
  for (let e = 0; e < 8; e++)
    s.push(me[Math.floor(Math.random() * t)]);
  return pe++, s.join("") + `${pe}`;
}
class Fs extends y {
  constructor() {
    super(...arguments), this.type = "", this.parser = _n;
  }
  get danmaku() {
...
class Hs extends P {
  constructor(t) {
    const e = new DocumentFragment();
    f(Tn, e), super(t, e.querySelector(`.${r}-controls-button`)), this.name = "danmakuToggle", this.$icon = this.$(`.${r}-controls-button-icon`), this.$tooltip = this.$(".mpui-tooltip");
  }
  init() {
    this.player.on("danmaku:on", () => {
      this._change(!0);
...
Hs.pluginName = "buttonDanmakuToggle";
const An = p`
...
class Ms extends P {
  ...
  apply(t, e) {
    var i, n;
    (i = e.danmakuBar) != null && i.loginRequired && this.setLoginRequired(!0), this.setPlaceHolder(((n = e.danmakuBar) == null ? void 0 : n.placeholder) || Dn);
  }
  setPlaceHolder(t) {
...
class Ns extends P {
  ...
  init() {
    ...
    }), this.sliderArea.drag(25), this.sliderSize = new $t({
...
Ns.pluginName = "buttonDanmakuSettings";
const Pn = (s, t, e, i) => p`
  ${s.map(
  (n) => p`
      <li
...
`, Hn = (s) => navigator.clipboard.writeText(s);
class Rs extends y {
  constructor(t) {
    super(t), this.$el = L("ul", { class: `${r}-contextmenu-danmaku mpui-black` });
  }
  init() {
...
qs.pluginName = "flvLoader";
var Os = (s, t, e) => {
  if (!t.has(s))
    throw TypeError("Cannot " + e);
}, kt = (s, t, e) => (Os(s, t, "read from private field"), e ? e.call(s) : t.get(s)), In = (s, t, e) => {
  if (t.has(s))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(s) : t.set(s, e);
}, ve = (s, t, e, i) => (Os(s, t, "write to private field"), i ? i.call(s, e) : t.set(s, e), e), R;
class zs extends y {
  constructor(t) {
    super(t), In(this, R, null);
    const e = window.ResizeObserver || os;
    e && (this.observer = new e(([i]) => {
      const { width: n, height: a } = i.contentRect;
      this._keepRatio(n, a);
  ...
  apply(t, e) {
    ve(this, R, this._parse(e.aspectRatio || ""));
  }
  init() {
    this.player.define("aspectRatio", { get: () => this._stringify(kt(this, R)) }), this.player.define("setAspectRatio", (t) => {
      this.set(t);
    });
  }
  mounted() {
    var t;
    console.log("233333311111111"), (t = this.observer) == null || t.observe(this.player.$area), this._setRatio(kt(this, R));
  }
  set(t) {
    const e = this._parse(t);
    ve(this, R, e), this._setRatio(e), this.player.emit("aspectRatioChange", this._stringify(e));
  }
  /** 设置视频比例 */
  _setRatio(t) {
  ...
  _keepRatio(t, e) {
    if (kt(this, R)) {
      ...
      const [n, a] = kt(this, R), { width: l, height: o } = i.getBoundingClientRect();
...
const qn = [
  ...
  Ls,
  _s
], On = [Ie, qe, $s], zn = [Re, Ne, fs, bs, xs], Vn = [qs, Bs, Is];
class Wn extends Rt {
  constructor(t) {
    super({
      autoPart: !0,
