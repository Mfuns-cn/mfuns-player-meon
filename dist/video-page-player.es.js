...
var M = (i, t, e) => (ri(i, t, "read from private field"), e ? e.call(i) : t.get(i)), R = (i, t, e) => {
  if (t.has(i))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(i) : t.set(i, e);
}, L = (i, t, e, s) => (ri(i, t, "write to private field"), s ? s.call(i, e) : t.set(i, e), e);
const Wi = /mobile/i.test(window.navigator.userAgent), Ti = document.fullscreenEnabled || document.webkitFullscreenEnabled || document.mozFullScreenEnabled || document.msFullscreenEnabled || !1, Si = document.pictureInPictureEnabled || !1;
function u(i, t, e) {
...
function Ge(i, t) {
  return t.replace(
    ...
    (e) => {
      var s;
      return (s = Ft[e]) == null ? void 0 : s.call(Ft, i);
    }
  );
}
const qa = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  dateFormat: Ge,
  debounce: Ht,
  fullScreenEnabled: Ti,
  isMobile: Wi,
  numberToHexColor: _i,
  pictureInPictureEnabled: Si,
  random: Xi,
  replaceChildren: Ui,
  secondToTime: yt,
  throttle: Ai,
...
let ut = (Z = class {
  constructor(t) {
    this.hook = new tn(), this.plugins = {}, this.invokes = {}, this._eventEmitter = new sn(), this.Player = Z, this.container = t.container, this.$el = u("div", { class: `${a} mpui` }), this.$main = this.$el.appendChild(u("div", { class: `${a}-main` })), this.$area = this.$main.appendChild(u("div", { class: `${a}-area` })), this.$content = this.$area.appendChild(
  ...
  seek(t) {
    this.hook.call("seek").then((e) => {
      e && (this.$video.currentTime = zt(t, 0, this.$video.duration));
    });
  }
  /** 设置音量
   * @param volume 音量（0-1）
...
class ct {
  constructor({
    ...
    this.container = t, this.min = e, this.max = s, this.step = n || 0, this.divider = r ? typeof r == "boolean" ? this.step : r : 0, this.value = isNaN(l) ? l : Number(l), this.onChange = h, this.onDragStart = o, this.onDragEnd = c, this.onDrag = p, this.$el = this.container.appendChild(
      ...
      var w;
      const b = g, { clientX: T } = b, S = this.$track.offsetWidth;
      let m = this.$thumbTrack.offsetWidth;
      m = m || S;
      const v = (S - m) / 2, d = this.$el.getBoundingClientRect().left;
      let $ = T - d - v;
      $ = $ >= m ? m : $ <= 0 ? 0 : $;
      const E = this.step ? Math.round($ / m * (this.max - this.min) / this.step) * this.step + this.min : $ / m * (this.max - this.min) + this.min;
      (w = this.onDragStart) == null || w.call(this, E), this.value != E && this.drag(E);
      const k = (x) => {
        var ot;
        ...
        var y, _;
        x.stopPropagation(), (y = window.getSelection()) == null || y.removeAllRanges(), document.removeEventListener("mousemove", k), document.removeEventListener("mouseup", A), (_ = this.onDragEnd) == null || _.call(this, E);
      };
...
class Fi {
  constructor({
    ...
    this.container = t, this.min = e, this.max = s, this.step = n || 0, this.value = isNaN(r) ? r : Number(r), this.onChange = l, this.onDragStart = h, this.onDragEnd = o, this.onDrag = c, this.$el = u(
      ...
      var A;
      const g = p, { clientY: b } = g, T = this.$track.offsetHeight;
      let S = this.$thumbTrack.offsetHeight;
      S = S || T;
      const m = (T - S) / 2, v = this.$el.getBoundingClientRect().top;
      let d = S - (b - v - m);
      d = d >= S ? S : d <= 0 ? 0 : d;
      ...
      const E = (w) => {
        ...
        let y = S - (H - v - m);
        y = y >= S ? S : y <= 0 ? 0 : y;
        const _ = this.step ? Math.round(y / S * (this.max - this.min) / this.step) * this.step + this.min : y / S * (this.max - this.min) + this.min;
        this.value != _ && this.drag(_), (N = window.getSelection()) == null || N.removeAllRanges();
      }, k = (w) => {
        var H, y;
        w.stopPropagation(), (H = window.getSelection()) == null || H.removeAllRanges(), document.removeEventListener("mousemove", E), document.removeEventListener("mouseup", k), (y = this.onDragEnd) == null || y.call(this, $);
      };
 ...
 */
var Pt;
const At = window, rt = At.trustedTypes, oi = rt ? rt.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, Vt = "$lit$", V = `lit$${(Math.random() + "").slice(9)}$`, Pi = "?" + V, rn = `<${Pi}>`, J = document, pt = () => J.createComment(""), mt = (i) => i === null || typeof i != "object" && typeof i != "function", Ri = Array.isArray, ln = (i) => Ri(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", Rt = `[ 	
\f\r]`, ht = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, hi = /-->/g, ci = />/g, C = RegExp(`>|${Rt}(?:([^\\s"'>=/]+)(${Rt}*=${Rt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), di = /'/g, ui = /"/g, Ni = /^(?:script|style|textarea|title)$/i, on = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e }), O = on(1), vt = Symbol.for("lit-noChange"), P = Symbol.for("lit-nothing"), pi = /* @__PURE__ */ new WeakMap(), W = J.createTreeWalker(J, 129, null, !1);
function Di(i, t) {
...
const hn = (i, t) => {
  ...
  for (let h = 0; h < e; h++) {
    ...
    for (; b < o.length && (l.lastIndex = b, p = l.exec(o), p !== null); )
      b = l.lastIndex, l === ht ? p[1] === "!--" ? l = hi : p[1] !== void 0 ? l = ci : p[2] !== void 0 ? (Ni.test(p[2]) && (n = RegExp("</" + p[2], "g")), l = C) : p[3] !== void 0 && (l = C) : l === C ? p[0] === ">" ? (l = n ?? ht, g = -1) : p[1] === void 0 ? g = -2 : (g = l.lastIndex - p[2].length, c = p[1], l = p[3] === void 0 ? C : p[3] === '"' ? ui : di) : l === ui || l === di ? l = C : l === hi || l === ci ? l = ht : (l = C, n = void 0);
    const T = l === C && i[h + 1].startsWith("/>") ? " " : "";
    r += l === ht ? o + rn : g >= 0 ? (s.push(c), o.slice(0, g) + Vt + o.slice(g) + V + T) : o + V + (g === -2 ? (s.push(void 0), h) : T);
  }
  return [Di(i, r + (i[e] || "<?>") + (t === 2 ? "</svg>" : "")), s];
};
class $t {
      ...
      if (n.nodeType === 1) {
        if (n.hasAttributes()) {
          ...
          for (const b of n.getAttributeNames())
            if (b.endsWith(Vt) || b.startsWith(V)) {
              const T = p[l++];
              if (g.push(b), T !== void 0) {
                const S = n.getAttribute(T.toLowerCase() + Vt).split(V), m = /([.?@])?(.*)/.exec(T);
                o.push({ type: 1, index: r, name: m[2], strings: S, ctor: m[1] === "." ? dn : m[1] === "?" ? pn : m[1] === "@" ? mn : _t });
              } else
        ...
        if (Ni.test(n.tagName)) {
          const g = n.textContent.split(V), b = g.length - 1;
          if (b > 0) {
            n.textContent = rt ? rt.emptyScript : "";
            for (let T = 0; T < b; T++)
              n.append(g[T], pt()), W.nextNode(), o.push({ type: 2, index: ++r });
            n.append(g[b], pt());
          }
        }
...
class cn {
  ...
  u(t) {
    ...
    for (; c !== void 0; ) {
      if (h === c.index) {
        let p;
        c.type === 2 ? p = new wt(l, l.nextSibling, this, t) : c.type === 1 ? p = new c.ctor(l, c.name, c.strings, this, t) : c.type === 6 && (p = new vn(l, this, t)), this._$AV.push(p), c = n[++o];
      }
      h !== (c == null ? void 0 : c.index) && (l = W.nextNode(), h++);
    }
    return W.currentNode = J, r;
  }
  v(t) {
    let e = 0;
...
class wt {
  ...
  g(t) {
    var e;
    const { values: s, _$litType$: n } = t, r = typeof n == "number" ? this._$AC(t) : (n.el === void 0 && (n.el = $t.createElement(Di(n.h, n.h[0]), this.options)), n);
    if (((e = this._$AH) === null || e === void 0 ? void 0 : e._$AD) === r)
      this._$AH.v(s);
    else {
      const l = new cn(r, this), h = l.u(this.options);
  ...
  T(t) {
    ...
    let s, n = 0;
    for (const r of t)
      n === e.length ? e.push(s = new wt(this.k(pt()), this.k(pt()), this, this.options)) : s = e[n], s._$AI(r), n++;
...
mi == null || mi($t, wt), ((Pt = At.litHtmlVersions) !== null && Pt !== void 0 ? Pt : At.litHtmlVersions = []).push("2.8.0");
const Mt = (i, t, e) => {
  var s, n;
  ...
  if (l === void 0) {
    ...
    r._$litPart$ = l = new wt(t.insertBefore(pt(), h), h, void 0, e ?? {});
  }
  return l._$AI(i), l;
}, $n = ({
  list: i,
...
class tt {
  ...
  /** 重载，一般用于列表项更改 */
  reload(t) {
    Mt($n({ list: this.list, template: this.template }), this.container), this.$el = this.container.querySelector(".mpui-picker"), this.$items = this.$el.querySelectorAll(".mpui-picker-item"), this.$items.forEach((e) => {
...
class Ii {
  ...
  /** 重载，一般用于列表项更改 */
  reload(t) {
    Mt(gn({ list: this.list, template: this.template }), this.container), this.$el = this.container.querySelector(".mpui-picker"), this.$items = this.$el.querySelectorAll(".mpui-picker-item"), this.$items.forEach((e) => {
      e.addEventListener("click", () => {
...
`
  ...
  if (c.length) {
    ...
    c.forEach(([g, b, T]) => {
      if (!T)
        return;
      const S = u("div", { class: "list-operate-btn" }, g);
      S.onclick = (m) => {
...
`
  ...
  constructor(t) {
    super(t, u("div", { class: `${a}-videotime` }, En)), this.valueBeforeEdited = "", this.timeFormat = 2, this.$label = this.$(`.${a}-videotime-label`), this.$current = this.$(`.${a}-videotime-current`), this.$total = this.$(`.${a}-videotime-total`), this.$input = this.$(`.${a}-videotime-input`);
  }
  init() {
    this.player.on("timeupdate", (t) => {
      ...
      t != this.valueBeforeEdited && (this.player.seek(Ot(t)), this.player.play()), this.exitInput();
    }), this.$input.addEventListener("keydown", (t) => {
      const e = t || window.event;
      e.keyCode == 13 && (this.player.seek(Ot(this.$input.value)), this.player.play(), this.exitInput()), e.keyCode == 27 && this.exitInput();
    });
  }
  /** 退出输入模式 */
  exitInput() {
...
`
  ...
  get ignored() {
    return !this.player.enterPip || !Si;
  }
};
...
`
  ...
  get ignored() {
    return !this.player.enterFullscreen || !Ti;
  }
};
...
`
  ...
  constructor(t) {
    super(t, u("div", { class: `${a}-progress` }, zn)), this.trackLength = 0, this.distance = 0, this.nMax = 0, this.nLeft = 0, this.isDragging = !1, this.isHover = !1, this.isActive = !1, this.$bar = this.$(`.${a}-progress-bar`), this.$buffered = this.$(`.${a}-progress-buffered`), this.$played = this.$(`.${a}-progress-played`), this.$thumbTrack = this.$(`.${a}-progress-thumb-track`), this.$thumb = this.$(`.${a}-progress-thumb`), this.$preview = this.$(`.${a}-progress-preview`), this.$thumbnail = this.$(`.${a}-progress-thumbnail`), this.$time = this.$(`.${a}-progress-time`), this.$tip = this.$(`.${a}-progress-tip`), this.$el.addEventListener("mousedown", (n) => {
      const { clientX: r } = n;
...
`
  ...
  constructor(t) {
    super(t, u("div", { class: `${a}-settings` }, On)), this.title = "设置", this.$slot = this.$(`.${a}-settings-slot`), this.$play = this.$(`.${a}-settings-play`), this.$others = this.$(`.${a}-settings-others`), this.$ratePicker = this.$(`.${a}-settings-rate-picker`), this.$ratioPicker = this.$(`.${a}-settings-ratio-picker`);
  }
  init() {
...
X = new WeakMap(), ks.pluginName = "side";
let ce = ks;
...
const Es = class Es extends f {
  constructor(e) {
    ...
    R(this, I, void 0);
    R(this, B, void 0);
    L(this, I, !1), L(this, B, !1), this.activeDuration = 3e3, this.player.define("isActive", {
      get: () => M(this, I)
    });
    const s = Ht(() => {
      L(this, B, !1), this.remove();
    }, this.activeDuration);
    this.player.$main.addEventListener("mousemove", () => {
      L(this, B, !0), this.set(), s();
...
I = new WeakMap(), B = new WeakMap(), Es.pluginName = "stateActive";
let me = Es;
const Ts = class Ts extends f {
  constructor(t) {
...
var G = function(i) {
  ...
  borderBoxSize: et(),
  contentBoxSize: et(),
  contentRect: new zi(0, 0, 0, 0)
}), Vi = function(i, t) {
  if (t === void 0 && (t = !1), xt.has(i) && !t)
    return xt.get(i);
  if (Oi(i))
    return xt.set(i, fi), fi;
  var e = getComputedStyle(i), s = Ze(i) && i.ownerSVGElement && i.getBBox(), n = !Xn && e.boxSizing === "border-box", r = Un.test(e.writingMode || ""), l = !s && gi.test(e.overflowY || ""), h = !s && gi.test(e.overflowX || ""), o = s ? 0 : D(e.paddingTop), c = s ? 0 : D(e.paddingRight), p = s ? 0 : D(e.paddingBottom), g = s ? 0 : D(e.paddingLeft), b = s ? 0 : D(e.borderTopWidth), T = s ? 0 : D(e.borderRightWidth), S = s ? 0 : D(e.borderBottomWidth), m = s ? 0 : D(e.borderLeftWidth), v = g + c, d = o + p, $ = m + T, E = b + S, k = h ? i.offsetHeight - E - i.clientHeight : 0, A = l ? i.offsetWidth - $ - i.clientWidth : 0, w = n ? v + $ : 0, x = n ? d + E : 0, H = s ? s.width : D(e.width) - w - A, y = s ? s.height : D(e.height) - x - k, _ = H + v + A + $, N = y + d + k + E, ot = G({
    ...
    contentRect: new zi(g, o, H, y)
  });
  return xt.set(i, ot), ot;
}, Bi = function(i, t, e) {
  var s = Vi(i, e), n = s.borderBoxSize, r = s.contentBoxSize, l = s.devicePixelContentBoxSize;
  switch (t) {
  ...
  return Ci.splice(0).forEach(function(i) {
    return i();
  });
}, Jn = function(i) {
  if (!Nt) {
  ...
  return !!Tt;
}, ea = 250, sa = { attributes: !0, characterData: !0, childList: !0, subtree: !0 }, bi = [
  "resize",
  "load",
  "transitionend",
  "animationend",
  ...
  return i.prototype.run = function(t) {
    ...
    var t = this, e = function() {
      return t.observer && t.observer.observe(document.body, sa);
    };
...
}(), $e = new ia(), wi = function(i) {
  !Tt && i > 0 && $e.start(), Tt += i, !Tt && $e.stop();
}, na = function(i) {
  ...
  return i.connect = function(t, e) {
    ...
    var n = Lt.get(t), r = n.observationTargets.length === 0;
    xi(n.observationTargets, e) < 0 && (r && K.push(n), n.observationTargets.push(new aa(e, s && s.box)), wi(1), $e.schedule());
  }, i.unobserve = function(t, e) {
    var s = Lt.get(t), n = xi(s.observationTargets, e), r = s.observationTargets.length === 1;
    n >= 0 && (r && K.splice(K.indexOf(s), 1), s.observationTargets.splice(n, 1), wi(-1));
...
const Ss = class Ss extends f {
  constructor(t) {
    super(t);
    const e = window.ResizeObserver || ji;
...
const oa = [
  ...
  Jt,
  ee
], da = [...oa, ...ha, ...ca], Hs = class Hs extends f {
  constructor() {
...
const It = {
  ...
  setTheme(t) {
    Object.assign(this.properties, t), this.themeElement.forEach((e) => {
      let s;
      for (s in t)
        e.style.setProperty(It[s], t[s]);
    });
  }
  /** 设置某个主题属性 */
  set(t, e) {
    this.properties[t] = e, this.themeElement.forEach((s) => {
      s.style.setProperty(It[t], e);
    });
  }
  get(t) {
...
`
  ...
  constructor(t) {
    super(t, u("div", { class: `${a}-videostatus` }, va)), this.$paused = this.$(`.${a}-videostatus-paused`), this.$loading = this.$(`.${a}-videostatus-loading`), this.$volume = this.$(`.${a}-videostatus-volume`), this.player.$area.appendChild(this.$el), this.player.on("volumechange", (s, n) => {
      n && s > 0 ? this.$volume.innerText = "已静音" : this.$volume.innerText = `音量 | ${Math.round(s * 100)}%`;
    });
    const e = Ht(() => this.hideVolume(), 3e3);
...
`
  ...
  constructor(t) {
    super(t, u("div", { class: `${a}-loadingmask` }, $a)), this.delay = 0, this.$info = this.$(`.${a}-loadingmask-info`), this.$tips = this.$(`.${a}-loadingmask-tips`), this.player.$main.appendChild(this.$el);
  }
  apply(t, e) {
    var s, n;
...
const Cs = class Cs extends f {
  constructor(e) {
    ...
    if (this.$el = u("div", { class: `${a}-mini` }), this.player.$el.appendChild(this.$el), this.player.on("intersection", (n) => {
      const r = !M(this, Y) || this.player.isPip;
  ...
  init() {
    this.$el.addEventListener("click", () => {
      ...
      console.log([r, l]);
      const h = s - r, o = n - l, c = (g) => {
        L(this, at, !0);
        const { clientX: b, clientY: T } = g;
        this.$el.style.left = `${b - h}px`, this.$el.style.top = `${T - o}px`;
      }, p = () => {
  ...
  _show() {
    M(this, q) || (this.player.$area.style.height = `${this.player.$area.clientHeight}px`, this.$el.append(...this.player.$area.children), this.$el.classList.add("is-show"), L(this, q, !0));
  }
  _hide() {
    M(this, q) && (this.player.$area.style.height = "", this.player.$area.append(...this.$el.children), this.$el.classList.remove("is-show"), L(this, q, !1));
  }
  /** 播放器小窗启用状态 */
  get enabled() {
    return M(this, Y);
...
q = new WeakMap(), at = new WeakMap(), Y = new WeakMap(), Cs.pluginName = "mini";
let Pe = Cs;
...
class fa {
  ...
  draw(t) {
    ...
    const l = (m) => {
      ...
      t:
        for (let $ = 0; this.overlap || $ < r; $++) {
          const E = c(v, $);
          let k = this.danmakuTracks[v][$];
          if (this.danmakuTracks[v][$] = E, k && k.length) {
            if (v === "roll") {
              const A = s / o(d);
              k.length !== E.length && (k = E);
              for (const w of k) {
                const x = l(w) - 10;
                if (this.trackHeights[v][$] = parseInt(w.style.fontSize) + this.trackPadding, x <= s - A * o(w.getBoundingClientRect().width) || x <= 0)
                  continue t;
              }
            } else if (v === "reverse") {
              const A = s / o(d);
            ...
            return this.danmakuTracks[v][$].push(m), m.addEventListener("animationend", () => {
              var w, x;
              const A = (w = this.danmakuTracks[v][$]) == null ? void 0 : w.indexOf(m);
    ...
    for (let m = 0; m < t.length; m++) {
      ...
      d.classList.add(`${this.classPrefix}-danmaku-item`), d.classList.add(`${this.classPrefix}-danmaku-${St[v.mode]}`), d.innerHTML = `${v.content.replace(/(\\n)/g, `
`)}`, typeof v.color == "number" ? d.style.color = _i(v.color) : d.style.color = v.color, d.style.opacity = this.opacity.toString(), d.style.fontSize = +v.size * this.fontScale + "px", v.fromHere && (d.style.border = "2px solid white"), d.addEventListener("animationend", () => {
      ...
      switch (E) {
        case "roll":
        case "reverse":
          if (A = p(d, E, $), k = A % r, k >= 0) {
            const w = this.trackHeights[E].slice(0, r).reduce((_, N) => _ + N, 0), x = this.trackHeights[E].slice(0, k).reduce((_, N) => _ + N, 0) % w;
        ...
        case "top":
          if (k = p(d, E, 0) % r, k >= 0) {
            ...
            d.dataset.track = k.toString(), d.style.width = $ + 1 + "px", d.style.marginLeft = `-${($ + 1) * 0.5}px`, d.style.top = H + "px", d.style.fontFamily = this.fontFamily, d.style.fontWeight = this.fontWeight, d.style.setProperty("--duration", `${this.baseDuration / this.speed}s`);
          }
          break;
        case "bottom":
          if (E = "bottom", k = p(d, E, 0) % r, k >= 0) {
            ...
            d.dataset.track = k.toString(), d.style.width = $ + 1 + "px", d.style.marginLeft = `-${($ + 1) * 0.5}px`, d.style.bottom = H + "px", d.style.fontFamily = this.fontFamily, d.style.fontWeight = this.fontWeight, d.style.setProperty("--duration", `${this.baseDuration / this.speed}s`);
          }
          break;
        default:
  ...
  captureDanmakuDOM(t, e, s, n = !1) {
    ...
    for (const h of l)
      if (h.innerHTML) {
        const o = h.getBoundingClientRect(), c = this.container.getBoundingClientRect(), p = o.left - c.left, g = o.right - c.left, b = o.top - c.top, T = o.bottom - c.top;
        if (t >= p - s && t <= g + s && e >= b - s && e <= T + s && (r.push(h), n))
          return r;
      }
    return r;
  }
...
const Ys = class Ys extends f {
  constructor() {
    super(...arguments), this.type = "", this.parser = ba;
  }
  get danmaku() {
...
`
  ...
  apply(t, e) {
    var s, n, r;
    (s = e.danmakuBar) != null && s.loginRequired && this.setLoginRequired(!0), this.setPlaceHolder(((n = e.danmakuBar) == null ? void 0 : n.placeholder) || xa), this.controls = ((r = e.danmakuBar) == null ? void 0 : r.controls) || {};
  }
  ready() {
    this.setControls(this.controls);
  }
...
`, Ta = (i) => navigator.clipboard.writeText(i), Qs = class Qs extends f {
  constructor(t) {
  ...
  update(t) {
    ...
    t != null && t.length ? this.$el.style.display = "" : this.$el.style.display = "none", Mt(
      Ea(
        t,
        (n) => {
...
`
  ...
  init(t) {
    this.pickerSize = new tt({
      ...
      value: "#FFFFFF",
      list: _a.map((e) => ({ value: e })),
      onPick: (e) => {
        this.danmakuBar.danmakuColor = Hi(e);
      },
      onChange: (e) => {
...
const ni = class ni extends f {
  constructor(e) {
    super(e);
    R(this, z, null);
    const s = window.ResizeObserver || ji;
...
`
), ai = class ai extends bt {
  constructor(t) {
    super(t, u("div", { class: `${a}-footbar` }, Na)), this.controls = {}, this.$left = this.$(`.${a}-footbar-left`), this.$right = this.$(`.${a}-footbar-right`);
  }
  apply(t, e) {
    var s;
...
const Da = [
  ...
  Re,
  Ke
], Ia = [se, ie, Ee], za = [te, Qt, Te, Ae, Me], Oa = [Xe, We, Ue], Va = [
  ...Pa,
  ...da,
  ...Da,
  ...Ia,
