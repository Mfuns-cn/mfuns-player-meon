...
var A = (i, t, e) => (hi(i, t, "read from private field"), e ? e.call(i) : t.get(i)), R = (i, t, e) => {
  if (t.has(i))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(i) : t.set(i, e);
}, w = (i, t, e, s) => (hi(i, t, "write to private field"), s ? s.call(i, e) : t.set(i, e), e);
...
function Je(i, t) {
  return t.replace(
    ...
    (e) => {
      var s;
      return (s = Rt[e]) == null ? void 0 : s.call(Rt, i);
    }
  );
}
function Tt(i) {
...
function Qe(...i) {
  ...
  return i.shift(), i.forEach((e) => {
    if (Tt(e)) {
      Tt(t) || (t = {});
      for (const s in e)
        t[s] && Tt(e[s]) ? t[s] = Qe(t[s], e[s]) : t[s] = e[s];
    }
  }), t;
}
function Ri(...i) {
  ...
  return i.shift(), i.forEach((s) => {
    s.plugins && (e = e.concat(e, s.plugins)), Qe(t, s);
  }), t.plugins = e, t;
}
const Ua = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  throttle: Mi,
  timeToSecond: Bt
}, Symbol.toStringTag, { value: "Module" })), a = "mfuns-player", Ji = "3.0.0-alpha.8", Qi = "3481c24", tn = "https://github.com/Mfuns-cn/mfunsPlayer/tree/v3-beta", en = [
...
let pt = (J = class {
  ...
  seek(t) {
    this.hook.call("seek").then((e) => {
      e && (this.$video.currentTime = Vt(t, 0, this.$video.duration));
    });
  }
  /** 设置音量
   * @param volume 音量（0-1）
...
class Ni extends kt {
  ...
  /** 挂载 */
  mount(e, s) {
    e.appendChild(this.$el), this.unmount(), w(this, it, s == null ? void 0 : s.onUnmount);
  }
  /** 卸载 */
  unmount() {
    var e;
    (e = A(this, it)) == null || e.call(this), w(this, it, void 0);
  }
  show() {
...
class wt extends Ni {
  ...
  /** 挂载 */
  mount(e, s) {
    super.mount(e, { onUnmount: s == null ? void 0 : s.onUnmount }), w(this, nt, s == null ? void 0 : s.onToggle);
  }
  /** 卸载 */
  unmount() {
    this.toggle(!1), super.unmount(), w(this, nt, void 0);
  }
  /** 切换显示隐藏状态 */
  toggle(e) {
    var s;
    this.shown = e ?? !this.shown, (s = A(this, nt)) == null || s.call(this, this.shown);
  }
}
nt = new WeakMap();
class Xa extends f {
...
class dt {
  constructor({
    ...
    this.container = t, this.min = e, this.max = s, this.step = n || 0, this.divider = r ? typeof r == "boolean" ? this.step : r : 0, this.value = isNaN(l) ? l : Number(l), this.onChange = h, this.onDragStart = o, this.onDragEnd = c, this.onDrag = p, this.$el = this.container.appendChild(
      ...
      let g = S - d - v;
      g = g >= m ? m : g <= 0 ? 0 : g;
      const E = this.step ? Math.round(g / m * (this.max - this.min) / this.step) * this.step + this.min : g / m * (this.max - this.min) + this.min;
      (x = this.onDragStart) == null || x.call(this, E), this.value != E && this.drag(E);
      const k = (L) => {
        var ht;
        const _ = L, { clientX: y } = _;
        _.preventDefault(), _.stopPropagation();
        let M = y - d - v;
        M = M >= m ? m : M <= 0 ? 0 : M;
        const N = this.step ? Math.round(M / m * (this.max - this.min) / this.step) * this.step + this.min : M / m * (this.max - this.min) + this.min;
        this.value != N && this.drag(N), (ht = window.getSelection()) == null || ht.removeAllRanges();
      }, H = (L) => {
        var y, M;
        L.stopPropagation(), (y = window.getSelection()) == null || y.removeAllRanges(), document.removeEventListener("mousemove", k), document.removeEventListener("mouseup", H), (M = this.onDragEnd) == null || M.call(this, E);
      };
...
class Di {
  constructor({
    ...
    this.container = t, this.min = e, this.max = s, this.step = n || 0, this.value = isNaN(r) ? r : Number(r), this.onChange = l, this.onDragStart = h, this.onDragEnd = o, this.onDrag = c, this.$el = u(
      ...
      (H = this.onDragStart) == null || H.call(this, g), this.value != g && this.drag(g);
      const E = (x) => {
        var N;
        const L = x, { clientY: _ } = L;
        L.preventDefault(), L.stopPropagation();
        let y = T - (_ - v - m);
        y = y >= T ? T : y <= 0 ? 0 : y;
        const M = this.step ? Math.round(y / T * (this.max - this.min) / this.step) * this.step + this.min : y / T * (this.max - this.min) + this.min;
        this.value != M && this.drag(M), (N = window.getSelection()) == null || N.removeAllRanges();
      }, k = (x) => {
        var _, y;
        x.stopPropagation(), (_ = window.getSelection()) == null || _.removeAllRanges(), document.removeEventListener("mousemove", E), document.removeEventListener("mouseup", k), (y = this.onDragEnd) == null || y.call(this, g);
      };
 ...
 */
var Nt;
const _t = window, lt = _t.trustedTypes, di = lt ? lt.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, qt = "$lit$", V = `lit$${(Math.random() + "").slice(9)}$`, Ii = "?" + V, cn = `<${Ii}>`, Q = document, mt = () => Q.createComment(""), vt = (i) => i === null || typeof i != "object" && typeof i != "function", zi = Array.isArray, dn = (i) => zi(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", Dt = `[ 	
\f\r]`, ct = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ui = /-->/g, pi = />/g, C = RegExp(`>|${Dt}(?:([^\\s"'>=/]+)(${Dt}*=${Dt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), mi = /'/g, vi = /"/g, Oi = /^(?:script|style|textarea|title)$/i, un = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e }), O = un(1), gt = Symbol.for("lit-noChange"), P = Symbol.for("lit-nothing"), gi = /* @__PURE__ */ new WeakMap(), W = Q.createTreeWalker(Q, 129, null, !1);
function Vi(i, t) {
...
const pn = (i, t) => {
  ...
  let n, r = t === 2 ? "<svg>" : "", l = ct;
  for (let h = 0; h < e; h++) {
    const o = i[h];
    let c, p, $ = -1, b = 0;
    for (; b < o.length && (l.lastIndex = b, p = l.exec(o), p !== null); )
      b = l.lastIndex, l === ct ? p[1] === "!--" ? l = ui : p[1] !== void 0 ? l = pi : p[2] !== void 0 ? (Oi.test(p[2]) && (n = RegExp("</" + p[2], "g")), l = C) : p[3] !== void 0 && (l = C) : l === C ? p[0] === ">" ? (l = n ?? ct, $ = -1) : p[1] === void 0 ? $ = -2 : ($ = l.lastIndex - p[2].length, c = p[1], l = p[3] === void 0 ? C : p[3] === '"' ? vi : mi) : l === vi || l === mi ? l = C : l === ui || l === pi ? l = ct : (l = C, n = void 0);
    const S = l === C && i[h + 1].startsWith("/>") ? " " : "";
    r += l === ct ? o + cn : $ >= 0 ? (s.push(c), o.slice(0, $) + qt + o.slice($) + V + S) : o + V + ($ === -2 ? (s.push(void 0), h) : S);
  }
      ...
      if (n.nodeType === 1) {
        if (n.hasAttributes()) {
          ...
          for (const b of n.getAttributeNames())
            if (b.endsWith(qt) || b.startsWith(V)) {
              const S = p[l++];
              if ($.push(b), S !== void 0) {
                const T = n.getAttribute(S.toLowerCase() + qt).split(V), m = /([.?@])?(.*)/.exec(S);
                o.push({ type: 1, index: r, name: m[2], strings: T, ctor: m[1] === "." ? vn : m[1] === "?" ? $n : m[1] === "@" ? fn : Ft });
              } else
        ...
        if (Oi.test(n.tagName)) {
          ...
          if (b > 0) {
            ...
            for (let S = 0; S < b; S++)
              n.append($[S], mt()), W.nextNode(), o.push({ type: 2, index: ++r });
            n.append($[b], mt());
          }
        }
...
function ot(i, t, e = i, s) {
  ...
  return (o == null ? void 0 : o.constructor) !== c && ((r = o == null ? void 0 : o._$AO) === null || r === void 0 || r.call(o, !1), c === void 0 ? o = void 0 : (o = new c(i), o._$AT(i, e, s)), s !== void 0 ? ((l = (h = e)._$Co) !== null && l !== void 0 ? l : h._$Co = [])[s] = o : e._$Cl = o), o !== void 0 && (t = ot(i, o._$AS(i, t.values), o, s)), t;
}
class mn {
  constructor(t, e) {
  ...
  u(t) {
    ...
    for (; c !== void 0; ) {
      if (h === c.index) {
        let p;
        c.type === 2 ? p = new xt(l, l.nextSibling, this, t) : c.type === 1 ? p = new c.ctor(l, c.name, c.strings, this, t) : c.type === 6 && (p = new yn(l, this, t)), this._$AV.push(p), c = n[++o];
      }
      h !== (c == null ? void 0 : c.index) && (l = W.nextNode(), h++);
    }
    return W.currentNode = Q, r;
  }
  v(t) {
    let e = 0;
...
class xt {
  ...
  _$AI(t, e = this) {
    t = ot(this, t, e), vt(t) ? t === P || t == null || t === "" ? (this._$AH !== P && this._$AR(), this._$AH = P) : t !== this._$AH && t !== gt && this._(t) : t._$litType$ !== void 0 ? this.g(t) : t.nodeType !== void 0 ? this.$(t) : dn(t) ? this.T(t) : this._(t);
  }
  k(t) {
  ...
  _(t) {
    this._$AH !== P && vt(this._$AH) ? this._$AA.nextSibling.data = t : this.$(Q.createTextNode(t)), this._$AH = t;
  }
  g(t) {
    var e;
    const { values: s, _$litType$: n } = t, r = typeof n == "number" ? this._$AC(t) : (n.el === void 0 && (n.el = $t.createElement(Vi(n.h, n.h[0]), this.options)), n);
  ...
  _$AC(t) {
    ...
    return e === void 0 && gi.set(t.strings, e = new $t(t)), e;
  }
  T(t) {
    ...
    let s, n = 0;
    for (const r of t)
      n === e.length ? e.push(s = new xt(this.k(mt()), this.k(mt()), this, this.options)) : s = e[n], s._$AI(r), n++;
...
class Ft {
  ...
  _$AI(t, e = this, s, n) {
    ...
    let l = !1;
    if (r === void 0)
      t = ot(this, t, e, 0), l = !vt(t) || t !== this._$AH && t !== gt, l && (this._$AH = t);
    else {
      const h = t;
      let o, c;
      for (t = r[0], o = 0; o < r.length - 1; o++)
        c = ot(this, h[s + o], e, o), c === gt && (c = this._$AH[o]), l || (l = !vt(c) || c !== this._$AH[o]), c === P ? t = P : t !== P && (t += (c ?? "") + r[o + 1]), this._$AH[o] = c;
    }
    l && !n && this.j(t);
  }
  j(t) {
...
class fn extends Ft {
  ...
  _$AI(t, e = this) {
    var s;
    if ((t = (s = ot(this, t, e, 0)) !== null && s !== void 0 ? s : P) === gt)
      return;
...
const $i = _t.litHtmlPolyfillSupport;
$i == null || $i($t, xt), ((Nt = _t.litHtmlVersions) !== null && Nt !== void 0 ? Nt : _t.litHtmlVersions = []).push("2.8.0");
const Pt = (i, t, e) => {
  var s, n;
  ...
  if (l === void 0) {
    ...
    r._$litPart$ = l = new xt(t.insertBefore(mt(), h), h, void 0, e ?? {});
  }
  return l._$AI(i), l;
}, bn = ({
  list: i,
...
class et {
  ...
  /** 重载，一般用于列表项更改 */
  reload(t) {
    Pt(bn({ list: this.list, template: this.template }), this.container), this.$el = this.container.querySelector(".mpui-picker"), this.$items = this.$el.querySelectorAll(".mpui-picker-item"), this.$items.forEach((e) => {
...
class Bi {
  ...
  /** 重载，一般用于列表项更改 */
  reload(t) {
    Pt(kn({ list: this.list, template: this.template }), this.container), this.$el = this.container.querySelector(".mpui-picker"), this.$items = this.$el.querySelectorAll(".mpui-picker-item"), this.$items.forEach((e) => {
      e.addEventListener("click", () => {
  ...
  const o = u(
    ...
    `
      ...
      <div class="list-cell col-date">
        ${i.date ? Je(new Date(i.date * 1e3), "yy-MM-dd HH:mm") : "-"}
      </div>
    `
  );
  ...
  init() {
    ...
    this.list = new xn({
      ...
      createItem: (n, r) => En(n, r, {
        ...
        title: `${n.content}
${n.date ? Je(new Date(n.date * 1e3), "yyyy-MM-dd HH:mm:ss") : "-"} @ ${bt(n.time, 16)}`
      }),
      overflow: 5
    });
    const s = Mt(() => {
...
`
  ...
  init() {
    this.player.on("timeupdate", (t) => {
      ...
      t != this.valueBeforeEdited && (this.player.seek(Bt(t)), this.player.play()), this.exitInput();
    }), this.$input.addEventListener("keydown", (t) => {
      const e = t || window.event;
      e.keyCode == 13 && (this.player.seek(Bt(this.$input.value)), this.player.play(), this.exitInput()), e.keyCode == 27 && this.exitInput();
    });
  }
  /** 退出输入模式 */
  exitInput() {
...
ps.pluginName = "buttonWidescreen";
let ee = ps;
const Dn = (
  /*html*/
  `
...
vs.pluginName = "buttonFullscreen";
let ie = vs;
const zn = (
  /*html*/
  `
  <div class="${a}-about-logo"></div>
  <div class="${a}-about-version">version ${pt.version}-${pt.gitHash}</div>
...
const ks = class ks extends f {
  ...
  apply(e, s) {
    var n;
    w(this, U, ((n = s.modal) == null ? void 0 : n.panels) || []);
  }
  ready() {
    A(this, U).forEach((e) => {
...
U = new WeakMap(), ks.pluginName = "modal";
let he = ks;
const qn = (
  /*html*/
  `
...
const Ls = class Ls extends f {
  ...
  apply(e, s) {
    var n;
    w(this, X, ((n = s.side) == null ? void 0 : n.panels) || []);
  }
  ready() {
    A(this, X).forEach((e) => {
      const s = this.player.plugin.from(e);
...
const Ts = class Ts extends f {
  ...
  init() {
    this.player.define("userId", { get: () => A(this, at) }), this.player.define("authorId", { get: () => A(this, yt) }), this.player.define("login", () => this.login()), this.player.on("videoChange", ({ author: e }) => {
      (e == null ? void 0 : e.id) != null && w(this, yt, e.id || 0);
    });
  }
  apply(e, s) {
    w(this, at, s.userId || 0);
  }
  /** 调用页面登录 */
  async login() {
    var e;
  ...
  /** 设置用户 */
  async setUser(e) {
    w(this, at, e), this.player.emit("login", e);
  }
};
at = new WeakMap(), yt = new WeakMap(), Ts.pluginName = "user";
let ve = Ts;
var I, B;
const As = class As extends f {
  constructor(e) {
    ...
    R(this, I, void 0);
    R(this, B, void 0);
    w(this, I, !1), w(this, B, !1), this.activeDuration = 3e3, this.player.define("isActive", {
      get: () => A(this, I)
    });
    const s = Mt(() => {
      w(this, B, !1), this.remove();
    }, this.activeDuration);
    this.player.$main.addEventListener("mousemove", () => {
      w(this, B, !0), this.set(), s();
  ...
  /** 设置播放器活跃状态 */
  set() {
    A(this, I) || (this.player.$el.classList.add("is-active"), w(this, I, !0), this.player.emit("active"));
  }
  /** 移除播放器活跃状态 */
  remove() {
    !A(this, I) || A(this, B) || this.player.isControlled || this.player.hook.call("inactive").then((e) => {
      e && (this.player.$el.classList.remove("is-active"), w(this, I, !1), this.player.emit("inactive"));
    });
  }
};
I = new WeakMap(), B = new WeakMap(), As.pluginName = "stateActive";
let ge = As;
...
var Z = function(i) {
  ...
  return !1;
}, ut = typeof window < "u" ? window : {}, Lt = /* @__PURE__ */ new WeakMap(), bi = /auto|scroll/, Gn = /^tb|vertical/, Zn = /msie|trident/i.test(ut.navigator && ut.navigator.userAgent), D = function(i) {
  ...
  if (t === void 0 && (t = !1), Lt.has(i) && !t)
    return Lt.get(i);
  if (Ci(i))
    return Lt.set(i, ki), ki;
  var e = getComputedStyle(i), s = ts(i) && i.ownerSVGElement && i.getBBox(), n = !Zn && e.boxSizing === "border-box", r = Gn.test(e.writingMode || ""), l = !s && bi.test(e.overflowY || ""), h = !s && bi.test(e.overflowX || ""), o = s ? 0 : D(e.paddingTop), c = s ? 0 : D(e.paddingRight), p = s ? 0 : D(e.paddingBottom), $ = s ? 0 : D(e.paddingLeft), b = s ? 0 : D(e.borderTopWidth), S = s ? 0 : D(e.borderRightWidth), T = s ? 0 : D(e.borderBottomWidth), m = s ? 0 : D(e.borderLeftWidth), v = $ + c, d = o + p, g = m + S, E = b + T, k = h ? i.offsetHeight - E - i.clientHeight : 0, H = l ? i.offsetWidth - g - i.clientWidth : 0, x = n ? v + g : 0, L = n ? d + E : 0, _ = s ? s.width : D(e.width) - x - H, y = s ? s.height : D(e.height) - L - k, M = _ + v + H + g, N = y + d + k + E, ht = Z({
    devicePixelContentBoxSize: st(Math.round(_ * devicePixelRatio), Math.round(y * devicePixelRatio), r),
    borderBoxSize: st(M, N, r),
    contentBoxSize: st(_, y, r),
    contentRect: new qi($, o, _, y)
  });
...
}(), fe = new la(), Ei = function(i) {
  !At && i > 0 && fe.start(), At += i, !At && fe.stop();
}, oa = function(i) {
  return !ts(i) && !Kn(i) && getComputedStyle(i).display === "inline";
}, ha = function() {
  function i(t, e) {
  ...
  return i;
}(), Et = /* @__PURE__ */ new WeakMap(), Si = function(i, t) {
  ...
  return i.connect = function(t, e) {
    ...
    var n = Et.get(t), r = n.observationTargets.length === 0;
    Si(n.observationTargets, e) < 0 && (r && G.push(n), n.observationTargets.push(new ha(e, s && s.box)), Ei(1), fe.schedule());
  }, i.unobserve = function(t, e) {
    var s = Et.get(t), n = Si(s.observationTargets, e), r = s.observationTargets.length === 1;
...
const ua = [
  ...
  te,
  ie
], va = [...ua, ...pa, ...ma], Fs = class Fs extends f {
  constructor() {
...
const Ot = {
  ...
  setTheme(t) {
    Object.assign(this.properties, t), this.themeElement.forEach((e) => {
      let s;
      for (s in t)
        e.style.setProperty(Ot[s], t[s]);
    });
  }
  /** 设置某个主题属性 */
  set(t, e) {
    this.properties[t] = e, this.themeElement.forEach((s) => {
      s.style.setProperty(Ot[t], e);
    });
  }
  get(t) {
...
`
), qs = class qs extends kt {
  constructor(t) {
    super(t, u("div", { class: `${a}-videostatus` }, ya)), this.$paused = this.$(`.${a}-videostatus-paused`), this.$loading = this.$(`.${a}-videostatus-loading`), this.$volume = this.$(`.${a}-videostatus-volume`), this.player.$area.appendChild(this.$el), this.player.on("volumechange", (s, n) => {
      n && s > 0 ? this.$volume.innerText = "已静音" : this.$volume.innerText = `音量 | ${Math.round(s * 100)}%`;
    });
    const e = Mt(() => this.hideVolume(), 3e3);
...
`
), Cs = class Cs extends kt {
  constructor(t) {
    super(t, u("div", { class: `${a}-loadingmask` }, ba)), this.delay = 0, this.$info = this.$(`.${a}-loadingmask-info`), this.$tips = this.$(`.${a}-loadingmask-tips`), this.player.$main.appendChild(this.$el);
  }
  apply(t, e) {
    var s, n;
...
const Us = class Us extends f {
  constructor(e) {
    ...
    if (this.$el = u("div", { class: `${a}-mini` }), this.player.$el.appendChild(this.$el), this.player.on("intersection", (n) => {
      const r = !A(this, Y) || this.player.isPip;
  ...
  init() {
    this.$el.addEventListener("click", () => {
      !A(this, rt) && (this.player.paused ? this.player.play : this.player.pause());
  ...
  _show() {
    A(this, q) || (this.player.$area.style.height = `${this.player.$area.clientHeight}px`, this.$el.append(...this.player.$area.children), this.$el.classList.add("is-show"), w(this, q, !0));
  }
  _hide() {
    A(this, q) && (this.player.$area.style.height = "", this.player.$area.append(...this.$el.children), this.$el.classList.remove("is-show"), w(this, q, !1));
  }
  /** 播放器小窗启用状态 */
  get enabled() {
    return A(this, Y);
...
q = new WeakMap(), rt = new WeakMap(), Y = new WeakMap(), Us.pluginName = "mini";
let Ne = Us;
...
let ze = Ks;
var Ht = /* @__PURE__ */ ((i) => (i[i.roll = 1] = "roll", i[i.bottom = 4] = "bottom", i[i.top = 5] = "top", i[i.reverse = 6] = "reverse", i[i.special = 7] = "special", i[i.advanced = 9] = "advanced", i))(Ht || {});
class wa {
  constructor(t, e) {
  ...
  /** 检查弹幕类型过滤 */
  checkTrackFilter(t) {
    return !this.trackFilter[Ht[t.mode]];
  }
  /** 设置弹幕颜色过滤 */
  setColorFilter(t) {
  ...
  draw(t) {
    ...
    const l = (m) => {
      ...
      t:
        for (let g = 0; this.overlap || g < r; g++) {
          ...
          if (this.danmakuTracks[v][g] = E, k && k.length) {
            if (v === "roll") {
              const H = s / o(d);
              k.length !== E.length && (k = E);
              for (const x of k) {
                const L = l(x) - 10;
                if (this.trackHeights[v][g] = parseInt(x.style.fontSize) + this.trackPadding, L <= s - H * o(x.getBoundingClientRect().width) || L <= 0)
                  continue t;
              }
            } else if (v === "reverse") {
              const H = s / o(d);
            ...
            return this.danmakuTracks[v][g].push(m), m.addEventListener("animationend", () => {
              var x, L;
              const H = (x = this.danmakuTracks[v][g]) == null ? void 0 : x.indexOf(m);
              H && ((L = this.danmakuTracks[v][g]) == null || L.splice(H, 1));
            }), g;
          } else
    ...
    for (let m = 0; m < t.length; m++) {
      ...
      d.classList.add(`${this.classPrefix}-danmaku-item`), d.classList.add(`${this.classPrefix}-danmaku-${Ht[v.mode]}`), d.innerHTML = `${v.content.replace(/(\\n)/g, `
`)}`, typeof v.color == "number" ? d.style.color = Pi(v.color) : d.style.color = v.color, d.style.opacity = this.opacity.toString(), d.style.fontSize = +v.size * this.fontScale + "px", v.fromHere && (d.style.border = "2px solid white"), d.addEventListener("animationend", () => {
      ...
      switch (E) {
        case "roll":
        case "reverse":
          if (H = p(d, E, g), k = H % r, k >= 0) {
            const x = this.trackHeights[E].slice(0, r).reduce((M, N) => M + N, 0), L = this.trackHeights[E].slice(0, k).reduce((M, N) => M + N, 0) % x;
            if (L + parseInt(d.style.fontSize) + this.trackPadding > n) {
              (b = this.danmakuTracks[E][m]) == null || b.pop();
              return;
            }
            const _ = o(g), y = g + s + this.startDistance * 2;
            d.dataset.track = H.toString(), d.style.width = g + 1 + "px", d.style.top = L + "px", d.style.fontFamily = this.fontFamily, d.style.fontWeight = this.fontWeight, d.style.setProperty("--duration", `${y / _}s`), d.style.setProperty("--offset", `${s + this.startDistance}px`), d.style.setProperty("--translateX", `${-y}px`);
          }
          break;
        case "top":
          if (k = p(d, E, 0) % r, k >= 0) {
            const x = [], L = this.danmakuTracks.top;
            for (const y of L)
              x.push(...y);
            const _ = x.map((y) => parseInt(y.style.fontSize) + this.trackPadding).slice(0, k).reduce((y, M) => y + M, 0);
            if (_ + parseInt(d.style.fontSize) + this.trackPadding > n) {
              (S = this.danmakuTracks[E][m]) == null || S.pop();
              return;
            }
            d.dataset.track = k.toString(), d.style.width = g + 1 + "px", d.style.marginLeft = `-${(g + 1) * 0.5}px`, d.style.top = _ + "px", d.style.fontFamily = this.fontFamily, d.style.fontWeight = this.fontWeight, d.style.setProperty("--duration", `${this.baseDuration / this.speed}s`);
          }
          break;
        case "bottom":
          if (E = "bottom", k = p(d, E, 0) % r, k >= 0) {
            const x = [], L = this.danmakuTracks.bottom;
            for (const y of L)
              x.push(...y);
            const _ = x.map((y) => parseInt(y.style.fontSize) + this.trackPadding).slice(0, k).reduce((y, M) => y + M, 0);
            if (_ + parseInt(d.style.fontSize) + this.trackPadding > n) {
            ...
            d.dataset.track = k.toString(), d.style.width = g + 1 + "px", d.style.marginLeft = `-${(g + 1) * 0.5}px`, d.style.bottom = _ + "px", d.style.fontFamily = this.fontFamily, d.style.fontWeight = this.fontWeight, d.style.setProperty("--duration", `${this.baseDuration / this.speed}s`);
          }
          break;
        default:
...
const Zs = class Zs extends f {
  constructor() {
    super(...arguments), this.type = "", this.parser = La;
  }
  get danmaku() {
...
const ti = class ti extends F {
  constructor(e) {
    ...
    this.danmakuColor = 16777215, this.danmakuMode = 1, this.danmakuSize = 25, w(this, K, !1), this.coolDownTimer = 0, this.controls = {}, this.controller = this.plugins.controller, this.danmaku = this.plugins.danmaku, this.$send = this.$el.querySelector(`.${a}-danmakubar-send`), this.$input = this.$el.querySelector(`.${a}-danmakubar-input`), this.$outer = this.$el.querySelector(`.${a}-danmakubar-outer`), this.$left = this.$el.querySelector(`.${a}-danmakubar-left`), this.$right = this.$el.querySelector(`.${a}-danmakubar-right`), this.$logina = this.$el.querySelector(`.${a}-danmakubar-status-login a`), this.$logina.onclick = () => {
      ...
      A(this, K) && this.setLoginStatus(!s);
  ...
  apply(e, s) {
    var n, r, l;
    (n = s.danmakuBar) != null && n.loginRequired && (w(this, K, !0), !e.userId && this.setLoginStatus(!0)), this.setPlaceHolder(((r = s.danmakuBar) == null ? void 0 : r.placeholder) || Ta), this.controls = ((l = s.danmakuBar) == null ? void 0 : l.controls) || {};
  }
  ready() {
    this.setControls(this.controls);
  }
...
K = new WeakMap(), ti.pluginName = "danmakuBar";
let Ce = ti;
const Ta = "发条弹幕吧~", Aa = (
  /*html*/
  `
...
`, _a = (i) => navigator.clipboard.writeText(i), si = class si extends f {
  constructor(t) {
  ...
  update(t) {
    ...
    t != null && t.length ? this.$el.style.display = "" : this.$el.style.display = "none", Pt(
      Ha(
        t,
        (n) => {
...
const li = class li extends f {
  ...
  apply(e, s) {
    w(this, z, this._parse(s.aspectRatio || ""));
  }
  init() {
    this.player.define("aspectRatio", { get: () => this._stringify(A(this, z)) }), this.player.define("setAspectRatio", (e) => {
      this.set(e);
    });
  }
  mounted() {
    var e;
    console.log("233333311111111"), (e = this.observer) == null || e.observe(this.player.$area), this._setRatio(A(this, z));
  }
  set(e) {
    const s = this._parse(e);
    w(this, z, s), this._setRatio(s), this.player.emit("aspectRatioChange", this._stringify(s));
  }
  /** 设置视频比例 */
  _setRatio(e) {
  ...
  _keepRatio(e, s) {
    if (A(this, z)) {
      ...
      const [r, l] = A(this, z), { width: h, height: o } = n.getBoundingClientRect();
...
`
), oi = class oi extends kt {
  constructor(t) {
    super(t, u("div", { class: `${a}-footbar` }, Oa)), this.controls = {}, this.$left = this.$(`.${a}-footbar-left`), this.$right = this.$(`.${a}-footbar-right`);
  }
  apply(t, e) {
    var s;
...
const Va = [
  ...
  De,
  Ze
], Ba = [ne, ae, Te], qa = [se, ee, Ae, _e, Pe], Ca = [Ke, Xe, Ye], ja = [
  ...Ia,
  ...va,
  ...Va,
  ...Ba,
