...
function X(s) {
  return Object.getPrototypeOf(s) === Object.prototype;
}
function ot(...s) {
  if (s.length < 2)
    return s[0];
  let t = s[0];
  return s.shift(), s.forEach((e) => {
    if (X(e)) {
      X(t) || (t = {});
      for (const i in e)
        t[i] && X(e[i]) ? t[i] = ot(t[i], e[i]) : t[i] = e[i];
    }
  }), t;
}
function Vt(...s) {
  let t = { ...s[0] }, e = s[0].plugins || [];
  return s.shift(), s.forEach((i) => {
    i.plugins && (e = e.concat(e, i.plugins)), ot(t, i);
  }), t.plugins = e, t;
}
const ue = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  dateFormat: Pt,
  debounce: St,
  fullScreenEnabled: Ct,
  isMobile: kt,
  isPlainObject: X,
  mergeOptions: Vt,
  numberToHexColor: Nt,
  pictureInPictureEnabled: xt,
  random: wt,
  replaceChildren: Et,
  secondToTime: Tt,
  throttle: Mt,
  timeToSecond: Lt
}, Symbol.toStringTag, { value: "Module" })), O = "mfuns-player", Rt = "3.0.0-alpha.8", It = "3481c24", de = "https://github.com/Mfuns-cn/mfunsPlayer/tree/v3-beta", pe = [
...
const q = class q {
  constructor(t) {
    this.hook = new Ot(), this.plugins = {}, this.invokes = {}, this._eventEmitter = new Ut(), this.Player = q, this.container = t.container, this.$el = _("div", { class: `${O} mpui` }), this.$main = this.$el.appendChild(_("div", { class: `${O}-main` })), this.$area = this.$main.appendChild(_("div", { class: `${O}-area` })), this.$content = this.$area.appendChild(
      _("div", { class: `${O}-content` })
    ), this.invokes = t.invokes ?? {}, this.plugin = new jt(this), this._videoController = new Dt(this, t), this.loader = new qt(this), this.init(t);
  }
  /** 初始化播放器 */
  async init(t) {
    var e;
...
class $t extends Bt {
  ...
  unmount() {
    var e;
    (e = K(this, L)) == null || e.call(this), D(this, L, void 0);
  }
  show() {
...
class ve extends $t {
  ...
  toggle(e) {
    var i;
    this.shown = e ?? !this.shown, (i = K(this, T)) == null || i.call(this, this.shown);
  }
}
T = new WeakMap();
class ge extends gt {
  ...
  constructor({
    ...
    this.container = t, this.min = e, this.max = i, this.step = n || 0, this.divider = o ? typeof o == "boolean" ? this.step : o : 0, this.value = isNaN(r) ? r : Number(r), this.onChange = h, this.onDragStart = l, this.onDragEnd = a, this.onDrag = c, this.$el = this.container.appendChild(
      _(
        ...
        zt({ divider: this.divider })
      )
    ), this.$track = this.$el.querySelector(".mpui-slider-track"), this.$bar = this.$track.querySelector(".mpui-slider-bar"), this.$thumbTrack = this.$track.querySelector(".mpui-slider-thumb-track"), this.$thumb = this.$track.querySelector(".mpui-slider-thumb"), this.$el.addEventListener("mousedown", (u) => {
      var w;
      const d = u, { clientX: g } = d, m = this.$track.offsetWidth;
...
class Xt {
  constructor({
    ...
    this.container = t, this.min = e, this.max = i, this.step = n || 0, this.value = isNaN(o) ? o : Number(o), this.onChange = r, this.onDragStart = h, this.onDragEnd = l, this.onDrag = a, this.$el = _(
      ...
      var R;
      const u = c, { clientY: d } = u, g = this.$track.offsetHeight;
 ...
 */
var et;
const F = window, H = F.trustedTypes, at = H ? H.createPolicy("lit-html", { createHTML: (s) => s }) : void 0, nt = "$lit$", C = `lit$${(Math.random() + "").slice(9)}$`, ft = "?" + C, Zt = `<${ft}>`, M = document, U = () => M.createComment(""), B = (s) => s === null || typeof s != "object" && typeof s != "function", yt = Array.isArray, Ft = (s) => yt(s) || typeof (s == null ? void 0 : s[Symbol.iterator]) == "function", it = `[ 	
\f\r]`, j = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ct = /-->/g, ut = />/g, E = RegExp(`>|${it}(?:([^\\s"'>=/]+)(${it}*=${it}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), dt = /'/g, pt = /"/g, _t = /^(?:script|style|textarea|title)$/i, Gt = (s) => (t, ...e) => ({ _$litType$: s, strings: t, values: e }), G = Gt(1), z = Symbol.for("lit-noChange"), v = Symbol.for("lit-nothing"), mt = /* @__PURE__ */ new WeakMap(), S = M.createTreeWalker(M, 129, null, !1);
function At(s, t) {
    ...
    for (; (n = S.nextNode()) !== null && l.length < h; ) {
      if (n.nodeType === 1) {
        ...
        if (_t.test(n.tagName)) {
          const u = n.textContent.split(C), d = u.length - 1;
          if (d > 0) {
...
class Y {
  ...
  _$AI(t, e = this) {
    t = N(this, t, e), B(t) ? t === v || t == null || t === "" ? (this._$AH !== v && this._$AR(), this._$AH = v) : t !== this._$AH && t !== z && this._(t) : t._$litType$ !== void 0 ? this.g(t) : t.nodeType !== void 0 ? this.$(t) : Ft(t) ? this.T(t) : this._(t);
  }
  k(t) {
  ...
  _(t) {
    this._$AH !== v && B(this._$AH) ? this._$AA.nextSibling.data = t : this.$(M.createTextNode(t)), this._$AH = t;
  }
  g(t) {
    var e;
    const { values: i, _$litType$: n } = t, o = typeof n == "number" ? this._$AC(t) : (n.el === void 0 && (n.el = W.createElement(At(n.h, n.h[0]), this.options)), n);
  ...
  T(t) {
    ...
    let i, n = 0;
    for (const o of t)
      n === e.length ? e.push(i = new Y(this.k(U()), this.k(U()), this, this.options)) : i = e[n], i._$AI(o), n++;
...
class ee extends J {
  ...
  j(t) {
    t && t !== v ? this.element.setAttribute(this.name, te) : this.element.removeAttribute(this.name);
  }
}
class ie extends J {
  constructor(t, e, i, n, o) {
...
vt == null || vt(W, Y), ((et = F.litHtmlVersions) !== null && et !== void 0 ? et : F.litHtmlVersions = []).push("2.8.0");
const bt = (s, t, e) => {
  var i, n;
...
class oe {
  ...
  /** 重载，一般用于列表项更改 */
  reload(t) {
    bt(ne({ list: this.list, template: this.template }), this.container), this.$el = this.container.querySelector(".mpui-picker"), this.$items = this.$el.querySelectorAll(".mpui-picker-item"), this.$items.forEach((e) => {
...
console.log(
  `
 %c mfunsPlayer v${Z.version} ${Z.gitHash} %c https://github.com/Mfuns-cn 
