const mt = /mobile/i.test(window.navigator.userAgent), vt = document.fullscreenEnabled || document.webkitFullscreenEnabled || document.mozFullScreenEnabled || document.msFullscreenEnabled || !1, $t = document.pictureInPictureEnabled || !1;
function L(s, t, e) {
  const i = document.createElement(s);
  if (t)
    for (const n in t)
      i.setAttribute(n, t[n]);
  return typeof e == "string" ? i.innerText = e : e instanceof Node ? i.appendChild(e) : e != null && e.html ? (i.innerHTML = e.html, i.normalize()) : e != null && e.text && (i.innerText = e.text), i;
}
function ft(s, t) {
  s.innerHTML = "", typeof t == "string" ? s.innerText = t : s.appendChild(t);
}
const yt = (s, t, e = !1) => {
  let i = null, n = !1;
  return function(...r) {
...
function wt(s, t) {
  return t.replace(
    ...
    (e) => {
      var i;
      return (i = F[e]) == null ? void 0 : i.call(F, s);
    }
  );
}
const oe = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  dateFormat: wt,
  debounce: yt,
  fullScreenEnabled: vt,
  isMobile: mt,
  numberToHexColor: Ct,
  pictureInPictureEnabled: $t,
  random: bt,
  replaceChildren: ft,
  secondToTime: kt,
  throttle: _t,
  timeToSecond: At
}, Symbol.toStringTag, { value: "Module" })), j = "mfuns-player", Mt = void 0, St = "026c7e2", re = "https://github.com/Mfuns-cn/mfunsPlayer/tree/v3-beta", le = [
  ...
  set(t, e, i) {
    this.player.hook.call("video.set", t).then(async (n) => {
      ...
      if (n) {
        ...
        const u = { url: h, type: l, play: e, time: i, live: a };
...
class Lt {
  ...
  register(t, e) {
    ...
    (n = i.init) == null || n.call(i, this.player), t.pluginName && (this.player.plugin[t.pluginName] = i), console.log(t.pluginName), (o = i.apply) == null || o.call(i, this.player, e), this.initialized && ((r = i.ready) == null || r.call(i, this.player), (h = i.mounted) == null || h.call(i, this.player));
  }
  /** 批量注册插件 */
  pluginsRegister(t) {
    var e;
...
class Ht {
  ...
  build(t) {
    ...
    return (i = e.init) == null || i.call(e, this.player), (n = e.ready) == null || n.call(e, this.player), (o = e.mounted) == null || o.call(e, this.player), e;
  }
}
class Nt {
  constructor(t) {
...
const q = class q {
  constructor(t) {
    this.hook = new Tt(), this.plugin = {}, this._eventEmitter = new Rt(), this.Player = q, this.container = t.container, this.$el = L("div", { class: `${j} mpui` }), this.$main = this.$el.appendChild(L("div", { class: `${j}-main` })), this.$area = this.$main.appendChild(L("div", { class: `${j}-area` })), this.$content = this.$area.appendChild(
      L("div", { class: `${j}-content` })
    ), this._pluginManager = new Lt(this), this._videoController = new Et(this, t), this.loader = new Vt(this), this.controls = new Ht(this), this.panel = new Nt(this), this.menu = new Pt(this), this.init(t);
  }
  /** 初始化播放器 */
  async init(t) {
    this.on("videoChange", () => {
  ...
  seek(t) {
    this.hook.call("seek").then((e) => {
      e && (this.$video.currentTime = K(t, 0, this.$video.duration));
    });
  }
  /** 设置音量
   * @param volume 音量（0-1）
 ...
 */
var G;
const X = window, T = X.trustedTypes, it = T ? T.createPolicy("lit-html", { createHTML: (s) => s }) : void 0, Q = "$lit$", x = `lit$${(Math.random() + "").slice(9)}$`, ct = "?" + x, It = `<${ct}>`, S = document, U = () => S.createComment(""), B = (s) => s === null || typeof s != "object" && typeof s != "function", dt = Array.isArray, Dt = (s) => dt(s) || typeof (s == null ? void 0 : s[Symbol.iterator]) == "function", J = `[ 	
\f\r]`, D = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, st = /-->/g, nt = />/g, w = RegExp(`>|${J}(?:([^\\s"'>=/]+)(${J}*=${J}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ot = /'/g, rt = /"/g, pt = /^(?:script|style|textarea|title)$/i, jt = (s) => (t, ...e) => ({ _$litType$: s, strings: t, values: e }), _ = jt(1), z = Symbol.for("lit-noChange"), m = Symbol.for("lit-nothing"), lt = /* @__PURE__ */ new WeakMap(), M = S.createTreeWalker(S, 129, null, !1);
function gt(s, t) {
...
const qt = (s, t) => {
  ...
  for (let h = 0; h < e; h++) {
    const l = s[h];
    let a, u, c = -1, d = 0;
    for (; d < l.length && (r.lastIndex = d, u = r.exec(l), u !== null); )
      d = r.lastIndex, r === D ? u[1] === "!--" ? r = st : u[1] !== void 0 ? r = nt : u[2] !== void 0 ? (pt.test(u[2]) && (n = RegExp("</" + u[2], "g")), r = w) : u[3] !== void 0 && (r = w) : r === w ? u[0] === ">" ? (r = n ?? D, c = -1) : u[1] === void 0 ? c = -2 : (c = r.lastIndex - u[2].length, a = u[1], r = u[3] === void 0 ? w : u[3] === '"' ? rt : ot) : r === rt || r === ot ? r = w : r === st || r === nt ? r = D : (r = w, n = void 0);
    const v = r === w && s[h + 1].startsWith("/>") ? " " : "";
    o += r === D ? l + It : c >= 0 ? (i.push(a), l.slice(0, c) + Q + l.slice(c) + x + v) : l + x + (c === -2 ? (i.push(void 0), h) : v);
  }
  return [gt(s, o + (s[e] || "<?>") + (t === 2 ? "</svg>" : "")), i];
};
class W {
  constructor({ strings: t, _$litType$: e }, i) {
    ...
    this.parts = [];
    let o = 0, r = 0;
    const h = t.length - 1, l = this.parts, [a, u] = qt(t, e);
    if (this.el = W.createElement(a, i), M.currentNode = this.el.content, e === 2) {
      ...
      if (n.nodeType === 1) {
        if (n.hasAttributes()) {
          ...
          for (const d of n.getAttributeNames())
            if (d.endsWith(Q) || d.startsWith(x)) {
              const v = u[r++];
              if (c.push(d), v !== void 0) {
                const g = n.getAttribute(v.toLowerCase() + Q).split(x), p = /([.?@])?(.*)/.exec(v);
                l.push({ type: 1, index: o, name: p[2], strings: g, ctor: p[1] === "." ? Bt : p[1] === "?" ? Wt : p[1] === "@" ? Ot : Z });
              } else
        ...
        if (pt.test(n.tagName)) {
          const c = n.textContent.split(x), d = c.length - 1;
          if (d > 0) {
            n.textContent = T ? T.emptyScript : "";
            for (let v = 0; v < d; v++)
              n.append(c[v], U()), M.nextNode(), l.push({ type: 2, index: ++o });
            n.append(c[d], U());
          }
        }
        ...
        if (n.data === ct)
          ...
          for (; (c = n.data.indexOf(x, c + 1)) !== -1; )
            l.push({ type: 7, index: o }), c += x.length - 1;
        }
      o++;
    }
  }
...
function H(s, t, e = s, i) {
  ...
  return (l == null ? void 0 : l.constructor) !== a && ((o = l == null ? void 0 : l._$AO) === null || o === void 0 || o.call(l, !1), a === void 0 ? l = void 0 : (l = new a(s), l._$AT(s, e, i)), i !== void 0 ? ((r = (h = e)._$Co) !== null && r !== void 0 ? r : h._$Co = [])[i] = l : e._$Cl = l), l !== void 0 && (t = H(s, l._$AS(s, t.values), l, i)), t;
}
class Ut {
  constructor(t, e) {
  ...
  u(t) {
    var e;
    const { el: { content: i }, parts: n } = this._$AD, o = ((e = t == null ? void 0 : t.creationScope) !== null && e !== void 0 ? e : S).importNode(i, !0);
    M.currentNode = o;
    let r = M.nextNode(), h = 0, l = 0, a = n[0];
    for (; a !== void 0; ) {
      if (h === a.index) {
        let u;
        a.type === 2 ? u = new O(r, r.nextSibling, this, t) : a.type === 1 ? u = new a.ctor(r, a.name, a.strings, this, t) : a.type === 6 && (u = new Yt(r, this, t)), this._$AV.push(u), a = n[++l];
      }
      h !== (a == null ? void 0 : a.index) && (r = M.nextNode(), h++);
    }
    return M.currentNode = S, o;
  }
  v(t) {
    let e = 0;
...
class O {
  constructor(t, e, i, n) {
    var o;
    this.type = 2, this._$AH = m, this._$AN = void 0, this._$AA = t, this._$AB = e, this._$AM = i, this.options = n, this._$Cp = (o = n == null ? void 0 : n.isConnected) === null || o === void 0 || o;
  }
  get _$AU() {
    var t, e;
  ...
  _$AI(t, e = this) {
    t = H(this, t, e), B(t) ? t === m || t == null || t === "" ? (this._$AH !== m && this._$AR(), this._$AH = m) : t !== this._$AH && t !== z && this._(t) : t._$litType$ !== void 0 ? this.g(t) : t.nodeType !== void 0 ? this.$(t) : Dt(t) ? this.T(t) : this._(t);
  }
  k(t) {
  ...
  _(t) {
    this._$AH !== m && B(this._$AH) ? this._$AA.nextSibling.data = t : this.$(S.createTextNode(t)), this._$AH = t;
  }
  g(t) {
    var e;
    const { values: i, _$litType$: n } = t, o = typeof n == "number" ? this._$AC(t) : (n.el === void 0 && (n.el = W.createElement(gt(n.h, n.h[0]), this.options)), n);
    if (((e = this._$AH) === null || e === void 0 ? void 0 : e._$AD) === o)
      this._$AH.v(i);
    else {
      const r = new Ut(o, this), h = r.u(this.options);
  ...
  T(t) {
    ...
    let i, n = 0;
    for (const o of t)
      n === e.length ? e.push(i = new O(this.k(U()), this.k(U()), this, this.options)) : i = e[n], i._$AI(o), n++;
...
class Z {
  constructor(t, e, i, n, o) {
    this.type = 1, this._$AH = m, this._$AN = void 0, this.element = t, this.name = e, this._$AM = n, this.options = o, i.length > 2 || i[0] !== "" || i[1] !== "" ? (this._$AH = Array(i.length - 1).fill(new String()), this.strings = i) : this._$AH = m;
  }
  get tagName() {
  ...
  _$AI(t, e = this, i, n) {
    ...
    let r = !1;
    if (o === void 0)
      t = H(this, t, e, 0), r = !B(t) || t !== this._$AH && t !== z, r && (this._$AH = t);
    else {
      const h = t;
      let l, a;
      for (t = o[0], l = 0; l < o.length - 1; l++)
        a = H(this, h[i + l], e, l), a === z && (a = this._$AH[l]), r || (r = !B(a) || a !== this._$AH[l]), a === m ? t = m : t !== m && (t += (a ?? "") + o[l + 1]), this._$AH[l] = a;
    }
    r && !n && this.j(t);
  }
  j(t) {
...
const zt = T ? T.emptyScript : "";
class Wt extends Z {
  constructor() {
    super(...arguments), this.type = 4;
  }
  j(t) {
    t && t !== m ? this.element.setAttribute(this.name, zt) : this.element.removeAttribute(this.name);
  }
}
class Ot extends Z {
  constructor(t, e, i, n, o) {
  ...
  _$AI(t, e = this) {
    var i;
    if ((t = (i = H(this, t, e, 0)) !== null && i !== void 0 ? i : m) === z)
      return;
    const n = this._$AH, o = t === m && n !== m || t.capture !== n.capture || t.once !== n.once || t.passive !== n.passive, r = t !== m && (n === m || o);
...
ht == null || ht(W, O), ((G = X.litHtmlVersions) !== null && G !== void 0 ? G : X.litHtmlVersions = []).push("2.8.0");
const N = (s, t, e) => {
  var i, n;
  ...
  if (r === void 0) {
    ...
    o._$litPart$ = r = new O(t.insertBefore(U(), h), h, void 0, e ?? {});
  }
  return r._$AI(s), r;
}, Xt = ({ divider: s }) => _` <div
      ...
      <div class="mpui-slider-thumb-track" style="height: 0px">
        ...
        ${s ? _`
              <div class="mpui-slider-divider">
                ${new Array(s).fill(_`<div class="mpui-slider-divider-dot"></div>`)}
              </div>
            ` : ""}
      </div>
    </div>
...
class Zt {
  constructor({
    ...
    this.container = t, this.min = e, this.max = i, this.step = n || 0, this.divider = o ? typeof o == "boolean" ? this.step : o : 0, this.value = isNaN(r) ? r : Number(r), this.onChange = h, this.onDragStart = l, this.onDragEnd = a, this.onDrag = u, N(Xt({ divider: this.divider }), t), this.$el = this.container.querySelector(".mpui-slider"), this.$track = this.$el.querySelector(".mpui-slider-track"), this.$bar = this.$track.querySelector(".mpui-slider-bar"), this.$thumbTrack = this.$track.querySelector(".mpui-slider-thumb-track"), this.$thumb = this.$track.querySelector(".mpui-slider-thumb"), this.$el.addEventListener("mousedown", (c) => {
      var E;
      const d = c, { clientX: v } = d, g = this.$track.offsetWidth;
      let p = this.$thumbTrack.offsetWidth;
      p = p || g;
      const P = (g - p) / 2, b = this.$el.getBoundingClientRect().left;
      let y = v - b - P;
      y = y >= p ? p : y <= 0 ? 0 : y;
      const C = this.step ? Math.round(y / p * (this.max - this.min) / this.step) * this.step + this.min : y / p * (this.max - this.min) + this.min;
      (E = this.onDragStart) == null || E.call(this, C), this.value != C && this.drag(C);
      const V = (k) => {
        var tt;
        const A = k, { clientX: $ } = A;
        ...
        this.value != I && this.drag(I), (tt = window.getSelection()) == null || tt.removeAllRanges();
      }, R = (k) => {
        var $, f;
        k.stopPropagation(), ($ = window.getSelection()) == null || $.removeAllRanges(), document.removeEventListener("mousemove", V), document.removeEventListener("mouseup", R), (f = this.onDragEnd) == null || f.call(this, C);
      };
...
class Gt {
  constructor({
    ...
    this.container = t, this.min = e, this.max = i, this.step = n || 0, this.value = isNaN(o) ? o : Number(o), this.onChange = r, this.onDragStart = h, this.onDragEnd = l, this.onDrag = a, N(Ft(), t), this.$el = this.container.querySelector(".mpui-slider"), this.$track = this.$el.querySelector(".mpui-slider-track"), this.$bar = this.$track.querySelector(".mpui-slider-bar"), this.$thumbTrack = this.$track.querySelector(".mpui-slider-thumb-track"), this.$thumb = this.$track.querySelector(".mpui-slider-thumb"), this.$el.addEventListener("mousedown", (u) => {
      var R;
      const c = u, { clientY: d } = c, v = this.$track.offsetHeight;
      let g = this.$thumbTrack.offsetHeight;
      g = g || v;
      const p = (v - g) / 2, P = this.$el.getBoundingClientRect().top;
      let b = g - (d - P - p);
      b = b >= g ? g : b <= 0 ? 0 : b;
      const y = this.step ? Math.round(b / g * (this.max - this.min) / this.step) * this.step + this.min : b / g * (this.max - this.min) + this.min;
      (R = this.onDragStart) == null || R.call(this, y), this.value != y && this.drag(y);
      const C = (E) => {
        var I;
        const k = E, { clientY: A } = k;
        k.preventDefault(), k.stopPropagation();
        let $ = g - (A - P - p);
        $ = $ >= g ? g : $ <= 0 ? 0 : $;
        const f = this.step ? Math.round($ / g * (this.max - this.min) / this.step) * this.step + this.min : $ / g * (this.max - this.min) + this.min;
        this.value != f && this.drag(f), (I = window.getSelection()) == null || I.removeAllRanges();
      }, V = (E) => {
        var A, $;
        E.stopPropagation(), (A = window.getSelection()) == null || A.removeAllRanges(), document.removeEventListener("mousemove", C), document.removeEventListener("mouseup", V), ($ = this.onDragEnd) == null || $.call(this, y);
      };
...
class Kt {
  ...
  /** 重载，一般用于列表项更改 */
  reload(t) {
    N(Jt({ list: this.list, template: this.template }), this.container), this.$el = this.container.querySelector(".mpui-picker"), this.$items = this.$el.querySelectorAll(".mpui-picker-item"), this.$items.forEach((e) => {
...
class te {
  ...
  /** 重载，一般用于列表项更改 */
  reload(t) {
    N(Qt({ list: this.list, template: this.template }), this.container), this.$el = this.container.querySelector(".mpui-picker"), this.$items = this.$el.querySelectorAll(".mpui-picker-item"), this.$items.forEach((e) => {
      e.addEventListener("click", () => {
...
const ee = ({ label: s }) => _` <div class="mpui-switch">${s}</div> `;
class ie {
  constructor({ container: t, value: e = !1, onChange: i, onToggle: n }) {
    this.container = t, this.value = e, this.onChange = i, this.onToggle = n, N(ee({ label: this.label }), this.container), this.$el = this.container.querySelector(".mpui-switch"), this.$el.addEventListener("click", () => {
...
class ne {
  constructor({ container: t, value: e = !1, onChange: i, onToggle: n, label: o }) {
    this.container = t, this.value = e, this.onChange = i, this.onToggle = n, this.label = o, N(se({ label: this.label }), this.container), this.$el = this.container.querySelector(".mpui-checkbox"), this.$el.addEventListener("click", () => {
      this.toggle();
    }), this.setValue(this.value);
  }
  /** 设置开关状态 */
...
console.log(
  `
 %c mfunsPlayer v${Y.version} ${Y.gitHash} %c https://github.com/Mfuns-cn 
